...
<%
    String actionFrom = ParamUtil.getString(request,IaisEGPConstant.CRUD_ACTION_TYPE_FORM);
    if(StringUtil.isEmpty(actionFrom)){
        actionFrom = (String)ParamUtil.getRequestAttr(request,IaisEGPConstant.CRUD_ACTION_TYPE_FORM);
    }
%>
<input type="hidden" id = "controlFormLi" value="<%=actionFrom%>">
