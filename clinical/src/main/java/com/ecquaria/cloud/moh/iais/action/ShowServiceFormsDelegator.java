...
public class ShowServiceFormsDelegator {
    ...
    public void prepareSwitch(BaseProcessClass bpc){
        ...
        String actionFrom = ParamUtil.getString(bpc.request,IaisEGPConstant.CRUD_ACTION_TYPE_FORM);
        if(StringUtil.isEmpty(actionFrom)){
            ParamUtil.setRequestAttr(bpc.request,IaisEGPConstant.CRUD_ACTION_TYPE_FORM,"clinical");
        }
