			...
			if(applicantId){
				...
				var sHandler1 = function(data, textStatus){
					...
					if(status == "success"){
						...
						$('#applicantId').nextAll('small.error').html(eval(data)[0].message);
					}
					initSmallError();
				}
				...
				$('#applicantId').nextAll('small.error').html('Required Value');
				$('#applicantId').addClass('inputtext-error');
				initSmallError();
			}
		}
