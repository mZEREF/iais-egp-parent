...
<div id="lookupPanel">
	...
	<div>
		<label class="page-edit-label">Empty<br>Option</label>
		<div id="empty_option_div" class="buttons">
			<input type="checkbox" {if empty_option == 'true'} checked{/if}  class="property-input" value="true"/>
			<input type="text" class="property-input" value="${empty_option_desc}" size="12"
						style="vertical-align: top;" {if empty_option != 'true'}disabled{/if} />
		</div>
	</div>
	<div class="page-content-spacer"></div>
	...
	<div>
		...
		<div id="sources_options_default_div" class="buttons">
