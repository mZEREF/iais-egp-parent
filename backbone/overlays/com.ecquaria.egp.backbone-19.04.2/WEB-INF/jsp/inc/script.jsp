...
<%--<script type="text/javascript" src="<%=EngineHelper.getResourcePath()%>/javascripts/sop/jquery.js"></script>--%>
...
<script type="text/javascript">
    ...
    var isSureDelete = "<%=MultiLangUtil.translate(request,AppConstants.KEY_TRANSLATION_MODULE_MESSAGE, "isSureDelete","Are you sure you want to delete?")%>";
</script>
