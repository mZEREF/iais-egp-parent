<div class="personnel-content row form-horizontal" id="personnelRemoveId${status.index}">
    ...
    <iais:row cssClass="personnel-header">
        ...
        <iais:value width="5" cssClass="col-xs-12 col-md-6">
                <strong>
                    ...
                    <label class="assign-psn-item"><c:if test="${AppSvcPersonnelDtoList.size() > 1}">${status.index+1}</c:if></label>
                </strong>
            </iais:value>
