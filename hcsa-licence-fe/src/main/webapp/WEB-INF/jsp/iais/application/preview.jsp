                                                ...
                                                <c:forEach var="hcsaServiceDto" items="${hcsaServiceDtoList}" varStatus="status" >
                                                    <div class="panel panel-default svc-content">
                                                        ...
                                                        <c:if test="${showHeadingSign}">
                                                            <c:set var="headingSign" value="${StringUtil.isIn(hcsaServiceDto.svcCode, coMap.multiSvcInfo) ? 'incompleted' : 'completed'}" />
                                                        </c:if>
...
<script type="text/javascript">
    ...
    $('.svcTitle').click(function () {
        ...
        var url ='${pageContext.request.contextPath}<%=RedirectUtil.appendCsrfGuardToken("/eservice/INTERNET/MohServiceRelatedInformation/PrepareView", request)%>';
