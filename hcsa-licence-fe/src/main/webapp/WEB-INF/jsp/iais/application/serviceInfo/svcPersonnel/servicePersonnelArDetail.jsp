    ...
    <iais:row>
        ...
        <iais:row>
            ...
            <iais:value width="7" cssClass="col-md-7">
                <iais:input maxLength="66" type="text" cssClass="name" name="${logo}name${index}" value="${appSvcPersonnelDto.name}"/>
            </iais:value>
        </iais:row>
        ...
        <iais:row>
            ...
            <iais:value width="7" cssClass="col-md-7">
                <iais:select cssClass="designation" name="${logo}designation${index}" value="${appSvcPersonnelDto.designation}" options="designationOpList" firstOption="Please Select"/>
            </iais:value>
        </iais:row>
        ...
        <iais:row>
            ...
            <iais:value width="7" cssClass="col-md-7">
                ...
                <iais:input maxLength="20" type="text" cssClass="profRegNo" name="${logo}profRegNo${index}" value="${appSvcPersonnelDto.profRegNo}"/>
            </iais:value>
        </iais:row>
        ...
        <iais:row >
            ...
            <iais:value width="7" cssClass="col-md-7">
                <iais:input maxLength="50" type="text" cssClass="typeOfCurrRegi" name="${logo}typeOfCurrRegi${index}" value="${appSvcPersonnelDto.typeOfCurrRegi}"/>
            </iais:value>
        </iais:row>
        ...
        <iais:row>
            ...
            <iais:value width="7" cssClass="col-md-7">
                <iais:datePicker cssClass="currRegiDate field-date" name="${logo}currRegiDate${index}" value="${appSvcPersonnelDto.currRegiDate}"/>
            </iais:value>
        </iais:row>
        ...
        <iais:row>
            ...
            <iais:value width="7" cssClass="col-md-7">
                <iais:datePicker cssClass="praCerEndDate field-date" name="${logo}praCerEndDate${index}" value="${appSvcPersonnelDto.praCerEndDate}"/>
            </iais:value>
        </iais:row>
        ...
        <iais:row>
            ...
            <iais:value width="7" cssClass="col-md-7">
                <iais:input maxLength="50" type="text" cssClass="typeOfRegister" name="${logo}typeOfRegister${index}" value="${appSvcPersonnelDto.typeOfRegister}"/>
            </iais:value>
        </iais:row>
        ...
        <iais:row>
            ...
            <iais:value width="7" cssClass="col-md-7">
                <iais:datePicker cssClass="specialtyGetDate field-date" name="${logo}specialtyGetDate${index}" value="${appSvcPersonnelDto.specialtyGetDate}"/>
            </iais:value>
        </iais:row>
        ...
        <iais:row>
            ...
            <iais:value width="7" cssClass="col-md-7">
                <iais:input cssClass="wrkExpYear" maxLength="2" type="text" name="${logo}wrkExpYear${index}" value="${appSvcPersonnelDto.wrkExpYear}"/>
            </iais:value>
        </iais:row>
        ...
        <iais:row >
                ...
                <iais:value width="7" cssClass="col-md-7">
                    <iais:datePicker cssClass="bclsExpiryDate" name="${logo}bclsExpiryDate${index}" value="${appSvcPersonnelDto.bclsExpiryDate}"/>
                </iais:value>
        </iais:row>
</div>
