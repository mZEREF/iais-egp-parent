<div class="person-detail topByDrug <c:if test="${('0' == appSvcOtherInfoTop.topType) || ('0' == provideTop) || (empty appSvcOtherInfoTop.topType)}">hidden</c:if>" data-prefix="${prefix}">
    ...
    <iais:row>
        ...
        <iais:value width="7" cssClass="col-md-7">
            <iais:input maxLength="4" type="number" cssClass="year" name="${prefix}year${index}" value="${person.year}"/>
        </iais:value>
    </iais:row>
    ...
    <iais:row>
        ...
        <iais:value width="7" cssClass="col-md-7">
            <iais:input maxLength="7" type="number" cssClass="abortNum" name="${prefix}abortNum${index}" value="${person.abortNum}"/>
        </iais:value>
    </iais:row>
</div>
