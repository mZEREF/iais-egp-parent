...
<iais:row>
    ...
    <iais:value width="3" cssClass="form-check col-md-3">
        <input class="form-check-input nisOpenToPublic" <c:if test="${true == n.isOpenToPublic}">checked="checked"</c:if>  type="radio" name="nisOpenToPublic" value = "1" aria-invalid="false">
        <label class="form-check-label" ><span class="check-circle"></span>Yes</label>
    </iais:value>

    <iais:value width="3" cssClass="form-check col-md-3">
        <input class="form-check-input nisOpenToPublic" <c:if test="${false == n.isOpenToPublic}">checked="checked"</c:if> type="radio" name="nisOpenToPublic" value = "1" aria-invalid="false">
