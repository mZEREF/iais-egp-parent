...
<%--    --%>
    ...
    <iais:row>
        ...
        <iais:value width="7" cssClass="col-sm-5 col-md-7">
            <iais:input maxLength="66" type="text" name="${logo}name${index}" value="${appSvcPersonnelDto.name}"></iais:input>
        </iais:value>
    </iais:row>
    ...
    <iais:row>
        ...
        <iais:value width="7" cssClass="col-sm-5 col-md-7">
            <iais:input maxLength="66" type="text" name="${logo}qualification${index}" value="${appSvcPersonnelDto.qualification}"></iais:input>
        </iais:value>
    </iais:row>
