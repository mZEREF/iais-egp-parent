<div class="topBySurgicalProcedure <c:if test="${('1' == appSvcOtherInfoTop.topType) || ('0' == provideTop) || (empty appSvcOtherInfoTop.topType)}">hidden</c:if>">
    <iais:row>
    ...
    <iais:row>
        ...
        <iais:value width="7" cssClass="col-md-7">
            <iais:input maxLength="4" type="number" cssClass="pyear" name="pyear${index}" value="${person.year}"/>
        </iais:value>
    </iais:row>
    ...
    <iais:row>
        ...
        <iais:value width="7" cssClass="col-md-7">
            <iais:input maxLength="7" type="number" cssClass="pabortNum" name="pabortNum${index}" value="${person.abortNum}"/>
        </iais:value>
    </iais:row>
</div>
