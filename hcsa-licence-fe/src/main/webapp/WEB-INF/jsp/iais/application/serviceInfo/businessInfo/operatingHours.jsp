...
<c:set var="isSpecialMOSD" value="${appGrpPremisesDto.premisesType==ApplicationConsts.PREMISES_TYPE_MOBILE||appGrpPremisesDto.premisesType==ApplicationConsts.PREMISES_TYPE_REMOTE}"></c:set>
