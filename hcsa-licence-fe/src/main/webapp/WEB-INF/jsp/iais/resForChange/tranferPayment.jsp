                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="paymentTab" role="tabpanel">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                    <c:forEach var="svc" items="${tranferPayment.appSvcRelatedInfoDtoList}">
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <p><c:out value="${tranferPayment.appGrpNo}"></c:out></p>
                                            </td>
                                            <td>
                                                <p><c:out value="${tranferPayment.amount}"></c:out></p>
                                            </td>
                                        </tr>
                                    </c:forEach>
