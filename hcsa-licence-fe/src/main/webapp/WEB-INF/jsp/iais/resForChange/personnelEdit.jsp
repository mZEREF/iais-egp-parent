...
<div id="update" class="form-horizontal">
    ...
    <iais:row>
        ...
        <iais:value cssClass="col-xs-12 col-sm-7 col-md-8">
            <iais:select cssClass="specialty" name="specialty" firstOption="Please Select" options="SpecialtySelectList"
    ...
    <iais:row>
        ...
        <iais:value cssClass="col-xs-12 col-sm-7 col-md-8">
            <iais:input maxLength="100" type="text" name="subspeciality"
                        value="${onePersonnel.subSpeciality}"></iais:input>
        </iais:value>
    </iais:row>
    <iais:row>
...
<div id="replace" style="width: 40%" hidden>
    <iais:select name="replaceName" id="replaceOptionsId" options="replaceOptions" value="${replaceName}"
