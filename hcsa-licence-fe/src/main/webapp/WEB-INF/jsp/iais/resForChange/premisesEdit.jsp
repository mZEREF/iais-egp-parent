...
<form method="post" id="menuListForm" action=<%=process.runtime.continueURL()%>>
  ...
  <iais:confirm msg="NEW_ACK016" needCancel="false" callBack="postalCodeCon()" popupOrder="postalCodePop" yesBtnDesc="" needEscapHtml="false" needFungDuoJi="false"></iais:confirm>
