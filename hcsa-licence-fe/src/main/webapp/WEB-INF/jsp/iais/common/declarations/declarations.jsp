  ...
  <c:otherwise>
    <div class="panel panel-default">
      <div class="panel-heading" id="headingOne" role="tab">
        <h4 class="panel-title"><a class="a-panel-collapse" style="text-decoration: none;" role="button" data-toggle="collapse" href="#declarations" aria-expanded="true" aria-controls="declarations" name="printControlNameForApp">Declarations</a></h4>
      </div>
      <div class="panel-collapse collapse <c:if test="${!empty printFlag}">in</c:if>" id="declarations" role="tabpanel" aria-labelledby="headingOne">
        <div class="panel-body">
          ...
          <c:if test="${AppSubmissionDto.appType == 'APTY002'}">
            ...
            <%@include file="preliminaryQuestion.jsp"%>
            <c:if test="${viewPrint != 'Y'}">
              <%@include file="proofOfAuthorisationDocument.jsp"%>
            </c:if>
            <c:if test="${viewPrint == 'Y'}">
              <%@include file="proofOfAuthorisationDocumentView.jsp"%>
            </c:if>
            <%@include file="bankruptcy.jsp"%>
          ...
          <c:if test="${declaration_page_is == 'cessation' }">
            ...
            <%@include file="cessationQuestion.jsp"%>
          </c:if>
        </div>
      </div>
    </div>
