                            ...
                            <tr>
                                <td >
                                    <div class="col-xs-12 col-md-12 form-check" style="padding:0px 15px;margin-top:15px">
                                        <input class="form-check-input"  type="checkbox" value="<iais:mask name="licenceName${status.index}" value="${licence.id}"/>" name="licenceName${status.index}" aria-invalid="false">
