        ...
        <div class="panel-body">
            <div class="panel-main-content form-horizontal">
                ...
                <iais:row>
                    ...
                    <iais:value width="6" cssClass="col-md-6">
                        ...
                        <div id="reasonDisplay0" <c:if test="${arSuperDataSubmissionDto.efoCycleStageDto.isMedicallyIndicated == 1}">style="display: none"</c:if> >
                            <input type="text" maxlength="100" name="textReason" value="${arSuperDataSubmissionDto.efoCycleStageDto.reason}" >
                        </div>
                ...
                <iais:row id="cryopresNum">
                    ...
                    <iais:value width="6" cssClass="col-md-6">
                        <iais:input type="text" maxLength="2" value="${arSuperDataSubmissionDto.efoCycleStageDto.cryopresNumStr==null?arSuperDataSubmissionDto.efoCycleStageDto.cryopresNum:arSuperDataSubmissionDto.efoCycleStageDto.cryopresNumStr}" id="cryopresNum" name="cryopresNum" />
