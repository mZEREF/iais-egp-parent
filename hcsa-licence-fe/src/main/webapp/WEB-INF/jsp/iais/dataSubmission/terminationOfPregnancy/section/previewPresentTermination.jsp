                ...
                <div class="panel-main-content form-horizontal">
                    ...
                    <div
                        ...
                        <iais:row>
                            ...
                            <iais:value width="7" display="true" cssClass="col-md-7">
                                <c:if test="${terminationDto.performedOwn == true}">${topSuperDataSubmissionDto.premisesDto.businessName}</c:if>
                    ...
                    <div
                        ...
                        <iais:row>
                            ...
                            <iais:value width="7" display="true" cssClass="col-md-7">
                                <c:if test="${terminationDto.pregnancyOwn == true}">${topSuperDataSubmissionDto.premisesDto.businessName}</c:if>
                    ...
                    <div
                        ...
                        <iais:row>
                            ...
                            <iais:value width="7" display="true" cssClass="col-md-7">
                                <c:if test="${terminationDto.takenOwn == true}">${topSuperDataSubmissionDto.premisesDto.businessName}</c:if>
