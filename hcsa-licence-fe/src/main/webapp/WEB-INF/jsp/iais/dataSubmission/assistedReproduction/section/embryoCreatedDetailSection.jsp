    ...
    <div id="embryoCreatedDetails" class="panel-collapse collapse in">
        <div class="panel-body">
            <div class="panel-main-content form-horizontal">
                ...
                <iais:row>
                    <iais:field width="6" cssClass="col-md-6" value="No. of Transferrable embryos created from fresh oocyte(s)" mandatory="true"/>
                ...
                <iais:row>
                    <iais:field width="6" cssClass="col-md-6" value="No. of Poor Quality / Unhealthy / Abnormally Developed embryos created from fresh oocyte(s)" mandatory="true"/>
                    <iais:value width="6" cssClass="col-md-6" >
                ...
                <iais:row>
                    <iais:field width="6" cssClass="col-md-6" value="No. of Transferrable embryos created from thawed oocyte(s)" mandatory="true"/>
                    <iais:value width="6" cssClass="col-md-6" >
                ...
                <iais:row>
                    <iais:field width="6" cssClass="col-md-6" value="No. of Poor Quality / Unhealthy / Abnormally Developed embryos created from thawed oocyte(s)" mandatory="true"/>
                    <iais:value width="6" cssClass="col-md-6" >
                ...
                <iais:row>
                    <iais:field width="6" cssClass="col-md-6" value="Total No. Created" mandatory="false"/>
