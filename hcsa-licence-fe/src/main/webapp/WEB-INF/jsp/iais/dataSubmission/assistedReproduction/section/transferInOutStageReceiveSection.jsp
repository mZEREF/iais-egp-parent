    ...
    <div id="transferInOutDetails" class="panel-collapse collapse in">
        <div class="panel-body">
            <div class="panel-main-content form-horizontal">
                ...
                <iais:row>
                    <iais:field width="6" cssClass="col-md-6" value="Is this a Transfer In or Out?"/>
                    <iais:value width="6" cssClass="col-md-6" label="true" style="padding-top: 13px;">
                        <c:if test="${transferInOutStageDto.transferType eq 'in'}">
                            <c:out value=" Transfer In"/>
                        </c:if>
                        <c:if test="${transferInOutStageDto.transferType eq'out'}">
                ...
                <iais:row>
                    <iais:field width="6" cssClass="col-md-6" value="What was Transferred?"/>
                    <iais:value width="6" cssClass="col-md-6" label="true" style="padding-top: 13px;">
                ...
                <c:if test="${fn:contains(transferInOutStageDto.transferredList,'AR_WWT_001')}">
                    <iais:row id="transferred0">
                        <iais:field width="6" cssClass="col-md-6" value="No. of Oocyte(s) Received" mandatory="true"/>
                ...
                <c:if test="${fn:contains(transferInOutStageDto.transferredList,'AR_WWT_002')}">
                    <iais:row id="transferred1">
                        <iais:field width="6" cssClass="col-md-6" value="No. of Embryo(s) Received" mandatory="true"/>
                        <iais:value width="3" cssClass="col-md-3">
                ...
                <c:if test="${fn:contains(transferInOutStageDto.transferredList,'AR_WWT_003')}">
                    <iais:row id="transferred2">
                        <iais:field width="6" cssClass="col-md-6" value="Vials of Sperm Received" mandatory="true"/>
                        <iais:value width="3" cssClass="col-md-3">
                ...
                <iais:row>
                    <iais:field width="6" cssClass="col-md-6" value="Were the Gamete(s) or Embryo(s) from a Donor?"/>
                    <iais:value width="6" cssClass="col-md-6" label="true" style="padding-top: 13px;">
                ...
                <c:if test="${transferInOutStageDto.transferType =='in'}">
                    <iais:row>
                        <iais:field width="6" cssClass="col-md-6" value="Transferred In From"/>
                        <iais:value width="6" cssClass="col-md-6" label="true" style="padding-top: 13px;">
                    ...
                    <iais:row style="${transferInOutStageDto.transInFromHciCode eq'Others' ? '' : 'display:none;'}">
                        <iais:field width="6" cssClass="col-md-6" value="Transferred In From (Others)"/>
                        <iais:value width="6" cssClass="col-md-6" label="true" style="padding-top: 13px;">
                ...
                <c:if test="${transferInOutStageDto.transferType =='out'}">
                    <iais:row>
                        <iais:field width="6" cssClass="col-md-6" value="Transferred Out To"/>
                        <iais:value width="6" cssClass="col-md-6" label="true" style="padding-top: 13px;">
                    ...
                    <iais:row style="${transferInOutStageDto.transOutToHciCode eq'Others' ? '' : 'display:none;'}">
                        <iais:field width="6" cssClass="col-md-6" value="Transferred Out To (Others)"/>
                        <iais:value width="6" cssClass="col-md-6" label="true" style="padding-top: 13px;">
                ...
                <iais:row>
                    <iais:field width="6" cssClass="col-md-6" value="Date of Transfer"/>
                    <iais:value width="6" cssClass="col-md-6" label="true" style="padding-top: 13px;">
