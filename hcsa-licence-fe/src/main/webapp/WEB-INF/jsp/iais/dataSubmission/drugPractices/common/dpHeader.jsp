...
<c:set value="${dpSuperDataSubmissionDto != null && dpSuperDataSubmissionDto.getDataSubmissionDto() != null && 'DSTY_005'.equalsIgnoreCase(dpSuperDataSubmissionDto.getDataSubmissionDto().getAppType())}"
       var="isRfc"/>
