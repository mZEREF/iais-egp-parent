        ...
        <div class="panel-body">
            <div class="panel-main-content form-horizontal">
                ...
                <iais:row>
                    ...
                    <iais:value width="6" cssClass="col-md-6">
                        <input type="text" maxlength="2" onkeyup="this.value=this.value.replace(/^(-|\\+)?\\d+$/,'');" id="curCenDonatedNum" name="curCenDonatedNum" value="${arSuperDataSubmissionDto.donationStageDto.curCenDonatedNum}" >
                ...
                <iais:row>
                    ...
                    <iais:value width="6" cssClass="col-md-6">
                        <input type="text" maxlength="2"  onkeyup="this.value=this.value.replace(/^(-|\\+)?\\d+$/,'');" name="otherCenDonatedNum" id="otherCenDonatedNum" value="${arSuperDataSubmissionDto.donationStageDto.otherCenDonatedNum}" >
                ...
                <iais:row>
                    ...
                    <iais:value width="6" cssClass="col-md-6">
                        <input type="text" maxlength="2" onkeyup="this.value=this.value.replace(/^(-|\\+)?\\d+$/,'');"  name="resDonarNum" id="resDonarNum" value="${arSuperDataSubmissionDto.donationStageDto.resDonarNum}" >
                ...
                <iais:row>
                    ...
                    <iais:value width="6" cssClass="col-md-6">
                        <input type="text" maxlength="2" onkeyup="this.value=this.value.replace(/^(-|\\+)?\\d+$/,'');" name="curCenResDonatedNum" id="curCenResDonatedNum" value="${arSuperDataSubmissionDto.donationStageDto.curCenResDonatedNum}" >
                ...
                <iais:row>
                    ...
                    <iais:value width="6" cssClass="col-md-6">
                        <input type="text" maxlength="2"  onkeyup="this.value=this.value.replace(/^(-|\\+)?\\d+$/,'');" name="otherCenResDonarNum" id="otherCenResDonarNum" value="${arSuperDataSubmissionDto.donationStageDto.otherCenResDonarNum}" >
                ...
                <iais:row>
                    ...
                    <iais:value width="6" cssClass="col-md-6">
                        <input type="text" maxlength="2" onkeyup="this.value=this.value.replace(/^(-|\\+)?\\d+$/,'');" id="trainingNum" name="trainingNum" value="${arSuperDataSubmissionDto.donationStageDto.trainingNum}" >
