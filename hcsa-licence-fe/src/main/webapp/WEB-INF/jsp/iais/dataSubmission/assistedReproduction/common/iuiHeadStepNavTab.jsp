...
<%--@elvariable id="iuiStageList" type="java.util.List<com.ecquaria.cloud.moh.iais.dto.IUICycleStageDto>"--%>
<c:if test="${not empty iuiStageList}">
    <ul class="stage-tracker">
        <c:forEach var="stage" items="${iuiStageList}" varStatus="status">
