    ...
    <div class="main-content">
        <div class="container center-content">
            <div style="margin-top:-30px;">
                ...
                <p class="col-xs-12 margin-btm">- <strong><iais:code code="${vssSuperDataSubmissionDto.submissionType}"/></strong></p>
                <div class="ack-font-16">
                    <p class="col-xs-12">A notification email will be sent to ${emailAddress}.</p>
                    <p class="col-xs-12 margin-btm"><iais:message key="DS_MSG012" escape="false"></iais:message></p>
                </div>
                <div class="ack-font-16">
                    ...
                    <div class="col-xs-12 col-sm-12 margin-btm table-responsive">
                        <table aria-describedby="" class="table">
                            ...
                            <tbody>
                            <tr>
                                <td>${vssSuperDataSubmissionDto.dataSubmissionDto.submissionNo}</td>
                                <td>${submittedBy}</td>
                                <td><fmt:formatDate value="${vssSuperDataSubmissionDto.dataSubmissionDto.submitDt}" pattern="dd/MM/yyyy HH:mm"/></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-xs-12 col-md-10 margin-bottom-10">
                    <div class="text-right">
                        <a class="btn btn-secondary" href="/hcsa-licence-web/eservice/INTERNET/MohVSSDataSubmission">Start Another Submission</a>
