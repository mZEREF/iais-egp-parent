...
<%--@elvariable id="emailAddress" type="java.lang.String"--%>
...
<%--@elvariable id="submittedBy" type="java.lang.String"--%>
<style>
    .margin-btm {
        margin-bottom: 30px;
    }
        ...
        <div class="container center-content">
            <div style="margin-top:-30px;">
                    ...
                    <div class="col-xs-12 col-sm-12 margin-btm table-responsive">
                        <table aria-describedby="" class="table">
                            ...
                            <tr>
                                ...
                                <td>${submittedBy}</td>
                                <td><fmt:formatDate value="${arSuperDataSubmissionDto.dataSubmissionDto.submitDt}"
                ...
                <div class="col-xs-12 col-md-2 text-left">
                    <a style="padding-left: 5px;" class="back"
                       href="/main-web/eservice/INTERNET/MohDataSubmissionsInbox">
                        <em class="fa fa-angle-left">&nbsp;</em> Back
                    </a>
                </div>
                <div class="col-xs-12 col-md-10 margin-bottom-10">
                    <div class="text-right">
                        <a class="btn btn-secondary" href="/hcsa-licence-web/eservice/INTERNET/MohARAndIUIDataSubmission">Start
                            Another Submission</a>
                        <a class="btn btn-primary" href="/main-web/eservice/INTERNET/MohInternetInbox">Go to
                            DashBoard</a>
                    </div>
                </div>
            </div>
