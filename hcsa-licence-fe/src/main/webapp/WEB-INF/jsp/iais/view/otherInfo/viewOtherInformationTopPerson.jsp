    ...
    <div class="amend-preview-info form-horizontal min-row">
        ...
        <c:forEach var="person" items="${currentPreviewSvcInfo.appSvcOtherInfoDto.appSvcOtherInfoTopPersonDtoList}" varStatus="status">
            <c:if test="${person.psnType == 'practitioners'}">
                <iais:row>
                    <div class="col-xs-12">
                        <p><strong>Name, Professional Regn. No. and Qualification of medical practitioners authorised to perform Abortion&nbsp;<c:if test="${currentPreviewSvcInfo.appSvcOtherInfoDto.appSvcOtherInfoTopPersonDtoList.size()>1}">${status.index+1}:</c:if></strong></p>
                    </div>
                </iais:row>
        ...
        <c:forEach var="person" items="${currentPreviewSvcInfo.appSvcOtherInfoDto.appSvcOtherInfoTopPersonDtoList1}" varStatus="astatus">
            <c:if test="${person.psnType == 'anaesthetists'}">
                <iais:row>
                    <div class="col-xs-12">
                        <p><strong>Name, Professional Regn. No. and Qualification of anaesthetists&nbsp;<c:if test="${currentPreviewSvcInfo.appSvcOtherInfoDto.appSvcOtherInfoTopPersonDtoList1.size()>1}">${astatus.index+1}:</c:if></strong></p>
                    </div>
                </iais:row>
        ...
        <c:forEach var="person" items="${currentPreviewSvcInfo.appSvcOtherInfoDto.appSvcOtherInfoTopPersonDtoList2}" varStatus="nstatus">
            <c:if test="${person.psnType == 'nurses'}">
                <iais:row>
                    <div class="col-xs-12">
                        <p><strong>Name, Professional Regn. No. and Qualification of trained nurses&nbsp;<c:if test="${currentPreviewSvcInfo.appSvcOtherInfoDto.appSvcOtherInfoTopPersonDtoList2.size()>1}">${nstatus.index+1}:</c:if></strong></p>
                    </div>
                </iais:row>
        ...
        <c:forEach var="person" items="${currentPreviewSvcInfo.appSvcOtherInfoDto.appSvcOtherInfoTopPersonDtoList3}" varStatus="cstatus">
            <c:if test="${person.psnType == 'counsellors'}">
                <iais:row>
                    <div class="col-xs-12">
                        <p><strong>Name, Professional Regn. No. and Qualification of certified TOP counsellors&nbsp;<c:if test="${currentPreviewSvcInfo.appSvcOtherInfoDto.appSvcOtherInfoTopPersonDtoList3.size()>1}">${cstatus.index+1}:</c:if></strong></p>
                    </div>
                </iais:row>
