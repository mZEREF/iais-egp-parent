    ...
    <div id="cycleDetails" class="panel-collapse collapse in">
        <div class="panel-body">
            <div class="panel-main-content form-horizontal "><%--min-row--%>
                ...
                <div id="totalBirthSection" <c:if test="${pregnancyOutcomeStageDto.pregnancyOutcome != 'OUTOPRE001' && pregnancyOutcomeStageDtoVersion.pregnancyOutcome != 'OUTOPRE001'}">style="display:none;"</c:if>>
                    <iais:row>
    ...
    <div class="panel-collapse collapse in" id="babyDetals">
        <div class="panel-body">
            <div class="panel-main-content form-horizontal">
                <iais:row>
                    <div class="col-md-6">
                        <%@include file="previewPregnancyOutcomeStageBabySectionCurr.jsp" %>
                    </div>
                    <div class="col-md-6">
