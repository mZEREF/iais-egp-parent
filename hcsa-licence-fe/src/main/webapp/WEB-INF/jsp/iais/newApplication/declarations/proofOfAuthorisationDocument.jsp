    ...
    <div class="row">
        ...
        <div class="document-upload-list">
            ...
            <div class="file-upload-gp">
                <span name="selectedDeclFileShowId" id="selectedDeclFileShowId">
                ...
                <input class="selectedFile"  id="selectedFile" name = "selectedFile"  type="file" style="display: none;" aria-label="selectedFile1" onclick="fileClicked(event)" onchange="doUserRecUploadConfirmDecFile(event)"/><a class="btn btn-file-upload btn-secondary" onclick="clearFlagValueFEFile()">Upload</a>
            </div>
