                        ...
                        <div class="control-label formtext col-md-5 col-xs-5">
                            <label  class="control-label control-set-font control-font-label">
                                <div class="cgo-header">
                                    <strong>Key Appointment Holder <label class="assign-psn-item"><c:if test="${AppSvcKeyAppointmentHolderDtoList.size() > 1}">${keyAppointmentHolderStatus.index+1}</c:if></label></strong>
                                </div>
                            </label>
                        </div>

                        <div class="col-md-7 col-xs-7 text-right">
                            <c:if test="${keyAppointmentHolderStatus.index - keyAppointmentHolderConfigDto.mandatoryCount >=0}">
