...
<div class="panel-body" >
    <div class="row">
      ...
      <div  class="col-xs-3">
        <input type="text" autocomplete="off" value="<fmt:formatDate value="${AppSubmissionDto.appDeclarationMessageDto.effectiveDt}" pattern="dd/MM/yyyy"/>"  class="date_picker form-control form_datetime" name="effectiveDt" id="-20247433206800" data-date-start-date="01/01/1900" placeholder="dd/mm/yyyy" maxlength="10"></span>
      </div>
    </div>
