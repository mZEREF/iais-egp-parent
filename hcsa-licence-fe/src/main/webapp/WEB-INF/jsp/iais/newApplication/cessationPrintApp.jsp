                                        ...
                                        <div class="col-lg-12 col-xs-12">
                                            <div>
                                                ...
                                                <div class="form-group" id="transferDetail" style="display: none;">
                                                    ...
                                                    <div class="col-xs-6 col-sm-4 col-md-3">
                                                        <textarea name="transferDetail"  cols="30" rows="${appCessHci.transferDetailRow}" maxLength="1000" readonly="readonly">${appCessHci.transferDetail}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group" id="transferredWhere" style="display: none;">
                                                    ...
                                                    <div class="col-xs-6 col-sm-4 col-md-3">
                                                        <textarea name="transferredWhere"  cols="30" rows="${appCessHci.transferredWhereRow}" maxLength="1000" readonly="readonly">${appCessHci.transferredWhere}</textarea>
                                                    </div>
                                                </div>
                                                <c:if test="${isGrpLic}">
                                                    <div>
