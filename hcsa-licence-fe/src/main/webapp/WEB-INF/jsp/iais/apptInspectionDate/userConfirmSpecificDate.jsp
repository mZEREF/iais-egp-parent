              ...
              <c:if test="${'SUCCESS' ne apptInspFlag}">
                <iais:section title="" id = "ava_appt_date">
                  ...
                  <iais:action >
                    ...
                    <iais:confirm yesBtnCls="btn btn-primary" msg="OAPPT_ACK007" callBack="userConfirmSpecificDateReject()" popupOrder="rejectDate" title="Confirmation Box" needCancel="false"></iais:confirm>
