        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="instruction-content center-content">
                                            ...
                                            <div class="table-gp tablebox">
                                                <div class="topheader">
                                                    ...
                                                    <div class="form-group" id="${num.count}reason${uid.count}" hidden>
                                                        <label class="col-xs-12 col-md-6 control-label ">Others <span style="color: red">*</span></label>
                                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-xs-12 col-md-6 control-label">Ratient's Record will be transferred <span style="color: red">*</span></label>
                                                        <div class="col-xs-12 col-sm-4 col-md-3">
                    ...
                    <div class="form-check disabled">
                        <input disabled checked class="form-check-input" id="confirmInfo" type="checkbox" name="readInfo" aria-invalid="false">
