                                        ...
                                        <div class="col-lg-12 col-xs-12">
                                            <div class="">
                                                ...
                                                <div class="form-group" id="${num.count}transferDetail${uid.count}" style="display: none;">
                                                    ...
                                                    <div class="col-xs-12 col-sm-4 col-md-3">
                                                        <textarea name="${num.count}transferDetail${uid.count}"  cols="30" rows="${appCessHci.transferDetailRow}" maxLength="1000" readonly="readonly">${appCessHci.transferDetail}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group" id="${num.count}transferredWhere${uid.count}" style="display: none;">
                                                    ...
                                                    <div class="col-xs-12 col-sm-4 col-md-3">
                                                        <textarea name="${num.count}transferredWhere${uid.count}"  cols="30" rows="${appCessHci.transferredWhereRow}" maxLength="1000" readonly="readonly">${appCessHci.transferredWhere}</textarea>
                                                    </div>
                                                </div>
                                                <c:if test="${isGrpLic}">
                                                    <div>
