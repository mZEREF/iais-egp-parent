...
public interface LicenceClient {
    ...
    @GetMapping(value= "/hcsa-licence-rfc/licence-bylicence-byNo/{licenceNo}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(path = "/licenceView/{licenceId}",produces = MediaType.APPLICATION_JSON_VALUE)
