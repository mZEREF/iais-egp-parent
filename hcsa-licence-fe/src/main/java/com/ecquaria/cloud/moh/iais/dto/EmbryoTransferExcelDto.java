...
public class EmbryoTransferExcelDto {
    ...
    @ExcelProperty(cellIndex = 13, cellName = "(13) Was the 5th Embryo Transferred a fresh or thawed embryo?", readOnly = true)
    private String embryoType5;

    @ExcelProperty(cellIndex = 14, cellName = "(14) 6th Embryo", readOnly = true)
    private String embryo6;

    @ExcelProperty(cellIndex = 15, cellName = "(15) Was the 6th Embryo Transferred a fresh or thawed embryo?", readOnly = true)
    private String embryoType6;

    @ExcelProperty(cellIndex = 16, cellName = "(16) 7th Embryo", readOnly = true)
    private String embryo7;

    @ExcelProperty(cellIndex = 17, cellName = "(17) Was the 7th Embryo Transferred a fresh or thawed embryo?", readOnly = true)
    private String embryoType7;

    @ExcelProperty(cellIndex = 18, cellName = "(18) 8th Embryo", readOnly = true)
    private String embryo8;

    @ExcelProperty(cellIndex = 19, cellName = "(19) Was the 8th Embryo Transferred a fresh or thawed embryo?", readOnly = true)
    private String embryoType8;

    @ExcelProperty(cellIndex = 20, cellName = "(20) 9th Embryo", readOnly = true)
    private String embryo9;

    @ExcelProperty(cellIndex = 21, cellName = "(21) Was the 9th Embryo Transferred a fresh or thawed embryo?", readOnly = true)
    private String embryoType9;

    @ExcelProperty(cellIndex = 22, cellName = "(22) 10th Embryo", readOnly = true)
    private String embryo10;

    @ExcelProperty(cellIndex = 23, cellName = "(23) Was the 10th Embryo Transferred a fresh or thawed embryo?", readOnly = true)
    private String embryoType10;

    @ExcelProperty(cellIndex = 24, cellName = "(24) 1st Date of Transfer", readOnly = true)
