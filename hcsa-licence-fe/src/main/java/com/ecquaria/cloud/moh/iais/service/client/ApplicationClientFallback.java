...
public class ApplicationClientFallback implements ApplicationClient {
    ...
    @Override
    public FeignResponseEntity<List<AppPremisesSelfDeclChklDto>> saveAllSelfDecl(List<SelfDeclaration> selfDeclList){
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<SelfDeclaration>> getSelfDeclRfiData(String groupId) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
