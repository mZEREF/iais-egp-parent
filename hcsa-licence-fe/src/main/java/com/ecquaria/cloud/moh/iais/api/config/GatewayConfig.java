...
public class GatewayConfig {
	...
	public static final String payment_registry_name = properties.getProperty("payment.registry.name");
	
	//MD5 key
	public static final String key = properties.getProperty("payment.md5.key");//"4783D627CE96817C5D5DBA6DADECD2F15ECA5D1F97A0FDD8C07CA43B50C143B6";
	...
	public static final String seller_email = properties.getProperty("payment.seller.email");

	//public static String notify_url = "http://192.168.6.80:8088/egp/commpymt/commpymt_notify.jsp";
	public static final String notify_url = properties.getProperty("payment.notify.url");
	...
	public static final String input_charset = properties.getProperty("payment.input.charset");//UTF_8

	public static final String sign_type = properties.getProperty("payment.sign.type");//RSA
