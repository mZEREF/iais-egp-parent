...
public class GatewayNetsNotify {
	...
	public static String verifyNotify(Map<String, String> fields) throws Exception{
		...
		if(sign_type != null && (sign_type.equals(GatewayConstants.SIGN_TYPE_MD5) || sign_type.equals(GatewayConstants.SIGN_TYPE_RSA)))
			verified = GatewayNetsCore.verifySign(sParaNew, sign, sign_type);
		...
		if(!verified){
	    	...
	    	map.put(GatewayConstants.REGISTRY_NAME_KEY, GatewayNetsConfig.payment_registry_name);
	    	...
	    	String ressign = "";
	    	if(sign_type != null && (sign_type.equals(GatewayConstants.SIGN_TYPE_MD5) || sign_type.equals(GatewayConstants.SIGN_TYPE_RSA)))
	    		ressign = GatewayNetsCore.buildSign(map, sign_type);
	    	
	    	sb.append('{').append('\"' + GatewayConstants.REGISTRY_NAME_KEY + "\":\"").append(GatewayNetsConfig.payment_registry_name).append("\",")
	    	...
	    	.append(GatewayNetsConfig.sign_type).append("\"}");
