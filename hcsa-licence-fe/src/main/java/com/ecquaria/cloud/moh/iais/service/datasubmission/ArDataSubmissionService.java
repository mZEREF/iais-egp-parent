...
public interface ArDataSubmissionService {
    ...
    DonorSampleDto getDonorSampleDto(String idType,String idNumber,String sampleType,String donorSampleCode,String sampleFromHciCode,String sampleFromOthers);
