...
public class GatewayPayNowSubmit {

    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) throws Exception {

        Map<String, String> sPara = GatewayPayNowCore.paraFilter(sParaTemp);
        String mysign = GatewayPayNowCore.buildSign(sPara, GatewayConfig.sign_type);
    ...
    public static String buildForm(Map<String, String> sParaTemp, String gateway, String strMethod,
        ...
        sbHtml.append("<form id=\"GatewayPayNowSubmit\" name=\"GatewayPayNowSubmit\" action=\"").append(gateway).append("_input_charset=").append(GatewayConfig.input_charset).append("\" method=\"").append(strMethod).append("\">");
        ...
        sbHtml.append("<script>document.forms['GatewayPayNowSubmit'].submit();</script>");
