...
public interface ValidateFlow {
   ...
   default void doValidatePremises(Map<String,String> map,String type,Integer index,String licenseeId, AppGrpPremisesDto appGrpPremisesDto, boolean needAppendMsg ,boolean rfi, List<String> premisesHciList,List<String> oldPremiseHciList){};
}
