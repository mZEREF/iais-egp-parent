 ...
 */
@FeignClient(name = "email-sms", configuration = FeignConfiguration.class, fallback = EmailHistoryCommonClientFallback.class)
public interface EmailHistoryCommonClient {
