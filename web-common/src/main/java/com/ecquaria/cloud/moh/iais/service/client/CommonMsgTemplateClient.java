...
@FeignClient(name = "system-admin", configuration = FeignConfiguration.class, fallback = CommonMsgTemplateClientFallback.class)
public interface CommonMsgTemplateClient {
