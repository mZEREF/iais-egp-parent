 ...
 * @author ShiCheng_Xu
 */
@FeignClient(name = "inter-inbox",configuration = FeignConfiguration.class,fallback = CommonFeMessageClientFallback.class)
public interface CommonFeMessageClient {
