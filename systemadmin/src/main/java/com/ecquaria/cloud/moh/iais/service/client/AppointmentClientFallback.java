...
public class AppointmentClientFallback implements AppointmentClient{
    ...
    @Override
    public FeignResponseEntity<ApptUserCalendarDto> getCalenderBySysUserCorrIdAndStatus(ApptAppInfoShowDto apptAppInfoShowDto) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<ApptUserSystemCorrelationDto>> getApptUserSystemCorrelationDtos(String srcSysId, String userAgencyId) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<ApptAgencyUserDto> getAgencyUserByUserSysCorrId(String userSysCorrId) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<ApptNonAvailabilityDateDto>> getNonAvailabilityListByApptRefNo(String apptRefNo) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
