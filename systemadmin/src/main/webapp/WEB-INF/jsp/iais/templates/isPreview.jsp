                ...
                <div class="center-content">
                    <div class="intranet-content">
                        ...
                        <div class="row" style="padding-bottom: 40px;">
                            <div class="col-md-4">
                                <span style="font-size: 1.6rem;font-family: Open Sans, sans-serif;font-weight:600;">Message Type</span>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="row" style="padding-bottom: 40px;">
                            <div class="col-md-4">
                                <span style="font-size: 1.6rem;font-family: Open Sans, sans-serif;font-weight:600;">Template Name</span>
                            </div>
                            <div class="col-md-8">
                            <span style="font-size: 1.6rem;font-weight:600;">
                        ...
                        <div class="row" style="padding-bottom: 40px;">
                            <div class="col-md-4">
                                <span style="font-size: 1.6rem;font-family: Open Sans, sans-serif;font-weight:600;">Delivery Mode</span>
                            </div>
                            <div class="col-md-8">
                            <span style="font-size: 1.6rem;font-weight:600;">
                        ...
                        <div class="row" style="padding-bottom: 40px;">
                            <div class="col-md-4">
                                <span style="font-size: 1.6rem;font-family: Open Sans, sans-serif;font-weight:600;">Effective Start Date</span>
                            </div>
                            <div class="col-md-8">
                            <span style="font-size: 1.6rem;font-weight:600;">
                        ...
                        <div class="row" style="padding-bottom: 40px;">
                            <div class="col-md-4">
                                <span style="font-size: 1.6rem;font-family: Open Sans, sans-serif;font-weight:600;">Effective End Date</span>
                            </div>
                            <div class="col-md-8">
                            <span style="font-size: 1.6rem;font-weight:600;">
                        ...
                        <div class="row" style="padding-bottom: 40px;">
                            <div class="col-md-12">
                                <span style="font-size: 1.6rem;font-family: Open Sans, sans-serif;font-weight:600;">Message Content</span>
                            </div>
                        </div>
                        <div class="row" style="padding-bottom: 40px;">
