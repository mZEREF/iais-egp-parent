                ...
                <div class="center-content">
                    <div class="intranet-content">
                        ...
                        <div class="form-group">
                            ...
                            <iais:value>
                                <div class="col-xs-8 col-sm-6 col-md-5">
                                    <input type="text" class="disable" name="name" value="${edit.getMsgName()}" readonly>
                                </div>
                            </iais:value>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <iais:value>
                                <div class="col-xs-8 col-sm-6 col-md-5">
                                    <input type="text" name="name" class="disable"  value="${edit.getMode()}" readonly>
                                </div>
                            </iais:value>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <iais:value>
                                <div class="col-xs-8 col-sm-6 col-md-5">
                                    <input id="name" type="text" name="name" class="disable"  value="${edit.getStatus()}" readonly>
                                </div>
                            </iais:value>
                        </div>
                    </div>
