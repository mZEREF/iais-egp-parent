...
public class GatewayNetsConfig {
	...
	public static final String nets_gateway_post_url = ConfigHelper.getString("eNets.payment.gateway.post.url");
	...
	public static final String timeout = ConfigHelper.getString("eNets.payment.timeout.ms");

	public static final String b2sUrl = ConfigHelper.getString("eNets.b2s.jsp.url");

	public static final String s2sUrl = ConfigHelper.getString("eNets.s2s.api.url");
