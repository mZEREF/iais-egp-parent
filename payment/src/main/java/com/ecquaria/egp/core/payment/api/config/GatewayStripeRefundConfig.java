...
@Slf4j
public class GatewayStripeRefundConfig {
	...
	public static final String payment_registry_name = properties.getProperty("stripeRefund.payment.registry.name");
	
	//MD5 key
	public static final String key = properties.getProperty("stripeRefund.payment.md5.key");//"4783D627CE96817C5D5DBA6DADECD2F15ECA5D1F97A0FDD8C07CA43B50C143B6";
	...
	public static final String rsa_private_key = properties.getProperty("rsa.private.key");
	...
	public static final String rsa_public_key = properties.getProperty("rsa.public.key");
	...
	public static final String rsa_gateway_public_key = properties.getProperty("rsa.gateway.private.key");
	
	public static final String seller_email = properties.getProperty("stripeRefund.payment.seller.email");

	//public static String notify_url = "http://192.168.6.80:8088/egp/commpymt/commpymt_notify.jsp";
	public static final String notify_url = properties.getProperty("stripeRefund.payment.notify.url");
	
	//"http://192.168.6.80:8088/egp/commpymt/commpymt_return.jsp";
	public static final String return_url = properties.getProperty("stripeRefund.payment.return.url");

	//"http://192.168.6.80:8088/egp/process/EGOV/CommPayment?";
	public static final String common_gateway_url = properties.getProperty("stripeRefund.payment.gateway.url");
	...
	public static final String common_gateway_service_url = properties.getProperty("stripeRefund.payment.gateway.service.url");
	
	
	//"D:\\alipay_log_" + System.currentTimeMillis() + ".txt";
	public static final String log_path = properties.getProperty("stripeRefund.payment.log.path");

	public static final String input_charset = properties.getProperty("stripeRefund.payment.input.charset");//UTF_8

	public static final String sign_type = properties.getProperty("stripeRefund.payment.sign.type");//RSA
