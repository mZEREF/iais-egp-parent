...
<div class="main-content">
    <form id="mainForm" method="post" action=<%=process.runtime.continueURL()%>>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4" style="float: right">
                <div class="button-group" >
                    <a class="btn btn-primary" onclick="Utils.submit('mainForm','doBack')">back</a>
            ...
            <div class="table-gp">
                <table aria-describedby="" class="table">
                    ...
                    <tr>
                        ...
                        <iais:sortableHeader style="width:30%" needSort="false"  field="GameName" value="GameName"></iais:sortableHeader>
                        <iais:sortableHeader style="width:30%" needSort="false"   field="GameDescription" value="GameDescription"></iais:sortableHeader>
                    </tr>
                    </thead>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4" style="float: right">
                <div class="button-group" >
                    <button type="button"  onclick="doAdd()"  class="btn btn-info" >ADD</button>
                </div>
            </div>
        </div>
    </form>
