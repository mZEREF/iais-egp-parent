...
<div class="main-content">
    <form id = "mainForm" method = "post" action=<%=process.runtime.continueURL()%>>
        ...
        <br>
        <br>
        <div class="bg-title"><h2>Category</h2></div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-12">
                    ...
                    <div class="text-right">
                        ...
                        <button type="button"  onclick="doAdd()"  class="btn btn-secondary" style="float: left" >ADD</button>
            ...
            <div class="table-gp">
                <table aria-describedby="" class="table">
                    ...
                    <tr>
                        ...
                        <iais:sortableHeader style="width:20%" needSort="true"  field="category_Name" value="Category Name"></iais:sortableHeader>
                        <iais:sortableHeader style="width:20%" needSort="true"  field="category_No" value="Category NO"></iais:sortableHeader>
                        <iais:sortableHeader style="width:20%" needSort="true"   field="category_Description" value="Category Description"></iais:sortableHeader>
                    ...
                    <c:forEach var = "category" items = "${categorySearchResult.rows}" varStatus="status">
                        <tr>
                            ...
                            <td align="left" style="width: 30%"><iais:code code="${category.categoryName}"></iais:code></td>
                            ...
                            <td align="left" style="width: 10%">
                                <button type="button" value="${category.id}" onclick="prepareEdit('<iais:mask name="categoryId" value="${category.id}"/>')"  class="btn btn-default btn-sm" >Edit</button>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
