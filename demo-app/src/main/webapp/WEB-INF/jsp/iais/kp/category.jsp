...
<div class="main-content">
    <form id = "mainForm" method = "post" action=<%=process.runtime.continueURL()%>>
        ...
        <br>
        <br>
        <div class="bg-title"><h2>Game Categories</h2></div>
        <div class="form-horizontal">
            <div class="form-group">
                <iais:field value="Type" required="true"/>
                <iais:value width="7">
                    <iais:select name="categoryName" id="categoryName" options="categoryNameSelect" firstOption="Please Select" value="${categoryName}"></iais:select>
                </iais:value>
            </div>
            <div class="row">
        ...
        <div class="components">
            ...
            <iais:pagination  param="categorySearchParam" result="categorySearchResult"/>
            <div class="table-gp">
                <table aria-describedby="" class="table">
                    <thead>
                    <tr>
                        <iais:sortableHeader style="width:20%" needSort="false"  field="" value="S/N" ></iais:sortableHeader>
                        <iais:sortableHeader style="width:20%" needSort="true"  field="category_No" value="category_no"></iais:sortableHeader>
                        <iais:sortableHeader style="width:20%" needSort="true"   field="category_Name" value="category_name"></iais:sortableHeader>
                        <iais:sortableHeader style="width:20%" needSort="true"   field="category_Description" value="category_Description"></iais:sortableHeader>
                    ...
                    <tbody style="text-align: left">
                        ...
                        <c:forEach var = "category" items = "${categorySearchResult.rows}" varStatus="status">
                            <tr>
                                <td align="left" class="row_no" style="width: 5px">
                                        ${(status.index + 1) + (categorySearchParam.pageNo - 1) * categorySearchParam.pageSize}
                                </td>
                                <td align="left" style="width: 30%"><iais:code code="${category.categoryNo}"></iais:code></td>
                                ...
                                <td align="left" style="width: 10%">
                                    <button type="button" value="${category.id}"
                                            onclick="prepareEdit('<iais:mask name="categoryId" value="${category.id}"/>')"  class="btn btn-default btn-sm" >
                                        Edit</button>
                                </td>
                            </tr>
                        </c:forEach>
