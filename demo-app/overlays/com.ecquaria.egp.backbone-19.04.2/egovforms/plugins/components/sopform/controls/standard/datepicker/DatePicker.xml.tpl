...
<Control type="${control.FQN}" ref="${control.properties.name}"
	...
	<Properties>
		...
		<Entry name="format"><String>${control.properties.format|escape}</String></Entry>
		<Entry name="options"><String>${control.properties.options|escape}</String></Entry>
        ...
        <Entry name="myInfo"><String>${control.properties.myInfo|escape}</String></Entry>
