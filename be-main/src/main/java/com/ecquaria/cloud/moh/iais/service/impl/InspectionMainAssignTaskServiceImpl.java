...
public class InspectionMainAssignTaskServiceImpl implements InspectionMainAssignTaskService {
        ...
        if (StringUtil.isNotEmpty(appGrpPremisesDto.getPremisesType())) {
            if(hcsaTaskAssignDto != null && hcsaTaskAssignDto.getAppPremisesAllUnitNoStrMap() != null) {
                ...
                result = IaisCommonUtils.getAddressForApp(appGrpPremisesDto.getBlkNo(), appGrpPremisesDto.getStreetName(),
                        appGrpPremisesDto.getBuildingName(),
        ...
        if(stageRoleMap != null){
            ...
            if(updateTask != null) {
                ...
                for (Map.Entry<String, String> map : stageRoleMap.entrySet()) {
                    ...
                    String processUrl = td.getProcessUrl();
                    if(!applicationDto.getStatus().equals(ApplicationConsts.APPLICATION_STATUS_PENDING_BROADCAST)){
    ...
    public List<HcsaSvcStageWorkingGroupDto> generateHcsaSvcStageWorkingGroupDtos(List<ApplicationDto> applicationDtos, String stageId){
        ...
        for(ApplicationDto applicationDto : applicationDtos){
            AppGrpPremisesDto appGrpPremisesEntityDto = hcsaAppClient.getActivePremisesByAppNo(applicationDto.getApplicationNo()).getEntity();
