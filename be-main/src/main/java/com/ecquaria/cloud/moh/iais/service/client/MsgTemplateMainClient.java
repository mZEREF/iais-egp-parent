...
@FeignClient(name = "system-admin", configuration = FeignConfiguration.class, fallback = MsgTemplateMainClientFallback.class)
public interface MsgTemplateMainClient {
