...
public interface BeInspectionStatusClient {
    @GetMapping(path = "/iais-AppInspecStatus/search-status-swo/{status}", produces = MediaType.APPLICATION_JSON_VALUE,
    ...
    @GetMapping(path = "/iais-AppInspecStatus/search-status-three/{appPremCorreId}", produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = {MediaType.APPLICATION_JSON_VALUE})
