...
<div class="dashboard" style="background-image:url('<%=webroot%>img/Masthead-banner.jpg')">
  <form method="post" id="beDashComConfirmForm" action=<%=process.runtime.continueURL()%>>
...
<script type="text/javascript">
    function intraDashComConfirmBack() {
        showWaiting();
    ...
    function intraDashComConfirmSubmit(action){
        $("[name='hcsaBeDashboardSwitchType']").val(action);
        var mainPoolForm = document.getElementById('beDashComConfirmForm');
        mainPoolForm.submit();
    }
</script>
