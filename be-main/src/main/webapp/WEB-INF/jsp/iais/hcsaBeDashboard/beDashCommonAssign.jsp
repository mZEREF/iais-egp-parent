            ...
            <div class="intranet-content">
              ...
              <iais:body >
                <iais:section title="" id = "assign_Task">
                  ...
                  <iais:action >
                    <a class="back" id="Back" onclick="javascript:intraDashComAssignBack()" style="float:left"><em class="fa fa-angle-left"></em> Back</a>
                    <button class="btn btn-primary" style="float:right" type="button" onclick="javascript:intraDashComAssignNext()">Next</button>
                  </iais:action>
                </iais:section>
              </iais:body>
            </div>
...
<script type="text/javascript">
    ...
    function intraDashComAssignNext() {
        showWaiting();
        $("[name='actionValue']").val('comcon');
        intraDashComAssignSubmit('comcon');
    }
    function intraDashComAssignSubmit(action){
        $("[name='hcsaBeDashboardSwitchType']").val(action);
        var mainPoolForm = document.getElementById('beDashCommonAssignForm');
        mainPoolForm.submit();
    }
</script>
