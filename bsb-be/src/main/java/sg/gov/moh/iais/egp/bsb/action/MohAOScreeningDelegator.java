    ...
    public void process(BaseProcessClass bpc){
        ...
        switch (processingDecision) {
            case MOH_PROCESSING_DECISION_APPROVE:
                ...
                ParamUtil.setRequestAttr(request,TaskModuleConstants.KEY_NEXT_TASK,MasterCodeConstants.APP_STATUS_PEND_SUBMIT_SELF_ASSESSMENT);
            ...
            case MOH_PROCESSING_DECISION_ROUTE_BACK_TO_DO:
                ...
                ParamUtil.setRequestAttr(request,TaskModuleConstants.KEY_NEXT_TASK, MasterCodeUtil.getCodeDesc(MasterCodeConstants.APP_STATUS_PEND_DO)+" Screening");
