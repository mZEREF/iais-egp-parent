...
public class CheckListCommonValidate {
    ...
    public static boolean verifyQuestionDto(String answer, String remark, String ncs, boolean isError, String prefix, Map<String, String> errMap, boolean moreIns){
    ...
    public static boolean  verifyQuestionDto(String answer, String remark, String ncs, boolean isError, String prefix, Map<String, String> errMap){
