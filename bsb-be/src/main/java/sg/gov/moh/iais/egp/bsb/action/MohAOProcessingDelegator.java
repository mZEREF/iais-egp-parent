...
public class MohAOProcessingDelegator {
    private static final String FUNCTION_NAME = "AO Processing";

    private final ProcessClient processClient;
    private final RoutingHistoryClient routingHistoryClient;

    @Autowired
    public MohAOProcessingDelegator(ProcessClient processClient, RoutingHistoryClient routingHistoryClient) {
    ...
    public void prepareData(BaseProcessClass bpc) {
        ...
        if (StringUtils.hasLength(maskedAppId) && StringUtils.hasLength(maskedTaskId)){
            ...
            if (appId != null && taskId != null){
                ResponseDto<MohProcessDto> mohProcessDtoResponseDto = processClient.getAOProcessingDataByAppId(appId);
    ...
    public void prepareSwitch(BaseProcessClass bpc){
        ...
        AOProcessingDto aoProcessingDto = mohProcessDto.getAoProcessingDto();
        aoProcessingDto.reqObjMapping(request);
        mohProcessDto.setAoProcessingDto(aoProcessingDto);
    ...
    public void process(BaseProcessClass bpc){
        ...
        processClient.saveAOProcessing(mohProcessDto);
