...
@Slf4j
@Component
@JobHandler("expireFacilityJob")
public class ExpireFacilityJob extends IJobHandler{

    private final AutoRenewalClient autoRenewalClient;

    @Autowired
    public ExpireFacilityJob(AutoRenewalClient autoRenewalClient) {
    ...
    public ReturnT<String> execute(String s) throws Exception {
        try{
            autoRenewalClient.expireFacilitiesInNeed();
