...
public class IncidentMOHProcessService {
    ...
    private List<String> getScheduleTypeList(){
        ...
        scheduleTypeList.add(MasterCodeConstants.FIRST_SCHEDULE_PART_1);
        scheduleTypeList.add(MasterCodeConstants.FIRST_SCHEDULE_PART_2);
    ...
    private void showBasicInformation(HttpServletRequest request,IncidentNotificationDto incidentNotificationDto,String maskedAppId,String maskedTaskId){
        ...
        Map<String,DocDisplayDto> repoIdDocMap = CollectionUtils.uniqueIndexMap(DocDisplayDto::getFileRepoId, incidentDocs);
    ...
    private void viewBasicDoc(List<DocRecordInfo> docRecordInfos,HttpServletRequest request){
        Map<String,List<DocRecordInfo>> docMap = CollectionUtils.groupCollectionToMap(DocRecordInfo::getDocType, docRecordInfos);
        Map<String,DocRecordInfo> repoIdDocMap = CollectionUtils.uniqueIndexMap(DocRecordInfo::getRepoId, docRecordInfos);
        ParamUtil.setSessionAttr(request,PARAM_REPO_ID_FILE_MAP,new HashMap<>(repoIdDocMap));
