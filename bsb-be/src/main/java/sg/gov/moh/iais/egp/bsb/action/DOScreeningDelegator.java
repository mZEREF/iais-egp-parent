...
public class DOScreeningDelegator {
    ...
    public void screenedByDO(BaseProcessClass bpc) throws ParseException{
        ...
        FeignResponseEntity<Application> result = revocationClient.saveApplication(application);
        ...
        application.setId(result.getEntity().getId());
        ...
        routingHistory.setApplicationNo(result.getEntity().getApplicationNo());
