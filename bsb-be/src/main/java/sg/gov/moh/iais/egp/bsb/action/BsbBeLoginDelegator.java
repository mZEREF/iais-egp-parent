...
public class BsbBeLoginDelegator {
    ...
    public void afterSubmit(BaseProcessClass bpc){
        ...
        String jwtt = encoder.encode(claims, BASE64_ENCODED_PRIV);
