...
public class MohDOScreeningDelegator {
    ...
    public void prepareData(BaseProcessClass bpc) {
        ...
        MohProcessDto mohProcessDto = mohProcessService.getMohProcessDto(request, appId, MODULE_NAME_DO_SCREENING);
    ...
    public void prepareSwitch(BaseProcessClass bpc){
        ...
        //validation
        ValidationResultDto validationResultDto = processClient.validateMohProcessDto(mohProcessDto, MODULE_NAME_DO_SCREENING);
