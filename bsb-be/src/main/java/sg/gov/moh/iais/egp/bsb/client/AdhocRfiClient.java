...
public interface AdhocRfiClient {
    ...
    @GetMapping(value = "/adhoc-rfi/pre-newRfi/{facilityId}", consumes = MediaType.APPLICATION_JSON_VALUE, produces =MediaType.APPLICATION_JSON_VALUE)
    ResponseDto<NewAdhocRfiDto> queryPreNewData(@PathVariable("facilityId") String facilityId);
