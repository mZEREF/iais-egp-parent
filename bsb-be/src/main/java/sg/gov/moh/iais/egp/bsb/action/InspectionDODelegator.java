...
import sg.gov.moh.iais.egp.bsb.dto.inspection.ChecklistInfoDto;
...
import static com.ecquaria.cloud.moh.iais.common.constant.BsbAuditTrailConstants.FUNCTION_INSPECTION_CHECKLIST;
...
import static sg.gov.moh.iais.egp.bsb.constant.module.ModuleCommonConstants.KEY_CHECKLIST_INFO;
import static sg.gov.moh.iais.egp.bsb.constant.module.ModuleCommonConstants.KEY_FACILITY_DETAILS_INFO;
import static sg.gov.moh.iais.egp.bsb.constant.module.ModuleCommonConstants.KEY_INSPECTION_PROCESS_DTO;
...
public class InspectionDODelegator {
    ...
    public void start(BaseProcessClass bpc) {
        ...
        AuditTrailHelper.auditFunction(MODULE_INSPECTION, FUNCTION_INSPECTION_CHECKLIST);
    }
    ...
    public void init(BaseProcessClass bpc) {
        ...
        session.removeAttribute(KEY_CHECKLIST_INFO);
        ...
        ChecklistInfoDto checklistInfoDto = initDataDto.getChecklistInfoDto();
        ParamUtil.setSessionAttr(request,KEY_CHECKLIST_INFO,checklistInfoDto);
    }
    ...
    public void bindAction(BaseProcessClass bpc) {
        ...
        InspectionProcessDto inspectionProcessDto = new InspectionProcessDto();
        inspectionProcessDto.reqObjMapping(request);
        ParamUtil.setSessionAttr(request,KEY_INSPECTION_PROCESS_DTO,inspectionProcessDto);
    }
    ...
    public void saveDraft(BaseProcessClass bpc) {
        ...
        if (!errMap.isEmpty()) {
            ...
            ParamUtil.setRequestAttr(request, ModuleCommonConstants.AFTER_SAVE_DRAFT, Boolean.TRUE);
        }
        ParamUtil.setSessionAttr(request, SERLISTDTO, serListDto);
    }
    ...
    public void handleSubmit(BaseProcessClass bpc) {
        ...
        InspectionProcessDto inspectionProcessDto = (InspectionProcessDto) ParamUtil.getSessionAttr(request,KEY_INSPECTION_PROCESS_DTO);
        ValidationResultDto validationResultDto = inspectionClient.validateActualInspectionCombineCheckList(inspectionProcessDto);
        String route;
        if (validationResultDto.isPass() || (StringUtils.hasLength(actionValue) && "noValidate".equals(actionValue))) {
            inspectionClient.submitInspectionFindingChangeStatusToReport(inspectionProcessDto);
    ...
    public void doUpload(BaseProcessClass bpc) {
        ...
        ParamUtil.setRequestAttr(request, "ackMsg", "BISINSACK001");
    }
