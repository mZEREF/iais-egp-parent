...
public interface AutoRenewalClient {
    ...
    @PostMapping(value = "/autoRenewal/setFacilitiesRenewable")
    FeignResponseEntity<Void> setFacilitiesRenewable();

    @PostMapping(value = "/autoRenewal/suspendFacilities")
    FeignResponseEntity<Void> suspendFacilitiesInNeed();

    @PostMapping(value = "/autoRenewal/expireFacilities")
    FeignResponseEntity<Void> expireFacilitiesInNeed();
}
