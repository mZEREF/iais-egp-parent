...
public class PrimaryDocDto implements Serializable{
    ...
    public List<DocMeta> doValidation(String module) {
     ...
     * <p>
     * This method will generate id-bytes pairs at the same time, the result will be used to sync files to FE.
     *
     * @return a list of file data to be synchronized to FE
     */
    ...
    public void reqObjMapping(HttpServletRequest request,String docType) {
        ...
        if (StringUtils.hasLength(deleteSavedFilesString)) {
            ...
            deleteFileRepoIds.forEach(it -> {
                toBeDeletedDocIds.add(this.savedDocMap.remove(it).getDocEntityId());
