...
public class MohDOProcessingDelegator {
    ...
    @Autowired
    public MohDOProcessingDelegator(ProcessClient processClient) {
    ...
    public void prepareData(BaseProcessClass bpc) {
        ...
        if (StringUtils.hasLength(maskedAppId) && StringUtils.hasLength(maskedTaskId)){
            ...
            if (appId != null && taskId != null){
                ResponseDto<MohProcessDto> mohProcessDtoResponseDto = processClient.getDOProcessingDataByAppId(appId);
    ...
    public void prepareSwitch(BaseProcessClass bpc){
        ...
        DOProcessingDto doProcessingDto = mohProcessDto.getDoProcessingDto();
        doProcessingDto.reqObjMapping(request);
        mohProcessDto.setDoProcessingDto(doProcessingDto);
    ...
    public void process(BaseProcessClass bpc){
        ...
        processClient.saveDOProcessing(mohProcessDto);
    }
}