...
<script type="text/javascript" src="<%=WEB_ROOT%>/js/bsb/bsb-facility_approval_do_radio.js"></script>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="table-gp">
                                                        <div class="form-horizontal">
                                                                ...
                                                                <div class="col-sm-7 col-md-5 col-xs-10">
                                                                    <div class="input-group">
                                                                        <select name="selectMohUser" id="selectMohUser">
                                                                            ...
                                                                            <c:forEach var="ao" items="${aoSelectionOps}">
                                                                                <option value="${ao.value}" <c:if test="${processDto.selectMohUser eq ao.value}">selected="selected"</c:if>>${ao.text}</option>
                                                                            </c:forEach>
                                                                        </select>
                                                            ...
                                                            <%--@elvariable id="rfiProcessDto" type="sg.gov.moh.iais.egp.bsb.dto.rfi.RfiProcessDto"--%>
                                                            <common:rfi processingDecision="${processDto.processingDecision}" commentsToApplicant="${processDto.commentsToApplicant}" rfiProcessDto="${rfiProcessDto}">
                                                            </common:rfi>
                                                            <div class="form-group">
