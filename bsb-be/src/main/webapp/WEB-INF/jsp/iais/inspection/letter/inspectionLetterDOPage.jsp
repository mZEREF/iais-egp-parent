                                                ...
                                                <div class="col-xs-12">
                                                    <div class="table-gp">
                                                        <div class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7 col-md-5 col-xs-10">
                                                                    <select name="processingDecision"  class="processingDecisionDropdown" id="processingDecision" data-app-status="${submissionDetailsInfo.applicationStatus}">
                                                                        ...
                                                                        <option value="${MasterCodeConstants.MOH_PROCESS_DECISION_ROUTE_TO_AO_FOR_APPROVAL}" <c:if test="${letterDto.decision eq MasterCodeConstants.MOH_PROCESS_DECISION_ROUTE_TO_AO_FOR_APPROVAL}">selected="selected"</c:if>>Route to AO for Approval</option>
                                                                    </select>
                                                                </div>
                                                                <div class="clear"></div>
                                                            </div>
                                                            ...
                                                            <div class="form-group" id="selectMohUserDiv" <c:if test="${letterDto.decision ne MasterCodeConstants.MOH_PROCESS_DECISION_ROUTE_TO_AO_FOR_APPROVAL}">style="display: none;"</c:if>>
