          ...
          <c:forEach var="info" items="${newDocMap.values()}" varStatus="status">
            <tr id="${info.disPlayDto.maskedRepoId}FileTr">
              ...
              <td>
                ...
                <p ><c:out value="${reviewAFCReportDto.maxRound}"/></p>
              </td>
              <td>
          ...
          <c:forEach var="docInfo" items="${reviewAFCReportDto.certificationDocDisPlayDtos}" varStatus="status">
            <tr id="${docInfo.maskedRepoId}FileTr">
              ...
              <td>
                <p class="visible-xs visible-sm table-row-title">MOH</p>
                <c:choose>
                  <c:when test="${canActionRole eq 'BSB_DO' and docInfo.roundOfReview == reviewAFCReportDto.maxRound and docInfo.submitterRole ne 'MOH' and reviewAFCReportDto.lastUploadRole eq docInfo.submitterRole}">
...
<%--                  <c:when test="${canActionRole eq 'BSB_AO' and docInfo.roundOfReview == reviewAFCReportDto.maxRound and docInfo.submitterRole ne 'MOH' and reviewAFCReportDto.lastUploadRole eq docInfo.submitterRole}">--%>
