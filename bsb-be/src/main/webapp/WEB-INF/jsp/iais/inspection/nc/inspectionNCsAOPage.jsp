                                                    ...
                                                    <div class="table-gp">
                                                        <div class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7 col-md-5 col-xs-10">
                                                                    <select name="processingDecision" class="processingDecisionDropdown" id="processingDecision" data-app-status="${submissionDetailsInfo.applicationStatus}">
                                                                        ...
                                                                        <option value="${MasterCodeConstants.MOH_PROCESS_DECISION_APPROVE}" <c:if test="${insDecision.decision eq MasterCodeConstants.MOH_PROCESS_DECISION_APPROVE}">selected="selected"</c:if>>Accept</option>
                                                                    </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7 col-md-5 col-xs-10">
                                                                    <textarea autocomplete="off" class="col-xs-12" name="remarks" id="remarks" maxlength="1500" style="width: 100%"></textarea>
