                                ...
                                <div class="tab-gp dashboard-tab">
                                    <ul class="nav nav-tabs hidden-xs hidden-sm" role="tablist">
                                        ...
                                        <li <c:if test="${activeTab eq InspectionConstants.TAB_RECTIFICATION}">class="active"</c:if> id="rectification" role="presentation">
                                            <a href="#${InspectionConstants.TAB_APPROVAL_LETTER}" id="doRectification" aria-controls="tabEmail" role="tab" data-toggle="tab">NC Letter</a>
                                        </li>
                                    ...
                                    <div class="tab-nav-mobile visible-xs visible-sm">
                                        <div class="swiper-wrapper" role="tablist">
                                            ...
                                            <div class="swiper-slide">
                                                <a href="#${InspectionConstants.TAB_APPROVAL_LETTER}" aria-controls="tabEmail" role="tab" data-toggle="tab">NC Letter</a>
                                            </div>
                                            <div class="swiper-slide">
                                                    ...
                                                    <div class="table-gp">
                                                        <div class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7 col-md-5 col-xs-10">
                                                                    <select name="processingDecision"  class="processingDecisionDropdown" id="processingDecision">
                                                                        ...
                                                                        <option value="${MasterCodeConstants.MOH_PROCESS_DECISION_ROUTE_BACK_TO_DO}" <c:if test="${ncEmailDto.decision eq ''}">selected="selected"</c:if>>Route back to DO</option>
                                                                        <option value="${MasterCodeConstants.MOH_PROCESS_DECISION_APPROVE_AND_ROUTE_TO_APPLICANT}" <c:if test="${ncEmailDto.decision eq MasterCodeConstants.MOH_PROCESS_DECISION_APPROVE_AND_ROUTE_TO_APPLICANT}">selected="selected"</c:if>>Approve and route to Applicant</option>
                                                                    </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7 col-md-5 col-xs-10">
                                                                    <textarea autocomplete="off" class="col-xs-12" name="remarks" id="remarks" maxlength="1000" rows="4"><c:out value="${ncEmailDto.remark}"/></textarea>
