                                                                ...
                                                                <div class="col-sm-7 col-md-5 col-xs-10">
                                                                    <div class="input-group">
                                                                        <select name="processingDecision" class="processingDecisionDropDown" id="processingDecision">
                                                                            ...
                                                                            <option value="${MasterCodeConstants.MOH_PROCESS_DECISION_ACCEPT_AND_ROUTE_INSPECTION_REPORT_TO_APPLICANT}" <c:if test="${insDecision.decision eq MasterCodeConstants.MOH_PROCESS_DECISION_ACCEPT_AND_ROUTE_INSPECTION_REPORT_TO_APPLICANT}">selected="selected"</c:if>>Accept & Route Inspection Report to Applicant</option>
                                                                            <option value="${MasterCodeConstants.MOH_PROCESS_DECISION_ROUTE_BACK_TO_DO_FOR_REVISION}" <c:if test="${insDecision.decision eq MasterCodeConstants.MOH_PROCESS_DECISION_ROUTE_BACK_TO_DO_FOR_REVISION}">selected="selected"</c:if>>Route back to DO for revision</option>
                                                                        </select>
