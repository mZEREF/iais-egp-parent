                                                ...
                                                <div class="col-xs-12">
                                                    <div class="table-gp">
                                                        <div class="form-horizontal">
                                                                ...
                                                                <div class="col-sm-7 col-md-5 col-xs-10">
                                                                    <div class="input-group">
                                                                        <select name="processingDecision" class="processingDecisionDropDown" id="processingDecision" data-app-status="${submissionDetailsInfo.applicationStatus}">
                                                                            ...
                                                                            <option value="${MasterCodeConstants.MOH_PROCESS_DECISION_MARK_AS_FINAL_AND_ROUTE_TO_AO}" <c:if test="${insDecision.decision eq MasterCodeConstants.MOH_PROCESS_DECISION_MARK_AS_FINAL_AND_ROUTE_TO_AO}">selected="selected"</c:if>>Mark as final and route to AO</option>
                                                                        </select>
                                                            ...
                                                            <div class="form-group" id="selectMohUserDiv" <c:if test="${insDecision.decision ne MasterCodeConstants.MOH_PROCESS_DECISION_MARK_AS_FINAL_AND_ROUTE_TO_AO}">style="display: none;"</c:if>>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-xs-12 col-md-4 control-label">Edit Non-Compliance Notification Email</label>
                                                                <div class="col-sm-7 col-md-5 col-xs-10 control-label">
                                                                    <p>
                                                                        <input type="checkbox" name="ncEmailRequired" id="ncEmailRequired" value="Y" <c:if test="${insDecision.ncEmailRequired eq 'Y'}">checked="checked"</c:if>/>
                                                                    </p>
