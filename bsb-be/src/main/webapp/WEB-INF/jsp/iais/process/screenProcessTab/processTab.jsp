            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7 col-md-5 col-xs-10 control-label">
                        <div class="form-check col-xs-4 col-sm-5 col-lg-3" style="margin-top: 6px; padding: 0;">
                            <input class="form-check-input" type="radio" id="inspectionRequiredY" name="inspectionRequired" value = "${MasterCodeConstants.YES}" <c:if test="${MasterCodeConstants.YES eq mohProcessDto.inspectionRequired || (mohProcessDto.inspectionRequired eq null && MasterCodeConstants.PROCESS_TYPE_FAC_REG eq mohProcessDto.submissionDetailsInfo.applicationSubType)}">checked="checked"</c:if>/>
                ...
                <c:if test="${mohProcessDto.facilityDetailsInfo.classification eq 'FACCLA001' or mohProcessDto.facilityDetailsInfo.classification eq 'FACCLA002'}">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 col-md-5 col-xs-10 control-label">
                            <div class="form-check col-xs-4 col-sm-5 col-lg-3" style="margin-top: 6px; padding: 0;">
                                <input class="form-check-input" type="radio" id="certificationRequiredY" name="certificationRequired" value = "${MasterCodeConstants.YES}" <c:if test="${MasterCodeConstants.YES eq mohProcessDto.certificationRequired || (mohProcessDto.certificationRequired eq null && MasterCodeConstants.PROCESS_TYPE_FAC_REG eq mohProcessDto.submissionDetailsInfo.applicationSubType)}">checked="checked"</c:if>/>
