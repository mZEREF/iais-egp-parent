<%@ taglib prefix="code" uri="http://www.ecq.com/iais" %>
                    ...
                    <c:forEach var="info" items="${approvalProfile.batInfos}">
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.batName}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.prodMaxVolumeLitres}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.lspMethod}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.facilityNameOfTransfer}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.expectedDateOfImport}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.contactPersonNameOfTransfer}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.impCtcPersonNo}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.contactPersonEmailOfTransfer}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.transferFacAddr1}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.transferFacAddr2}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.transferFacAddr3}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.transferCountry}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.transferCity}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.transferState}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.transferPostalCode}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.courierServiceProviderName}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-md-5 col-xs-7"><p><c:out value="${info.remarks}"/></p></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                    </c:forEach>
