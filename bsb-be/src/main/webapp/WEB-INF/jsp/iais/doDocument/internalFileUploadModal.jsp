                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-8 col-md-8">
                                <label for="internalFileType"></label><select name="internalFileType" id="internalFileType">
                                    <option value="">Please Select</option>
                                    <c:forEach var="docType" items="${internalDocTypes}">
                                        <option value="${docType}"><iais:code code="${docType}"/></option>
                                    </c:forEach>
                                </select>
