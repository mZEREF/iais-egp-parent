            ...
            <div class="panel-main-content">
                <iais:section title="">
                    ...
                    <iais:row>
                        <iais:field value="Facility Classification"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="facilityClassification" options="facilityClassification" firstOption="Please Select"></iais:select>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Facility Type "/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="facilityType" options="facilityType"  firstOption="Please Select" multiSelect="true"></iais:select>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Schedule Type"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="scheduleType" options="scheduleType"  firstOption="Please Select"></iais:select>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Biological Agent/Toxin"/>
                    ...
                    <iais:row>
                        ...
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="nature_of_the_sample" options="nots"  firstOption="Please Select" multiSelect="true"></iais:select>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Risk Level of the Biological Agent/Toxin"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="rlotba" options="rlotba" firstOption="Please Select"></iais:select>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Approval Type"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="approvalType" options="approvalType"  firstOption="Please Select"></iais:select>
                        </div>
                    </iais:row>
                    <iais:row>
                    ...
                    <iais:row>
                        ...
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="approvalStatus" options="approvalStatus" firstOption="Please Select"></iais:select>
                        </div>
                    </iais:row>
                    <iais:row>
