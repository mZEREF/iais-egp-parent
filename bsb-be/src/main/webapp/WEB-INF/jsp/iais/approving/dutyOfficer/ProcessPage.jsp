                                    ...
                                    <div class="tab-gp dashboard-tab">
                                        <ul class="nav nav-tabs hidden-xs hidden-sm" role="tablist">
                                            ...
                                            <li id="process" role="presentation">
                                                <a href="#tabScreening" aria-controls="tabScreening" role="tab" data-toggle="tab">Processing</a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tabInspectionOrCertification" role="tabpanel">
                                                <%@include file="/WEB-INF/jsp/iais/approving/inspectionOrCertification.jsp" %>
                                            </div>
                                            ...
                                            <div class="tab-pane" id="tabScreening" role="tabpanel">
                                                                ...
                                                                <iais:section title="">
                                                                        ...
                                                                        <iais:row>
                                                                            ...
                                                                            <iais:value width="6">
                                                                                <select id="RiskLeveloftheBiologicalAgentOrToxinSelectId">
                                                                                    ...
                                                                                    <option value="3">Reduced risk</option>
                                                                                </select>
                                                                            </iais:value>
                                                                        </iais:row>
                                                                    </div>
                                                                    <div id="CommentsOnRiskLevelAssessment">
                                                                        <iais:row>
                                                                            ...
                                                                            <iais:value width="10">
                                                                                <div class="input-group">
                                                                                    <div class="ax_default text_area">
                                                                                        <textarea id="riskLevelId" name="riskLevel" cols="70" rows="7" maxlength="500"></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </iais:value>
                                                                        </iais:row>
                                                                        ...
                                                                        <iais:row>
                                                                            ...
                                                                            <iais:value width="6">
                                                                                <select id="ProcessingDecisionSelectId">
                                                                                    ...
                                                                                    <option value="3">Recommend Rejection</option>
                                                                                </select>
                                                                    ...
                                                                    <div id="SelectedApprovedFacilityCertifier">
                                                                        <iais:row>
                                                                            ...
                                                                            <iais:value width="10">
                                                                                <iais:value width="10"><p>ACF1</p></iais:value>
                                                                            </iais:value>
                                                                        </iais:row>
                                                                    </div>
                                                                    ...
                                                                    <div id="FinalRemarks">
                                                                        <iais:row>
                                                                            ...
                                                                            <iais:value width="6">
                                                                                <select id="FinalRemarksSelectId">
                                                                                    <option value="-1">Please Select</option>
                                                ...
                                                <%@include file="/WEB-INF/jsp/iais/approving/processHistory.jsp"%>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $("#submitButton").click(function (){
        ...
        if(validityStartDate != null && validityStartDate != "" && validityEndDate != null && validityEndDate != "" && internalInspectionReport != null || internalInspectionReport != "" && index != -1){
            if(index == 1){
                SOP.Crud.cfxSubmit("mainForm", "RecommendApproval");
            }else if(index == 2){
                SOP.Crud.cfxSubmit("mainForm", "RequestForInformation");
            }else if(index == 3){
                SOP.Crud.cfxSubmit("mainForm", "RecommendRejection");
            }
        }
    })
</script>