                                    ...
                                    <div class="tab-gp dashboard-tab">
                                        <ul class="nav nav-tabs hidden-xs hidden-sm" role="tablist">
                                            ...
                                            <li id="process" role="presentation">
                                                <a href="#tabScreening" aria-controls="tabScreening" role="tab" data-toggle="tab">Decision</a>
                                            </li>
                                        </ul>
                                        <div class="tab-nav-mobile visible-xs visible-sm">
                                            <div class="swiper-wrapper" role="tablist">
                                                ...
                                                <div class="swiper-slide">
                                                    <a href="#tabProcessing" id="doProcess" aria-controls="tabProcessing" role="tab" data-toggle="tab">Decision</a>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <iais:section title="">
                                                                    ...
                                                                    <div id="AOReviewDecision">
                                                                        <iais:row>
                                                                            ...
                                                                            <iais:value width="10"><p>Some Decision</p></iais:value>
                                                                        </iais:row>
                                                                    </div>
                                                                    <div id="AORemarks">
                                                                        <iais:row>
                                                                            <iais:field value="AO Remarks" required="false" width="12"/>
                                                                            <iais:value width="10"><p>Some Remarks</p></iais:value>
                                                                        </iais:row>
                                                                    </div>
                                                                    <div id="HMRemarks">
                                                                        <iais:row>
