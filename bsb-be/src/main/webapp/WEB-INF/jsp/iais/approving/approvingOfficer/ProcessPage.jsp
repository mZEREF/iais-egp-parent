                                    ...
                                    <div class="tab-gp dashboard-tab">
                                        <ul class="nav nav-tabs hidden-xs hidden-sm" role="tablist">
                                            ...
                                            <li id="process" role="presentation">
                                                <a href="#tabScreening" aria-controls="tabScreening" role="tab" data-toggle="tab">Reviews and Approves</a>
                                            </li>
                                        </ul>
                                        <div class="tab-nav-mobile visible-xs visible-sm">
                                            <div class="swiper-wrapper" role="tablist">
                                                ...
                                                <div class="swiper-slide">
                                                    <a href="#tabProcessing" id="doProcess" aria-controls="tabProcessing" role="tab" data-toggle="tab">Reviews and Approves</a>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <iais:section title="">
                                                                    <div id="DORemarks">
                                                                        <iais:row>
                                                                            ...
                                                                            <iais:value width="10"><p>Yes</p></iais:value>
                                                                        </iais:row>
                                                                    </div>
                                                                    ...
                                                                    <div id="DORecommendation">
                                                                        <iais:row>
                                                                            <iais:field value="DO Recommendation" required="false"/>
...
<script type="text/javascript">
    $("#submitButton").click(function (){
        ...
        if(validityStartDate != null && validityStartDate != "" && validityEndDate != null && validityEndDate != "" && index != -1 && internalInspectionReport != null && internalInspectionReport != ""){
            if(index == 1){
                SOP.Crud.cfxSubmit("mainForm", "Approved");
            }else if(index == 2){
                SOP.Crud.cfxSubmit("mainForm", "Rejected");
            }else if(index == 3){
