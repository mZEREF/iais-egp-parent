                ...
                <iais:section title="">
                    <iais:row>
                        ...
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select id="facName" cssClass="facNameDropDown" name="facilityName"  options="facilityName" firstOption="Please Select" value="${facSearchDto.facName}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Facility Classification"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                                <iais:select name="facClassification" cssClass="facClassiftDropDown" codeCategory="CATE_ID_BSB_FAC_CLASSIFICATION" firstOption="Please Select" value="${facSearchDto.facClassification}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Facility Type "/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="facTypes" cssClass="facTypesDropDown" codeCategory="CATE_ID_BSB_ACTIVE_TYPE" firstOption="Please Select" multiSelect="true" multiValues="${facSearchDto.facTypes}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Schedule Type"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="scheduleType"  cssClass="scheduleTypeDropDown" codeCategory="CATE_ID_BSB_SCH_TYPE" firstOption="Please Select" value="${facSearchDto.scheduleType}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Biological Agent/Toxin"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="batName"  options="biologicalAgent" cssClass="batNameDropDown"  firstOption="Please Select" value="${facSearchDto.batName}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Risk Level of the Biological Agent/Toxin"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="riskLevel" cssClass="risDropDropDown" codeCategory="CATE_ID_BSB_RISK_LEVEL_OF_THE_BIOLOGICAL_AGENT" firstOption="Please Select" value="${facSearchDto.riskLevel}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                    ...
                    <iais:row>
                        ...
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="gazettedArea" cssClass="gazettedDropDown" codeCategory="CATE_ID_BSB_GAZETTED_AREA" firstOption="Please Select" value="${facSearchDto.gazettedArea}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                    ...
                    <iais:row>
                        ...
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="facStatus" cssClass="facStDropDown" codeCategory="CATE_ID_BSB_FACILITY_STATUS" firstOption="Please Select" value="${facSearchDto.facStatus}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Approved Facility Certifier"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="afcName" cssClass="afcNameDropDown" options="AFC" firstOption="Please Select" value="${facSearchDto.afcName}"/>
                        </div>
                    </iais:row>
                </iais:section>
            </div>
            ...
            <div class="panel-main-content">
                <iais:section title="">
                    <iais:row>
                        <iais:field value="Facility Name"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="facName" cssClass="facNameDropDown" options="facilityName"  firstOption="Please Select" value="${approvalSearchDto.facName}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Facility Classification"/>
                    ...
                    <iais:row>
                        <iais:field value="Facility Type "/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="facTypes" cssClass="facTypesDropDown" codeCategory="CATE_ID_BSB_ACTIVE_TYPE"  firstOption="Please Select" multiSelect="true" multiValues="${approvalSearchDto.facTypes}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Schedule Type"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="scheduleType" cssClass="scheduleTDropDown" codeCategory="CATE_ID_BSB_SCH_TYPE"  firstOption="Please Select" value="${approvalSearchDto.scheduleType}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Biological Agent/Toxin"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="batName" cssClass="batNameDropDown" options="biologicalAgent"  firstOption="Please Select" value="${approvalSearchDto.batName}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Nature of the sample"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="sampleNatures" cssClass="sampleNaturesDropDown" codeCategory="CATE_ID_BSB_NATURE_OF_TTE_SAMPLE"  firstOption="Please Select" multiSelect="true" multiValues="${approvalSearchDto.sampleNatures}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Risk Level of the Biological Agent/Toxin"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="riskLevel" cssClass="riskLevelDropDown" codeCategory="CATE_ID_BSB_RISK_LEVEL_OF_THE_BIOLOGICAL_AGENT" firstOption="Please Select" value="${approvalSearchDto.riskLevel}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Approval Type"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="approvalType"  cssClass="approvalTypeDropDown" codeCategory="CATE_ID_BSB_APPROVAL_TYPE"  firstOption="Please Select" value="${approvalSearchDto.approvalType}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                    ...
                    <iais:row>
                        ...
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="approvalStatus" cssClass="approvalDropDown" codeCategory="CATE_ID_BSB_APPROVAL_STATUS" firstOption="Please Select" value="${approvalSearchDto.approvalStatus}"/>
                        </div>
                    </iais:row>
                    <iais:row>
            ...
            <div class="panel-main-content">
                <iais:section title="">
                    ...
                    <iais:row>
                        ...
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="appType" id="appType" cssClass="appTypeDropDown"  codeCategory="CATE_ID_BSB_APP_TYPE" firstOption="Please Select" value="${appSearchDto.appType}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Application Status"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="appStatus" id="appStatus" cssClass="appStatusDropDown" codeCategory="CATE_ID_BSB_APP_STATUS" firstOption="Please Select" value="${appSearchDto.appStatus}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                    ...
                    <iais:row>
                        <iais:field value="Facility Classification"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="facClassification" cssClass="facClassifDropDown" id="facClassification" codeCategory="CATE_ID_BSB_FAC_CLASSIFICATION" firstOption="Please Select" value="${appSearchDto.facClassification}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Facility Type"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                           <iais:select name="facTypes" id="facTypes" cssClass="facTypeDropDown" codeCategory="CATE_ID_BSB_ACTIVE_TYPE" firstOption="Please Select" multiSelect="true" multiValues="${appSearchDto.facTypes}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Facility Name"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                                <iais:select name="facName" id="facName" cssClass="facNameDropDown" options="facilityName" firstOption="Please Select" value="${appSearchDto.facName}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Schedule Type"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="scheduleType" cssClass="scheduleTypeDropDown" id="scheduleType" codeCategory="CATE_ID_BSB_SCH_TYPE" firstOption="Please Select" value="${appSearchDto.scheduleType}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                        <iais:field value="Biological Agent/Toxin"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="batName" cssClass="batNameDropDown" id="batName" options="biologicalAgent" firstOption="Please Select" value="${appSearchDto.batName}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Risk Level of the Biological Agent/Toxin"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="riskLevel" cssClass="riskLevelDropDown" id="riskLevel" codeCategory="CATE_ID_BSB_RISK_LEVEL_OF_THE_BIOLOGICAL_AGENT" firstOption="Please Select" value="${appSearchDto.riskLevel}"/>
                        </div >
                    </iais:row>
                    <iais:row>
                        <iais:field value="Process Type"/>
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="processType" cssClass="processTypeDropDown" id="processType" codeCategory="CATE_ID_BSB_PRO_TYPE" firstOption="Please Select" value="${appSearchDto.processType}"/>
                        </div >
                    </iais:row>
                </iais:section>
            </div>
            ...
            <div class="panel-main-content">
                <iais:section title="">
                    <iais:row>
                        ...
                        <div class="col-sm-7 col-md-4 col-xs-10">
                            <iais:select name="orgName" cssClass="orgNameDropDown" options="orgName" firstOption="Please Select" value="${afcSearchDto.orgName}"/>
                        </div>
                    </iais:row>
                    <iais:row>
                    ...
                    <iais:row>
                        ...
                        <div class="col-sm-7 col-md-4 col-xs-10">
                                <iais:select name="afcStatus"  cssClass="afcStatusDropDown" codeCategory="CATE_ID_BSB_APPROVAL_STATUS" firstOption="Please Select" value="${afcSearchDto.afcStatus}"/>
                        </div>
                    </iais:row>
                    <iais:row>
