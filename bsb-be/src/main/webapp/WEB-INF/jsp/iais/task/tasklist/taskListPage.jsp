                                            ...
                                            <div class="accordian-body p-3 collapse" id="dropdown${divId}">
                                                <table aria-describedby=""  class="table application-item" style="background-color: #F3F3F3;margin-bottom:0px;" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col" style="width: 15%">Validity End Date</th>
                                                    ...
                                                    <c:forEach var="subTask" items="${pool.taskListDetailViewDtos}">
                                                        ...
                                                        <tr style="color: black">
                                                            <td>
                                                                ...
                                                                <p>
                                                                    <c:choose>
                                                                        <c:when test="${not empty taskEntity.processUrl}">
                                                                            <a href="${taskEntity.processUrl}?appId=<iais:mask name='id' value='${taskEntity.application.id}'/>&taskId=<iais:mask name='id' value='${taskEntity.id}'/>&OWASP_CSRFTOKEN=null&from=app"><c:out
                                                                                    value="${taskEntity.application.applicationNo}"/></a>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <c:out value="${taskEntity.application.applicationNo}"/>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </p>
                                                            </td>
