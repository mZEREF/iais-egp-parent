                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8 col-sm-6 col-md-6">
                            <select name="commonRoleId" class="roleDropdown" id="commonRoleId">
                    ...
                    <div id="taskListSearchFilter" class="collapse">
                        <div class="col-xs-12 col-sm-12"><%-- div for app date from and to --%>
                            ...
                            <div class="col-sm-7 col-md-5">
                                ...
                                <iais:select name="searchAppType" cssClass="searchAppDropSelect" id="searchAppType" codeCategory="CATE_ID_BSB_APP_TYPE"
