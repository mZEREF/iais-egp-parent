                            ...
                            <div id="beInboxFilter" class="collapse intranet-content">
                                <iais:row>
                                    ...
                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                        <iais:select id="facilityName" cssClass="facilityNameDropdown" name="facilityName"  options="facilityName" firstOption="Please Select" value="${facilitySearch.facilityName}"/>
                                    </div>
                                </iais:row>
                                <iais:row>
                                ...
                                <iais:row>
                                    ...
                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                        <iais:select id="facilityClassification" cssClass="facilityClassificationDropdown" name="facilityClassification" codeCategory="CATE_ID_BSB_FAC_CLASSIFICATION" firstOption="Please Select" multiSelect="true" multiValues="${facilitySearch.facilityClassifications}"/>
                                    </div>
                                </iais:row>
                                <iais:row>
                                ...
                                <iais:row>
                                    ...
                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                        <iais:select name="approvalStatus" cssClass="approvalStatusDropdown" id="approvalStatus" value="${facilitySearch.approvalStatus}" codeCategory="CATE_ID_BSB_APPROVAL_STATUS" firstOption="Please Select"/>
                                    </div>
                                </iais:row>
                                <iais:row>
                                    <iais:field value="Process Type"/>
                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                        <iais:select name="approvalType" cssClass="approvalTypeDropdown" codeCategory="CATE_ID_BSB_APPROVAL_TYPE"  firstOption="Please Select" value="${facilitySearch.approvalType}"/>
                                    </div>
                                </iais:row>
                                <iais:row>
