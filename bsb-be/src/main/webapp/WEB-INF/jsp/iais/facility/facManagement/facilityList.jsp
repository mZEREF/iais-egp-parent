            ...
            <div class="center-content">
                ...
                <div class="table-gp">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach var="pool" items="${dataList}" varStatus="status">
                                    <c:set var="maskedFacId" value='${MaskUtil.maskValue("id", pool.id)}'/>
                                    <tr style="display: table-row;">
                                        <td>
                                            <p class="visible-xs visible-sm table-row-title"> </p>
                                            <p><input type="radio" value="${maskedFacId}" name="rowRadio"></p>
                                        </td>
                                        <td>
                    ...
                    <div style="text-align:right;">
                        ...
                        <button type="button" class="btn btn-primary" id="reqInfoBtn">REQFORINFO</button>
                    </div>
                </div>
            </div>
        </div>
        <iais:confirm msg="GENERAL_ERR0023"  needCancel="false" callBack="adhocRfiCancel()" popupOrder="adhocRfiAlert"/>
    </form>
</div>
