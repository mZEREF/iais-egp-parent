                    ...
                    <div id="beInboxFilter">
                        <div class="col-xs-12 col-sm-12"><%-- div for app date from and to --%>
                            ...
                            <div class="col-sm-7 col-md-5">
                                ...
                                <input type="text" id="searchAppNo" name="searchAppNo" value="${searchDto.searchAppNo}"/>
                            </div>
                ...
                <div class="table-gp">
                    <table aria-describedby="" class="table application-group" style="border-collapse:collapse;">
                        ...
                        <tr>
                            ...
                            <iais:sortableHeader needSort="false" field="" value="Application No."/>
                            <iais:sortableHeader needSort="false" field="" value="Inspector(s)"/>
                            <iais:sortableHeader needSort="false" field="" value="Application Type"/>
                                ...
                                <c:forEach var="entity" items="${dataList}" varStatus="status">
                                    <tr style="display: table-row;">
                                        ...
                                        <td>
                                            ...
                                            <p><iais:code code="${entity.applicationType}"/></p>
                                        </td>
                                        <td>
