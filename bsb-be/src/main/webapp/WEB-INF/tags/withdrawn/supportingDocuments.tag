                        ...
                        <div class="document-upload-list">
                            ...
                            <div id="upload-other-doc-gp" class="file-upload-gp">
                                <c:if test="${supportDocDisplayDtoList ne null}">
                                    <c:forEach var="info" items="${supportDocDisplayDtoList}">
                                        <c:set var="tmpId"><iais:mask name="file" value="${info.repoId}"/></c:set>
                                        <div id="${tmpId}FileDiv">
                                            <a href="${savedFileDLUrl}${tmpId}" style="text-decoration: underline"><span id="${tmpId}Span"><c:out value="${info.filename}"/></span></a>
                                        </div>
                                    </c:forEach>
                                </c:if>
                            </div>
