...
<%@attribute name="compareFacProfiles" required="true" type="java.util.List<sg.gov.moh.iais.egp.bsb.dto.compare.CompareWrap>" %>
                    ...
                    <div id="previewFacInfo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="panel-main-content form-horizontal min-row">
                                ...
                                <c:forEach var="compareWrap" items="${compareFacProfiles}" varStatus="status">
                                    <c:set var="oldFacProfile" value="${compareWrap.oldDto}"/>
                                    <c:set var="newFacProfile" value="${compareWrap.newDto}"/>
                                    <%--@elvariable id="oldFacProfile" type="sg.gov.moh.iais.egp.bsb.dto.register.facility.FacilityProfileInfo"--%>
                                    <%--@elvariable id="newFacProfile" type="sg.gov.moh.iais.egp.bsb.dto.register.facility.FacilityProfileInfo"--%>
                                    <div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Facility Name</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileFacName${status.index}" data-val="<c:out value='${oldFacProfile.facName}'/>"><c:out value="${oldFacProfile.facName}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileFacName${status.index}" data-val="<c:out value='${newFacProfile.facName}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.facName}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Is the Facility address the same as the company address?</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileSameAddress${status.index}" data-val="<c:out value='${oldFacProfile.sameAddress}'/>"><c:out value="${oldFacProfile.sameAddress}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileSameAddress${status.index}" data-val="<c:out value='${newFacProfile.sameAddress}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.sameAddress}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Postal Code</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfilePostalCode${status.index}" data-val="<c:out value='${oldFacProfile.postalCode}'/>"><c:out value="${oldFacProfile.postalCode}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfilePostalCode${status.index}" data-val="<c:out value='${newFacProfile.postalCode}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.postalCode}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Address Type</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileAddressType${status.index}" data-val="<c:out value='${oldFacProfile.addressType}'/>"><iais:code code="${oldFacProfile.addressType}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileAddressType${status.index}" data-val="<c:out value='${newFacProfile.addressType}'/>" class="compareTdStyle" style="display: none"><iais:code code="${newFacProfile.addressType}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Block / House No.</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileBlock${status.index}" data-val="<c:out value='${oldFacProfile.block}'/>"><c:out value="${oldFacProfile.block}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileBlock${status.index}" data-val="<c:out value='${newFacProfile.block}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.block}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Floor and Unit No.</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileFloor${status.index}" data-val="<c:out value='${oldFacProfile.floor}${oldFacProfile.unitNo}'/>"><c:out value="${oldFacProfile.floor} - ${oldFacProfile.unitNo}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileFloor${status.index}" data-val="<c:out value='${newFacProfile.floor}${newFacProfile.unitNo}'/>" class="compareTdStyle" style="display: none" data-val="<c:out value='${newFacProfile.floor}${newFacProfile.unitNo}'/>"><c:out value="${newFacProfile.floor} - ${newFacProfile.unitNo}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Street Name</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileStreetName${status.index}" data-val="<c:out value='${oldFacProfile.streetName}'/>"><c:out value="${oldFacProfile.streetName}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileStreetName${status.index}" data-val="<c:out value='${newFacProfile.streetName}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.streetName}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Is the facility a Protected Place?</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileFacilityProtected${status.index}" data-val="<c:out value='${oldFacProfile.facilityProtected}'/>"><c:out value="${oldFacProfile.facilityProtected}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileFacilityProtected${status.index}" data-val="<c:out value='${newFacProfile.facilityProtected}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.facilityProtected}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                    </div>
                                    <c:if test="${isRfJudge}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-4"><p data-compare-old="facProfileInChargePersonName${status.index}" data-val="<c:out value='${oldFacProfile.inChargePersonName}'/>"><c:out value="${oldFacProfile.inChargePersonName}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileInChargePersonName${status.index}" data-val="<c:out value='${newFacProfile.inChargePersonName}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.inChargePersonName}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Desingation</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileInChargePersonDesignation${status.index}" data-val="<c:out value='${oldFacProfile.inChargePersonDesignation}'/>"><c:out value="${oldFacProfile.inChargePersonDesignation}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileInChargePersonDesignation${status.index}" data-val="<c:out value='${newFacProfile.inChargePersonDesignation}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.inChargePersonDesignation}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Email</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileInChargePersonEmail${status.index}" data-val="<c:out value='${oldFacProfile.inChargePersonEmail}'/>"><c:out value="${oldFacProfile.inChargePersonEmail}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileInChargePersonEmail${status.index}" data-val="<c:out value='${newFacProfile.inChargePersonEmail}'/>" class="compareTdStyle" style="display: none"><c:out value="${oldFacProfile.inChargePersonEmail}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">Contect No.</label>
                                            <div class="col-xs-4"><p data-compare-old="facProfileInChargePersonContactNo${status.index}" data-val="<c:out value='${oldFacProfile.inChargePersonContactNo}'/>"><c:out value="${oldFacProfile.inChargePersonContactNo}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="facProfileInChargePersonContactNo${status.index}" data-val="<c:out value='${newFacProfile.inChargePersonContactNo}'/>" class="compareTdStyle" style="display: none"><c:out value="${oldFacProfile.inChargePersonContactNo}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                    </c:if>
                                    <c:if test="${isPvRfJudge}">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">OPV/Sabin 1 IM</label>
                                            <div class="col-xs-4" data-compare-old="opvSabin1IM${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin1IM}'/>">
                                                Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq oldFacProfile.opvSabin1IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq oldFacProfile.opvSabin1IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                            </div>
                                            <c:if test="${newFacProfile.opvSabin1IM ne null}">
                                                <div class="col-xs-4 compareTdStyle" data-compare-new="opvSabin1IM${status.index}" data-val="<c:out value='${newFacProfile.opvSabin1IM}'/>" style="display: none">
                                                    Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq newFacProfile.opvSabin1IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq newFacProfile.opvSabin1IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                </div>
                                            </c:if>
                                            <div class="clear"></div>
                                        </div>
                                        <c:if test="${masterCodeConstants.YES eq oldFacProfile.opvSabin1IM || masterCodeConstants.YES eq newFacProfile.opvSabin1IM}">
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Expected destruction date</label>
                                                <div class="col-xs-4"><p data-compare-old="opvSabin1IMExpectedDestructDt${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin1IMExpectedDestructDt}'/>"><c:out value="${oldFacProfile.opvSabin1IMExpectedDestructDt}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin1IMExpectedDestructDt${status.index}" data-val="<c:out value='${newFacProfile.opvSabin1IMExpectedDestructDt}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.opvSabin1IMExpectedDestructDt}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Reason for Retention</label>
                                                <div class="col-xs-4"><p data-compare-old="opvSabin1IMRetentionReason${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin1IMRetentionReason}'/>"><c:out value="${oldFacProfile.opvSabin1IMRetentionReason}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin1IMRetentionReason${status.index}" data-val="<c:out value='${newFacProfile.opvSabin1IMRetentionReason}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.opvSabin1IMRetentionReason}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                        </c:if>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">OPV/Sabin 2 IM</label>
                                            <div class="col-xs-4" data-compare-old="opvSabin2IM${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin2IM}'/>">
                                                Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq oldFacProfile.opvSabin2IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq oldFacProfile.opvSabin2IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                            </div>
                                            <c:if test="${newFacProfile.opvSabin2IM ne null}">
                                                <div class="col-xs-4 compareTdStyle" data-compare-new="opvSabin2IM${status.index}" data-val="<c:out value='${newFacProfile.opvSabin2IM}'/>" style="display: none">
                                                    Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq newFacProfile.opvSabin2IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq newFacProfile.opvSabin2IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                </div>
                                            </c:if>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">OPV/Sabin 3 IM</label>
                                            <div class="col-xs-4" data-compare-old="opvSabin3IM${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin3IM}'/>">
                                                Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq oldFacProfile.opvSabin3IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq oldFacProfile.opvSabin3IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                            </div>
                                            <c:if test="${newFacProfile.opvSabin3IM ne null}">
                                                <div class="col-xs-4 compareTdStyle" data-compare-new="opvSabin3IM${status.index}" data-val="<c:out value='${newFacProfile.opvSabin3IM}'/>" style="display: none">
                                                    Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq newFacProfile.opvSabin3IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq newFacProfile.opvSabin3IM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                </div>
                                            </c:if>
                                            <div class="clear"></div>
                                        </div>
                                        <c:if test="${masterCodeConstants.YES eq oldFacProfile.opvSabin3IM || masterCodeConstants.YES eq newFacProfile.opvSabin3IM}">
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Expected destruction date</label>
                                                <div class="col-xs-4"><p data-compare-old="opvSabin3IMExpectedDestructDt${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin3IMExpectedDestructDt}'/>"><c:out value="${oldFacProfile.opvSabin3IMExpectedDestructDt}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin3IMExpectedDestructDt${status.index}" data-val="<c:out value='${newFacProfile.opvSabin3IMExpectedDestructDt}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.opvSabin3IMExpectedDestructDt}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Reason for Retention</label>
                                                <div class="col-xs-4"><p data-compare-old="opvSabin3IMRetentionReason${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin3IMRetentionReason}'/>"><c:out value="${oldFacProfile.opvSabin3IMRetentionReason}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin3IMRetentionReason${status.index}" data-val="<c:out value='${newFacProfile.opvSabin3IMRetentionReason}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.opvSabin3IMRetentionReason}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                        </c:if>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">OPV/Sabin 1 PIM</label>
                                            <div class="col-xs-4" data-compare-old="opvSabin1PIM${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin1PIM}'/>">
                                                Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq oldFacProfile.opvSabin1PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq oldFacProfile.opvSabin1PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                            </div>
                                            <c:if test="${newFacProfile.opvSabin1PIM ne null}">
                                                <div class="col-xs-4 compareTdStyle" data-compare-new="opvSabin1PIM${status.index}" data-val="<c:out value='${newFacProfile.opvSabin1PIM}'/>" style="display: none">
                                                    Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq newFacProfile.opvSabin1PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq newFacProfile.opvSabin1PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                </div>
                                            </c:if>
                                            <div class="clear"></div>
                                        </div>
                                        <c:if test="${masterCodeConstants.YES eq oldFacProfile.opvSabin1PIM || masterCodeConstants.YES eq newFacProfile.opvSabin1PIM}">
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Risk level</label>
                                                <div class="col-xs-4"><p data-compare-old="opvSabin1PIMRiskLevel${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin1PIMRiskLevel}'/>"><c:out value="${oldFacProfile.opvSabin1PIMRiskLevel}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin1PIMRiskLevel${status.index}" data-val="<c:out value='${newFacProfile.opvSabin1PIMRiskLevel}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.opvSabin1PIMRiskLevel}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Reason for Retention</label>
                                                <div class="col-xs-4"><p data-compare-old="opvSabin1PIMRetentionReason${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin1PIMRetentionReason}'/>"><c:out value="${oldFacProfile.opvSabin1PIMRetentionReason}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin1PIMRetentionReason${status.index}" data-val="<c:out value='${newFacProfile.opvSabin1PIMRetentionReason}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.opvSabin1PIMRetentionReason}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                        </c:if>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">OPV/Sabin 2 PIM</label>
                                            <div class="col-xs-4" data-compare-old="opvSabin2PIM${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin2PIM}'/>">
                                                Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq oldFacProfile.opvSabin2PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq oldFacProfile.opvSabin2PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                            </div>
                                            <c:if test="${newFacProfile.opvSabin2PIM ne null}">
                                                <div class="col-xs-4 compareTdStyle" data-compare-new="opvSabin2PIM${status.index}" data-val="<c:out value='${newFacProfile.opvSabin2PIM}'/>" style="display: none">
                                                    Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq newFacProfile.opvSabin2PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq newFacProfile.opvSabin2PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                </div>
                                            </c:if>
                                            <div class="clear"></div>
                                        </div>
                                        <c:if test="${masterCodeConstants.YES eq oldFacProfile.opvSabin2PIM || masterCodeConstants.YES eq newFacProfile.opvSabin2PIM}">
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Risk level</label>
                                                <div class="col-xs-4"><p data-compare-old="opvSabin2PIMRiskLevel${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin2PIMRiskLevel}'/>"><c:out value="${oldFacProfile.opvSabin2PIMRiskLevel}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin2PIMRiskLevel${status.index}" data-val="<c:out value='${newFacProfile.opvSabin2PIMRiskLevel}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.opvSabin2PIMRiskLevel}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Reason for Retention</label>
                                                <div class="col-xs-4"><p data-compare-old="opvopvSabin2PIMRetentionReason${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin2PIMRetentionReason}'/>"><c:out value="${oldFacProfile.opvSabin2PIMRetentionReason}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin2PIMRetentionReason${status.index}" data-val="<c:out value='${newFacProfile.opvSabin2PIMRetentionReason}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.opvSabin2PIMRetentionReason}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                        </c:if>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">OPV/Sabin 3 PIM</label>
                                            <div class="col-xs-4" data-compare-old="opvSabin3PIM${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin3PIM}'/>">
                                                Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq oldFacProfile.opvSabin3PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq oldFacProfile.opvSabin3PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                            </div>
                                            <c:if test="${newFacProfile.opvSabin3PIM ne null}">
                                                <div class="col-xs-4 compareTdStyle" data-compare-new="opvSabin3PIM${status.index}" data-val="<c:out value='${newFacProfile.opvSabin3PIM}'/>" style="display: none">
                                                    Yes <span class="fa <c:choose><c:when test="${masterCodeConstants.YES eq newFacProfile.opvSabin3PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    No <span class="fa <c:choose><c:when test="${masterCodeConstants.NO eq newFacProfile.opvSabin3PIM}">fa-dot-circle-o</c:when><c:otherwise>fa-circle-o</c:otherwise></c:choose>"></span>
                                                </div>
                                            </c:if>
                                            <div class="clear"></div>
                                        </div>
                                        <c:if test="${masterCodeConstants.YES eq oldFacProfile.opvSabin3PIM || masterCodeConstants.YES eq newFacProfile.opvSabin3PIM}">
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Risk level</label>
                                                <div class="col-xs-4"><p data-compare-old="opvSabin3PIMRiskLevel${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin3PIMRiskLevel}'/>"><iais:code code="${oldFacProfile.opvSabin3PIMRiskLevel}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin3PIMRiskLevel${status.index}" data-val="<c:out value='${newFacProfile.opvSabin3PIMRiskLevel}'/>" class="compareTdStyle" style="display: none"><iais:code code="${newFacProfile.opvSabin3PIMRiskLevel}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-4 control-label">Reason for Retention</label>
                                                <div class="col-xs-4"><p data-compare-old="opvSabin3PIMRetentionReason${status.index}" data-val="<c:out value='${oldFacProfile.opvSabin3PIMRetentionReason}'/>"><c:out value="${oldFacProfile.opvSabin3PIMRetentionReason}"/></p></div>
                                                <div class="col-xs-4"><p data-compare-new="opvSabin3PIMRetentionReason${status.index}" data-val="<c:out value='${newFacProfile.opvSabin3PIMRetentionReason}'/>" class="compareTdStyle" style="display: none"><c:out value="${newFacProfile.opvSabin3PIMRetentionReason}"/></p></div>
                                                <div class="clear"></div>
                                            </div>
                                        </c:if>
                                    </c:if>
                            ...
                            <div class="panel-body">
                                <div class="panel-main-content form-horizontal min-row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4" data-compare-old="appointed" data-val="<c:out value='${oldAfc.appointed}'/>">
                                        ...
                                        <c:if test="${newAfc.appointed ne null}">
                                            <div class="col-xs-4 compareTdStyle" data-compare-new="appointed" data-val="<c:out value='${newAfc.appointed}'/>" style="display: none">
                                    ...
                                    <c:if test="${oldAfc.appointed eq 'Y' || newAfc.appointed eq 'Y'}">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-4"><p data-compare-old="afcAfc" data-val="<c:out value='${oldAfc.afc}'/>"><iais:code code="${oldAfc.afc}"/></p></div>
                                            <div class="col-xs-4"><p data-compare-new="afcAfc" data-val="<c:out value='${newAfc.afc}'/>" class="compareTdStyle" style="display: none"><iais:code code="${newAfc.afc}"/></p></div>
                                            <div class="clear"></div>
                                        </div>
                                        <c:if test="${oldAfc.selectReason ne null || newAfc.selectReason ne null}">
                                            <div class="form-group">
                                                <label class="col-xs-6 control-label">Reasons for choosing this AFC</label>
                                                <div class="col-xs-4"><p data-compare-old="afcSelectReason" data-val="<c:out value='${oldAfc.selectReason}'/>"><c:out value="${oldAfc.selectReason}"/></p></div>
