...
<%@attribute name="facProfile" required="true" type="sg.gov.moh.iais.egp.bsb.dto.appview.facility.FacilityProfileDto" %>
<%@attribute name="facOperator" required="true" type="sg.gov.moh.iais.egp.bsb.dto.appview.facility.FacilityOperatorDto" %>
<%@attribute name="facAuth" required="true" type="sg.gov.moh.iais.egp.bsb.dto.appview.facility.FacilityAuthoriserDto" %>
<%@attribute name="facAdminOfficer" required="true" type="sg.gov.moh.iais.egp.bsb.dto.appview.facility.FacilityAdminAndOfficerDto" %>
<%@attribute name="facCommittee" required="true" type="sg.gov.moh.iais.egp.bsb.dto.appview.facility.FacilityCommitteeDto" %>
<%@attribute name="batList" required="false" type="java.util.List<sg.gov.moh.iais.egp.bsb.dto.appview.facility.BiologicalAgentToxinDto>" %>
...
<%@attribute name="afc" required="false" type="sg.gov.moh.iais.egp.bsb.dto.appview.facility.FacilityAfcDto" %>
