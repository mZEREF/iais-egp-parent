...
<%@attribute name="isRfc" required="true" type="java.lang.Boolean" %>
            ...
            <div class="panel-group" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="previewFacInfo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="panel-main-content form-horizontal min-row">
                                <c:if test="${'rfi' eq viewType}"><div class="text-right"><input type="checkbox" id="facSelect" name="selectCheckbox" value="facility" <c:if test="${pageAppEditSelectDto.facSelect}">checked="checked"</c:if>/></div></c:if>
                                <div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="previewBatInfo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="panel-main-content form-horizontal min-row">
                            <c:if test="${'rfi' eq viewType}"><div class="text-right"><input type="checkbox" id="batSelect" name="selectCheckbox" value="bat" <c:if test="${pageAppEditSelectDto.batSelect}">checked="checked"</c:if>/></div></c:if>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="previewAfc" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="panel-main-content form-horizontal min-row">
                                <c:if test="${'rfi' eq viewType}"><div class="text-right"><input type="checkbox" id="afcSelect" name="selectCheckbox" value="afc" <c:if test="${pageAppEditSelectDto.afcSelect}">checked="checked"</c:if>/></div></c:if>
                                <div class="form-group">
