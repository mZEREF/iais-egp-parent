<%@tag description="Preview committee info tag of facility registration" %>
<%@taglib prefix="webui" uri="http://www.ecquaria.com/webui" %>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>

<%@attribute name="dataList" required="true" type="java.util.List<sg.gov.moh.iais.egp.bsb.dto.register.facility.FacilityCommitteeFileDto>" %>
                            ...
                            <div>
                                <table class="table" style="font-size: 12px;" aria-describedby="">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">Role under Sixth Schedule</th>
