            ...
            <div class="panel-group" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="previewDocs" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="panel-main-content form-horizontal min-row">
                                <c:if test="${'rfi' eq viewType}"><div class="text-right"><input type="checkbox" id="docSelect" name="selectCheckbox" value="doc" <c:if test="${pageAppEditSelectDto.docSelect}">checked="checked"</c:if>/></div></c:if>
