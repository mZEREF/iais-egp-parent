...
public class INTRANET___MohFacilityApprovalHMApproval___1 extends BaseProcessClass {
	...
	// 		Approve->OnStepProcess
		EngineHelper.delegate(DELEGATOR, "approveByHM", this);
	}

	public void reject_OnStepProcess_0() throws Exception {
	// 		Reject->OnStepProcess
		EngineHelper.delegate(DELEGATOR, "rejectByHM", this);
	}
