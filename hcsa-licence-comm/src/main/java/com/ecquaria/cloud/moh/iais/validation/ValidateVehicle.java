        ...
        for (int i = 0; i < appSvcVehicleDtos.size(); i++) {
            ...
            if (!currentDto.isDummyVehNum() && StringUtil.isNotEmpty(vehicleNum)){
                if (vehicleNum.length() > 10) {
                    map.put(VEHICLE_NAME + i, AppValidatorHelper.repLength("Vehicle Number", "10"));
            ...
            if (StringUtil.isEmpty(chassisNum)) {
                ...
                map.put(CHASSIS_NAME + i, AppValidatorHelper.repLength("Chassis Number", "25"));
            } else {
            ...
            if (StringUtil.isEmpty(engineNum)) {
                ...
                map.put(ENGINE_NAME + i, AppValidatorHelper.repLength("Engine Number", "25"));
            } else {
