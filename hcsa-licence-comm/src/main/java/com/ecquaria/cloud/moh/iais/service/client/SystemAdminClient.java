...
import com.ecquaria.cloud.moh.iais.service.callback.SystemAdminClientFallback;
 ...
 */
@FeignClient(name = "system-admin", configuration = FeignConfiguration.class, fallback = SystemAdminClientFallback.class)
