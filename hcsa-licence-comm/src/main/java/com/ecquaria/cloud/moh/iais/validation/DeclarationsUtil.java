...
import com.ecquaria.cloud.moh.iais.validation.decaration.CoLocationDeclaration;
...
public class DeclarationsUtil {
    ...
    static {
        ...
        RENEW_LIST.add(new CoLocationDeclaration());
        /*-----------------------*/
        ...
        NEW_LIST.add(new CoLocationDeclaration());
    }

    public static void declarationsValidate(Collection<Declarations> collection, Map<String, String> map,
            AppDeclarationMessageDto appDeclarationMessageDto) {
