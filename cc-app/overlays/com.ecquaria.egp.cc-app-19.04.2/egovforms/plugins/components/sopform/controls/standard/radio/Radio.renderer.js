...
var RadioRenderer = Form.Design.AbstractRenderer.extend($jq.extend({
...
Form.registerRenderer(FQN, 'design', new RadioRenderer());

// RUNTIME
var RadioRuntimeRenderer = Form.Runtime.AbstractRenderer.extend($jq.extend({
	...
	afterRender: function(control, placeholder){
		...
		var $input = $(':radio', control.getElement());
...
Form.registerRenderer(FQN, 'runtime', new RadioRuntimeRenderer());

// PRINTER FRIENDLY
var RadioPrinterFriendlyRenderer = Form.Runtime.AbstractRenderer.extend({
...
Form.registerRenderer(FQN, 'printerFriendly', new RadioPrinterFriendlyRenderer());

var RadioRuntimeViewRenderer = Form.Runtime.AbstractRenderer.extend({
...
Form.registerRenderer(FQN, 'view', new RadioRuntimeViewRenderer());
