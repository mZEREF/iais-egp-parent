<div class="row">
    ...
    <div class="col-xs-10 col-xs-offset-1 col-lg-offset-0 col-lg-2">
        <div class="dropdown profile-dropdown"><a class="profile-btn btn" id="profileBtn" data-toggle="dropdown"
                                                  aria-haspopup="true" aria-expanded="false" href="javascript:;" style="width: 142%;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;float: left;margin-left: -43%">${iais_Login_User_Info_Attr.userName}</a>
