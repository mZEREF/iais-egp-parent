...
<div class="self-assessment-item assessment-level-3">
    <div class="amendLicence3_1">
        <div class="form-check-gp">
            <%@include file="/WEB-INF/jsp/iais/assessmentGuide/amendLicence/updateLicenceInfo/amendUpdateLicenceInfoContent.jsp" %>
        </div>
    </div>
</div>
...
<script>
    ...
    function sortRecords(sortFieldName, sortType) {
        ...
        $("[name='guide_action_type']").val("updateLicenceSort");
        $("#mainForm").submit();
    }
</script>