            ...
            <div class="col-xs-12">
                <div class="tab-gp dashboard-tab">
                    <ul class="nav nav-tabs hidden-xs hidden-sm" role="tablist">
                        ...
                        <li class="incomplete" role="presentation" id="licTab"><a href="#tabLic" id="tLic" aria-controls="tabLic" role="tab" data-toggle="tab" >Licences</a></li>
                    </ul>
                    <div class="tab-nav-mobile visible-xs visible-sm">
                        <div class="swiper-wrapper" role="tablist">
                            ...
                            <div class="swiper-slide"><a href="#tabLic" aria-controls="tabLicence" role="tab" data-toggle="tab">Licences</a></div>
                        </div>
