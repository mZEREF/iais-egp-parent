...
%>
        ...
        <c:forEach var="appGrpPremisesDto" items="${ReloadPremises}" varStatus="status">
            ...
            <iais:row>
                ...
                <iais:value width="11">
                    <iais:input maxLength="100" needDisabled="true" type="text" name="hciName" id="sitePremiseName" value="${appGrpPremisesDto.hciName}"></iais:input>
            ...
            <iais:row>
                ...
                <iais:value width="5">
                    ...
                    <span class="error-msg" name="iFire Safety Shelter Bureau Ref. No.aisErrorMsg" id="error_blkNo"></span>
                </iais:value>
            </iais:row>
            <iais:row>
            ...
            <iais:row>
                ...
                <iais:value width="10">
                    <iais:input cssClass="scdfRefNo" maxLength="66" type="text" name="scdfRefNo" id="siteStreetName" value="${appGrpPremisesDto.scdfRefNo}"></iais:input>
