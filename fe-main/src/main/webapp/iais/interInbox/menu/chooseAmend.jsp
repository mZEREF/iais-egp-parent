...
%>
        ...
        <input class="form-check-input amendType" id="amend-licensee"  type="radio" name="amendType" value ="0" />
        <label class="form-check-label" ><span for="amend-licensee" class="check-circle"></span>amend licensee</label>
        </div>
        </div>
        <div class="col-xs-6 col-md-6">
        <div class="form-check">
        <input class="form-check-input amendType" id="amend-licence"  type="radio" name="amendType"  value ="1"  />
        <label class="form-check-label" ><span for="amend-licence" class="check-circle"></span>amend licence</label>
        </div>
        </div>
        </div>
        </div>
        ...
        <c:forEach var="amendType" items="${AmendTypeList}">
            <div class="form-check">
            <input class="form-check-input" name="amend-licence-type" id="clinical" type="checkbox" aria-invalid="false" value="${amendType.value}">
            <label class="form-check-label" for="clinical"><span class="check-square"></span>${amendType.text}</label>
            </div>
        </c:forEach>
        </div>
        </div>
