...
public class FELandingDelegator {
	...
	public void initSso(BaseProcessClass bpc) throws InvalidKeySpecException, NoSuchAlgorithmException,
		...
		if (StringUtil.isEmpty(key)) {
			...
			cookie.setPath("/");
			bpc.response.addCookie(cookie);
			redisCacheHelper.set(RedisNameSpaceConstant.CACHE_NAME_ACTIVE_SESSION_SET, key, new Date(), RedisCacheHelper.SESSION_DEFAULT_EXPIRE);
		}
	}
