...
public interface SystemAdminMainFeClient {
    ...
    @PostMapping(value = "/input-files/search-inputFiles", produces = MediaType.APPLICATION_JSON_VALUE)
    FeignResponseEntity<SearchResult<SearchInputFilesDto>> searchInputFiles(@RequestBody SearchParam searchParam);
}
