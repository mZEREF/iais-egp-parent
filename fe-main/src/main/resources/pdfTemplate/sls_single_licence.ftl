        ...
        <div class="instruction-content center-content">
          <div class="licence_box">
            ...
            <div class="lic-info">
              ...
              <span>
                Note:<br/>
                The licensee stated above is permitted to provide the special licensable healthcare service to which<br/>
                this licence relates, on the condition that the licensee must at all times also be granted a licence to<br/>
                provide ${baseServiceName}, being a licensable healthcare service prescribed as underlying to that<br/>
                special licensable healthcare service.
              </span>
            </div>
