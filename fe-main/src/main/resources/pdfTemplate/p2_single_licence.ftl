            ...
            <div class="text-box">
              ...
              <div class="lic-list">
                <ol>
                  ...
                  <li>Medical Microbiology<br>
                    - AFB Smear
                  </li>
                  <li>Transfusion Medicine</li>
                  <li>Molecular Pathology </li>
                  <li>Molecular Microbiology<br>
                    - Molecular SARS-CoV-2 testing for Coronavirus Disease 2019 (COVID-19)
                  </li>
                  <li>Nuclear Medicine Assay (In-Vitro)</li>
                  <li>Nuclear Medicine Assay (In-vivo)</li>
                </ol>
              </div>
            </div>
