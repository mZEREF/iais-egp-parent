...
<form id = "mainForm" method = "post" action=<%=process.runtime.continueURL()%>>
  ...
  <iais:body>
    <iais:section title="Checklist Item Clone Edit" id="items">
      <iais:row>
        ...
        <iais:value width="7">
          ...
          <iais:action>
            <button type="button" class="btn btn-lg btn-login-submit" onclick="javascript:editCloneItem();">Edit</button>
          </iais:action>
