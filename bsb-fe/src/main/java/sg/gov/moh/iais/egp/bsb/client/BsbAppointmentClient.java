...
public interface BsbAppointmentClient {
    @GetMapping(value = "/appointment/inspection-date", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseDto<InspectionDateDto> getInspectionDateByAppId(@RequestParam("appId") String appId);
