...
import static com.ecquaria.cloud.moh.iais.common.constant.BsbAuditTrailConstants.FUNCTION_INBOX_CERTIFICATION_FACILITY_ADMIN;
...
@Delegator("bsbInboxFACCertificationDelegator")
@Slf4j
@RequiredArgsConstructor
public class BsbInboxFACCertificationDelegator {
    ...
    public void start(BaseProcessClass bpc) {
        ...
        AuditTrailHelper.auditFunction(MODULE_INTERNAL_INBOX, FUNCTION_INBOX_CERTIFICATION_FACILITY_ADMIN);
    }
    ...
    public void prepareData(BaseProcessClass bpc) {
        ...
        ResponseDto<InboxCertificationPageInfoResultDto> resultDto = inboxClient.searchInboxInsCerForFacAdmin(searchDto);
        if (resultDto.ok()) {
