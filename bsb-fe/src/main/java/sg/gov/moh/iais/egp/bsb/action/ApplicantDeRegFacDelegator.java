...
import static sg.gov.moh.iais.egp.bsb.constant.module.CessationAndDeRegConstants.KEY_DE_REGISTRATION_FACILITY_DTO;
...
public class ApplicantDeRegFacDelegator {
    ...
    public void start(BaseProcessClass bpc) {
        ...
        AuditTrailHelper.auditFunction(MODULE_DEREGISTRATION, FUNCTION_FACILITY_REGISTRATION);
    }
