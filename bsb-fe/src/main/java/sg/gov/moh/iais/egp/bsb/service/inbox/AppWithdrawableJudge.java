...
public class AppWithdrawableJudge implements AppActionJudge {
    ...
    public boolean judge() {
        ...
        List<String> notWithdrawableAppStatus = Arrays.asList(MasterCodeConstants.APP_STATUS_WITHDRAW, MasterCodeConstants.APP_STATUS_REJECTED, MasterCodeConstants.APP_STATUS_APPROVED, MasterCodeConstants.APP_STATUS_DRAFT, MasterCodeConstants.APP_STATUS_REMOVED,
                ...
                MasterCodeConstants.APP_STATUS_PEND_AFC_REPORT_UPLOAD,MasterCodeConstants.APP_STATUS_PEND_AFC_INPUT,MasterCodeConstants.APP_STATUS_PEND_APPLICANT_REPORT_REVIEW, MasterCodeConstants.APP_STATUS_PEND_DO_REPORT_REVIEW,MasterCodeConstants.APP_STATUS_PEND_AO_REPORT_REVIEW);
