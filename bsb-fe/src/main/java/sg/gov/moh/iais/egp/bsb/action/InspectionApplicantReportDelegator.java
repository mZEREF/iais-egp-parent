...
import static com.ecquaria.cloud.moh.iais.common.constant.BsbAuditTrailConstants.FUNCTION_APPLICANT_CERTIFICATION_UPLOAD_REPORT;
...
public class InspectionApplicantReportDelegator {
    ...
    public void start(BaseProcessClass bpc) {
        ...
        AuditTrailHelper.auditFunction(MODULE_INSPECTION, FUNCTION_APPLICANT_CERTIFICATION_UPLOAD_REPORT);
    ...
    public void prepareData(BaseProcessClass bpc) {
        ...
        ParamUtil.setRequestAttr(request, PARAM_CAN_ACTION_ROLE, RoleConsts.USER_ROLE_BSB_FACILITY_USER);
    ...
    public void handleSubmit(BaseProcessClass bpc) {
        ...
        ReviewAFCReportDto dto = insAFCReportService.getDisplayDto(request);
        AFCCommonDocDto commonDocDto = insAFCReportService.getAFCCommonDocDto(request);
        commonDocDto.reqObjMapping(request,"Applicant");
    ...
    public void submitFormData(BaseProcessClass bpc) {
        ...
        rfiClient.saveApplicantCertificationComment(afcSaveDto, rfiDataId);
