...
public class FacilityAuthoriserDto implements ValidatableNodeValue, RefreshableDocDto {
    @Data
    @NoArgsConstructor
    ...
    public boolean validateDataFile() {
        if (this.newFile == null) {
            ...
            errorMap.put(DocConstants.DOC_TYPE_DATA_AUTHORISER, MessageUtil.getMessageDesc("BISERR002"));
