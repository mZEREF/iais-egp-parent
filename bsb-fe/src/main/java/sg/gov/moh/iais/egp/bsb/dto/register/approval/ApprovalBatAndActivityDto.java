...
public class ApprovalBatAndActivityDto implements Serializable {
     ...
     * @param p validation profile
     */
    public NodeGroup toApprovalAppRootGroup(String name, String p) {
        ...
        switch (processType) {
            case MasterCodeConstants.PROCESS_TYPE_APPROVE_POSSESS:
                SimpleNode possessBatNode = new SimpleNode(approvalToPossessDto.p(p), NODE_NAME_POSSESS_BAT, new Node[]{facProfileNode});
            ...
            case MasterCodeConstants.PROCESS_TYPE_APPROVE_LSP:
                SimpleNode largeBatNode = new SimpleNode(approvalToLargeDto.p(p), NODE_NAME_LARGE_BAT, new Node[]{facProfileNode});
            ...
            case MasterCodeConstants.PROCESS_TYPE_SP_APPROVE_HANDLE:
                SimpleNode specialBatNode = new SimpleNode(approvalToSpecialDto.p(p), NODE_NAME_SPECIAL_BAT, new Node[]{facProfileNode});
                SimpleNode facAuthorisedNode = new SimpleNode(facAuthorisedDto.p(p), NODE_NAME_FAC_AUTHORISED, new Node[]{facProfileNode, specialBatNode});
        ...
        PrimaryDocDto primaryDocDto = new PrimaryDocDto(p);
    ...
    public static ApprovalBatAndActivityDto from(ApprovalSelectionDto approvalSelectionDto, NodeGroup approvalAppRoot, HttpServletRequest request) {
        ...
        switch (processType) {
            case MasterCodeConstants.PROCESS_TYPE_APPROVE_POSSESS:
                approvalBatAndActivityDto.setApprovalToPossessDto((ApprovalToPossessDto) ((SimpleNode) approvalAppRoot.at(NODE_NAME_APP_INFO + approvalAppRoot.getPathSeparator() + NODE_NAME_POSSESS_BAT)).getValue());
                break;
            case MasterCodeConstants.PROCESS_TYPE_APPROVE_LSP:
