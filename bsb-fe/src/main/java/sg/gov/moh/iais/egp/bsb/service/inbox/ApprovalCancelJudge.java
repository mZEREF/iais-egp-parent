...
public class ApprovalCancelJudge implements AppActionJudge {
    ...
    public ApprovalCancelJudge(String processType, String approvalStatus) {
    ...
    public boolean judge() {
        List<String> cancelProcessTypes = Arrays.asList(PROCESS_TYPE_APPROVE_POSSESS, PROCESS_TYPE_APPROVE_LSP, PROCESS_TYPE_SP_APPROVE_HANDLE, PROCESS_TYPE_APPROVAL_FOR_FACILITY_ACTIVITY_TYPE);
