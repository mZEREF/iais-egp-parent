...
import sg.gov.moh.iais.egp.bsb.dto.followup.Followup1AMetaDto;
import sg.gov.moh.iais.egp.bsb.dto.followup.Followup1BMetaDto;
import sg.gov.moh.iais.egp.bsb.dto.followup.FollowupInfoADto;
import sg.gov.moh.iais.egp.bsb.dto.followup.FollowupInfoBDto;
import sg.gov.moh.iais.egp.bsb.dto.followup.FollowupPreviewADto;
import sg.gov.moh.iais.egp.bsb.dto.followup.FollowupPreviewBDto;
import sg.gov.moh.iais.egp.bsb.dto.followup.FollowupReport1ADto;
import sg.gov.moh.iais.egp.bsb.dto.followup.FollowupReport1BDto;
import sg.gov.moh.iais.egp.bsb.dto.followup.IncidentInfoA;
...
public class ReportableEventFollowUPReportDelegator {
    ...
    public void retrieveByFollowupReport1ADto(HttpServletRequest request,FollowupReport1ADto followupReport1ADto ){
        ...
        Map<String, DocRecordInfo> savedDocMap = sg.gov.moh.iais.egp.bsb.util.CollectionUtils.uniqueIndexMap(DocRecordInfo::getRepoId, followupReport1ADto.getDocRecordInfos());
    ...
    public void retrieveByFollowupReport1BDto(HttpServletRequest request,FollowupReport1BDto followupReport1BDto ){
        CommonDocDto followupDoc = new CommonDocDto();
        Map<String, DocRecordInfo> savedDocMap = sg.gov.moh.iais.egp.bsb.util.CollectionUtils.uniqueIndexMap(DocRecordInfo::getRepoId, followupReport1BDto.getDocRecordInfos());
        followupDoc.setSavedDocMap(savedDocMap);
        //retrieve follow-up1B and follow-up1B documents
