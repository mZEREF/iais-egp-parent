...
public class MasterCodeConstants {
    ...
    //InboxInspectionCertification type
    public static final String DATA_TYPE_INS = "INS";
    public static final String DATA_TYPE_CER = "CER";
    ...
    public static final List<String> BIOLOGICAL_AGENT_SCHEDULE_TYPE_ALL = Collections.unmodifiableList(Arrays.asList(
            FIRST_SCHEDULE_PART_1, FIRST_SCHEDULE_PART_2,SECOND_SCHEDULE,
    ...
    public static final String APP_TYPE_REINSTATE = "BSBAPTY008";
    ...
    public static final String APP_STATUS_PEND_DO_CLARIFICATION_OF_NC_REVIEW        = "BSBAPST316";
    ...
    public static final List<SelectOption> INBOX_CERTIFICATION_SEARCH_STATUS_AFC;
    ...
    static {
        ...
        pendingMohAppStatus.add(APP_STATUS_PEND_DO_CLARIFICATION_OF_REPORT_APPROVAL);
        ...
        pendingMohAppStatus.add(APP_STATUS_PEND_DO_CLARIFICATION_OF_NC_REVIEW);
        ...
        List<SelectOption> inboxCertificationCertificationStatus = new ArrayList<>(5);
        inboxCertificationCertificationStatus.add(new SelectOption(APP_STATUS_PEND_AFC_REPORT_UPLOAD, MasterCodeUtil.getCodeDesc(APP_STATUS_PEND_AFC_REPORT_UPLOAD)));
        inboxCertificationCertificationStatus.add(new SelectOption(APP_STATUS_PEND_AFC_INPUT, MasterCodeUtil.getCodeDesc(APP_STATUS_PEND_AFC_INPUT)));
        inboxCertificationCertificationStatus.add(new SelectOption(APP_STATUS_PEND_APPLICANT_CLARIFICATION, "Pending Facility"));
        inboxCertificationCertificationStatus.add(new SelectOption(PENDING_MOH, PENDING_MOH));
        inboxCertificationCertificationStatus.add(new SelectOption(APP_STATUS_APPROVED, "Completed"));
        INBOX_CERTIFICATION_SEARCH_STATUS_AFC = Collections.unmodifiableList(inboxCertificationCertificationStatus);
    }
    ...
    public static final List<SelectOption> INBOX_CERTIFICATION_SEARCH_PROCESS_TYPE_AFC;
    ...
    static {
        ...
        List<SelectOption> inboxCertificationProcessType = new ArrayList<>(1);
        inboxCertificationProcessType.add(new SelectOption(PROCESS_TYPE_FAC_REG, MasterCodeUtil.getCodeDesc(PROCESS_TYPE_FAC_REG)));
        inboxCertificationProcessType.add(new SelectOption(PROCESS_TYPE_APPROVAL_FOR_FACILITY_ACTIVITY_TYPE, MasterCodeUtil.getCodeDesc(PROCESS_TYPE_APPROVAL_FOR_FACILITY_ACTIVITY_TYPE)));
        INBOX_CERTIFICATION_SEARCH_PROCESS_TYPE_AFC = Collections.unmodifiableList(inboxCertificationProcessType);
    }
