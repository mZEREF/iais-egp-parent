...
public interface BsbInboxClient {
    ...
    @GetMapping("/fe-inbox/fac-admin/ins-cer")
    ResponseDto<InboxCertificationPageInfoResultDto> searchInboxInsCerForFacAdmin(@SpringQueryMap InboxAFCSearchDto dto);

    @GetMapping("/fe-inbox/afc-admin/certification")
    ResponseDto<InboxCertificationPageInfoResultDto> searchInboxCertificationForAFCAdmin(@SpringQueryMap InboxAFCSearchDto dto);

    @GetMapping(path = "/fe-inbox/count-ongoing-app/facility", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseDto<Integer> countOngoingApplicationByFacId(@RequestParam("facId") String facId);

    @GetMapping(path = "/fe-inbox/count-ongoing-app/approval", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseDto<Integer> countOngoingApplicationByApprovalId(@RequestParam("approvalId") String approvalId);
}
