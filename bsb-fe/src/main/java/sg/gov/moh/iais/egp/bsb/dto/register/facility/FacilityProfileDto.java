...
public class FacilityProfileDto implements ValidatableNodeValue, RefreshableDocDto {
    @Getter @Setter
    ...
    public boolean doValidation() {
        ...
        FacilityProfileValidateDto validateDto = new FacilityProfileValidateDto(validateDtoList, facClassification, activityTypes);
    ...
    public void reqObjMapping(HttpServletRequest request, FieldEditableJudger editableJudger) {
        ...
        if (idxSet.isEmpty()) {
            ...
            map.forEach((k, v) -> v.reqObjMapping(request, editableJudger, k.toString(), getFacClassification(), getActivityTypes()));
