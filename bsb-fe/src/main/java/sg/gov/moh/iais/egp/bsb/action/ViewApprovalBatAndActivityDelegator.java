...
public class ViewApprovalBatAndActivityDelegator {
    ...
    public void prepareData(BaseProcessClass bpc) {
        ...
        NodeGroup approvalAppRoot = approvalBatAndActivityDto.toApprovalAppRootGroup(KEY_ROOT_NODE_GROUP, ValidationConstants.VALIDATION_PROFILE_NEW);
        ParamUtil.setSessionAttr(request, ApprovalBatAndActivityConstants.KEY_APPROVAL_BAT_AND_ACTIVITY_DTO, approvalAppRoot);
