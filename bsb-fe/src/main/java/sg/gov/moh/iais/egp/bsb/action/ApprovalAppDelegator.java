...
public class ApprovalAppDelegator {
    private static final String MODULE_NAME = "New Approval Application";
    ...
    public void init(BaseProcessClass bpc) {
        ...
        if (newApprovalApp) {
            ParamUtil.setSessionAttr(request, KEY_ROOT_NODE_GROUP, approvalAppService.getApprovalAppRoot(request));
        }
    }
    ...
    public void handlePreviewSubmit(BaseProcessClass bpc) {
        HttpServletRequest request = bpc.request;
        NodeGroup approvalAppRoot = approvalAppService.getApprovalAppRoot(request);
