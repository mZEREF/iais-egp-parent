...
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.ERR_MSG_NULL_GROUP;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.ERR_MSG_NULL_NAME;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_ACTION_DELETE_DATA_FILE;
...
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_ACTION_LOAD_DATA_FILE;
...
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_CERTIFIER_TEAM_LIST;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_COUNTRY_OPTIONS;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_DATA_ERRORS;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_DATA_LIST;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_DEST_NODE_ROUTE;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_ERROR_IN_DATA_FILE;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_INDEED_ACTION_TYPE;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_IS_CERTIFY_TEAM_FILE;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_JUMP_DEST_NODE;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_NATIONALITY_OPTIONS;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_NAV_BACK;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_NAV_LOAD_CERTIFY_TEAM_FILE;
...
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_POSITION_OPTIONS;
...
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_SALUTATION_OPTIONS;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_SHOW_ERROR_SWITCH;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_SOURCE_NODE_PATH;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_VALIDATION_ERRORS;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.KEY_VALID_DATA_FILE;
...
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.NODE_NAME_BEGIN_FACILITY_CERTIFIER;
...
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.NODE_NAME_REVIEW;
...
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.TEXT_VALUE_CHINA;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.TEXT_VALUE_MALAYSIA;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.TEXT_VALUE_PLEASE_SELECT;
import static sg.gov.moh.iais.egp.bsb.constant.FacCertifierRegisterConstants.TEXT_VALUE_SINGAPORE;
