...
public class INTERNET___MohRfcFacilityRegistration___1 extends BaseProcessClass {
	...
	// 		PreAfc->OnStepProcess
		EngineHelper.delegate(DELEGATOR, "preAfc", this);
	}

	public void handleAfc_OnStepProcess_0() throws Exception {
	// 		HandleAfc->OnStepProcess
		EngineHelper.delegate(DELEGATOR, "handleAfc", this);
	}
