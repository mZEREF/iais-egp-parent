...
<script type="text/javascript" src="<%=sg.gov.moh.iais.egp.bsb.constant.GlobalConstants.WEB_ROOT%>/js/bsb/edit/bsb-edit-facility-committee.js"></script>
                                                ...
                                                <div class="document-upload-list">
                                                    ...
                                                    <div class="file-upload-gp">
                                                        ...
                                                        <c:if test="${dataHasError}">
                                                            <span class="error-msg"><iais:message key="BISERRNEW017"/></span>
                                                            <div class="row">
                                                                <div class="col-xs-12">
                                                                    <div class="table-gp">
