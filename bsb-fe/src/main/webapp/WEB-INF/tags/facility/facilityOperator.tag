...
<script type="text/javascript" src="<%=sg.gov.moh.iais.egp.bsb.constant.GlobalConstants.WEB_ROOT%>/js/bsb/edit/bsb-edit-facility-operator.js"></script>
                                ...
                                <div id="facInfoPanel" role="tabpanel">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-6 col-md-7">
                                                <select name="nationality" class="nationalityDropdown" id="nationality" onchange="modifyContactNoLength(this, 'contactNo', '')">
                                                    <option value="">Please Select</option>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-6 col-md-7">
                                                <input <c:choose><c:when test="${facOperator.nationality eq 'NAT0001'}">maxLength="8"</c:when><c:otherwise> maxLength="20"</c:otherwise></c:choose>
                                                       type="text" autocomplete="off" name="contactNo" id="contactNo" value='<c:out value="${facOperator.contactNo}"/>'/>
