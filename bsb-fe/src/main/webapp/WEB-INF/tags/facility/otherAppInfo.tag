...
<script type="text/javascript" src="<%=sg.gov.moh.iais.egp.bsb.constant.GlobalConstants.WEB_ROOT%>/js/bsb/edit/bsb-edit-other-info.js"></script>
...
<form method="post" id="mainForm" action="<%=process.runtime.continueURL()%>">
    ...
    <input type="hidden" id="editableFieldSet" value="allField" readonly disabled>
