...
<script type="text/javascript" src="<%=sg.gov.moh.iais.egp.bsb.constant.GlobalConstants.WEB_ROOT%>/js/bsb/edit/bsb-edit-facility-admin-officer.js"></script>
                            ...
                            <div class="tab-pane fade in active">
                                <div id="facInfoPanel" role="tabpanel">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <h3 class="col-12 pl-0" style="border-bottom: 1px solid black">Facility Administrator</h3>
                                        ...
                                        <section id="mainAdmin">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <select name="nationalityM" class="nationalityDropdown" id="nationalityM" onchange="modifyContactNoLength(this, 'contactNo', 'M')">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <input <c:choose><c:when test="${facAdminOfficer.mainAdmin.nationality eq 'NAT0001'}">maxLength="8"</c:when><c:otherwise> maxLength="20"</c:otherwise></c:choose>
                                                            type="text" autocomplete="off" name="contactNoM" id="contactNoM" value='<c:out value="${facAdminOfficer.mainAdmin.contactNo}"/>'/>
                                        ...
                                        <section id="alternativeAdmin">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-3">
                                                    <select name="idTypeA" class="idTypeADropdown" id="idTypeA" onchange="modifyIdNumberLength(this, 'idNumber', 'A')">
                                                        <option value="">Please Select</option>
                                                ...
                                                <div class="col-sm-3 col-md-4">
                                                    <input <c:choose><c:when test="${facAdminOfficer.alternativeAdmin.idType eq 'IDTYPE003'}">maxLength="13"</c:when><c:otherwise> maxLength="9"</c:otherwise></c:choose>
                                                           type="text" autocomplete="off" name="idNumberA" id="idNumberA" value='<c:out value="${facAdminOfficer.alternativeAdmin.idNumber}"/>'/>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <select name="nationalityA" class="nationalityDown" id="nationalityA" onchange="modifyContactNoLength(this, 'contactNo', 'A')">
                                                        <option value="">Please Select</option>
                                                        <c:forEach items="${nationalityOps}" var="na">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <input <c:choose><c:when test="${facAdminOfficer.alternativeAdmin.salutation eq 'NAT0001'}">maxLength="8"</c:when><c:otherwise> maxLength="20"</c:otherwise></c:choose>
                                                           type="text" autocomplete="off" name="contactNoA" id="contactNoA" value='<c:out value="${facAdminOfficer.alternativeAdmin.contactNo}"/>'/>
                                        ...
                                        <div id="sectionGroup">
                                            ...
                                            <section id="officerSection--v--${status.index}" <c:if test="${noOfficer}">style="display: none"</c:if>>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-sm-6 col-md-7">
                                                            <select name="nationality--v--${status.index}" class="nationalityvv" id="nationality--v--${status.index}" onchange="modifyContactNoLength(this, 'contactNo', '--v--${status.index}')">
                                                                <option value="">Please Select</option>
                                                                <c:forEach items="${nationalityOps}" var="na">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-sm-6 col-md-7">
                                                            <input <c:choose><c:when test="${officer.nationality eq 'NAT0001'}">maxLength="8"</c:when><c:otherwise> maxLength="20"</c:otherwise></c:choose>
                                                                   type="text" autocomplete="off" name="contactNo--v--${status.index}" id="contactNo--v--${status.index}" value='<c:out value="${officer.contactNo}"/>'/>
