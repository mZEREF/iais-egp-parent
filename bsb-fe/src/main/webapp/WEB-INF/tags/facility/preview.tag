...
<%@attribute name="isRfc" type="java.lang.Boolean" %>
...
<%@attribute name="srcNodePath" type="java.lang.String" %>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel-group" role="tablist" aria-multiselectable="true">
                    ...
                    <div id="previewFacInfo" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="panel-main-content form-horizontal min-row">
                                ...
                                <div>
                                    <div class="form-group">
                                        <label class="col-xs-6 control-label"><strong>Alternate Administrator</strong></label>
                                        <div class="clear"></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-6 control-label">Salutation</label>
                            ...
                            <c:if test="${not isRfJudge}">
                                ...
                                <div class="panel-main-content form-horizontal min-row">
                                    ...
                                    <div>
                                        <a href="javascript:void(0)" onclick="expandFile('${not empty srcNodePath?srcNodePath:'previewSubmit'}', 'bsbCommittee')">View Biosafety Committee Information</a>
                                    </div>
                                </div>
                            </c:if>
                            <c:if test="${not isPvRfJudge}">
                                ...
                                <div class="panel-main-content form-horizontal min-row">
                                    ...
                                    <div>
                                        <a href="javascript:void(0)" onclick="expandFile('${not empty srcNodePath?srcNodePath:'previewSubmit'}', 'facAuth')">View Authorised Personnel Information</a>
                                    </div>
                                </div>
                            </c:if>
                        </div>
                ...
                <c:if test="${not isRfc and (isUcfJudge or isFifthRfJudge)}">
                <div class="panel panel-default">
                    <div class="panel-heading completed">
                        <h4 class="panel-title">
                ...
                <c:if test="${isCfJudge || isUcfJudge}">
                <div class="panel panel-default">
                    <div class="panel-heading completed">
                        <h4 class="panel-title">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel-main-content form-horizontal min-row">
                                ...
                                <c:if test="${afc.appointed eq 'Y'}">
                                    ...
                                    <c:if test="${afc.selectReason ne null}">
                                        <div class="form-group">
