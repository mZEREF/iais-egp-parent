...
<script type="text/javascript" src="<%=sg.gov.moh.iais.egp.bsb.constant.GlobalConstants.WEB_ROOT%>/js/bsb/edit/bsb-edit-facility-authoriser.js"></script>
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="document-info-list">
                                            ...
                                            <ul>
                                                ...
                                                <li>The maximum file size is <%=fileMaxSize%> MB.</li>
                                            </ul>
                                        </div>
                                                ...
                                                <div class="document-upload-list">
                                                    ...
                                                    <div class="file-upload-gp">
                                                        ...
                                                        <c:if test="${dataHasError}">
                                                            <span class="error-msg"><iais:message key="BISERRNEW017" escape="false"/></span>
                                                            <div class="row">
                                                                <div class="col-xs-12">
                                                                    <div class="table-gp">
