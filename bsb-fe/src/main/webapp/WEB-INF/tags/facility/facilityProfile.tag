...
<%@attribute name="findGazetteError" type="java.lang.Boolean" %>
...
<script type="text/javascript" src="<%=sg.gov.moh.iais.egp.bsb.constant.GlobalConstants.WEB_ROOT%>/js/bsb/edit/bsb-edit-facility-profile.js"></script>
                                ...
                                <div id="facInfoPanel" role="tabpanel">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <c:forEach var="info" items="${facProfile.infoList}" varStatus="status">
                                            ...
                                            <div id="isSameAddrSection--v--${status.index}" <c:if test="${info.sameAddress eq null}">style="display: none"</c:if>>
                                                ...
                                                <div id="isSameAddrSectionN--v--${status.index}" <c:if test="${info.sameAddress ne 'N'}">style="display: none"</c:if>>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-sm-6 col-md-7">
                                                            <input maxLength="66" type="text" autocomplete="off" name="buildingName--v--${status.index}" id="buildingNameN--v--${status.index}" value='<c:out value="${notSameAddrDto.building}"/>'/>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-6 col-md-7">
                                                        <div class="form-check col-xs-4" style="margin-top: 8px">
                                                            <input type="radio" class="form-check-input" name="protectedPlace--v--${status.index}" id="isAProtectedPlace--v--${status.index}" data-custom-ind="gazetted" data-rf-ind="${isFifthRf or isPvRf}" value="Y" <c:if test="${info.facilityProtected eq 'Y'}">checked="checked"</c:if> />
                                                            <label for="isAProtectedPlace--v--${status.index}" class="form-check-label">Yes<span class="check-circle"></span></label>
                                                        </div>
                                                        <div class="form-check col-xs-8" style="margin-top: 8px">
                                                            <input type="radio" class="form-check-input" name="protectedPlace--v--${status.index}" id="notAProtectedPlace--v--${status.index}" data-custom-ind="gazetted" data-rf-ind="${isFifthRf or isPvRf}" value="N" <c:if test="${info.facilityProtected eq 'N'}">checked="checked"</c:if> />
                                            ...
                                            <c:if test="${not (isFifthRf or isPvRf)}">
                                            ...
                                            <div id="inventoryInfoSection--v--${status.index}">
                                                ...
                                                <div id="opvSabin1IMSubSection--v--${status.index}" data-custom-ind="opvSabinSubSection" <c:if test="${info.opvSabin1IM ne 'Y'}">style="display: none"</c:if>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6 col-md-7">
                                                            <textarea maxLength="500" class="col-xs-12" style="margin-bottom: 15px;" name="opvSabin1IMRetentionReason--v--${status.index}" id="opvSabin1IMRetentionReason--v--${status.index}" rows="5"><c:out value="${info.opvSabin1IMRetentionReason}"/></textarea>
                                                ...
                                                <div id="opvSabin3IMSubSection--v--${status.index}" data-custom-ind="opvSabinSubSection" <c:if test="${info.opvSabin3IM ne 'Y'}">style="display: none"</c:if>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6 col-md-7">
                                                            <textarea maxLength="500" class="col-xs-12" style="margin-bottom: 15px;" name="opvSabin3IMRetentionReason--v--${status.index}" id="opvSabin3IMRetentionReason--v--${status.index}" rows="5"><c:out value="${info.opvSabin3IMRetentionReason}"/></textarea>
                                                ...
                                                <div id="opvSabin1PIMSubSection--v--${status.index}" data-custom-ind="opvSabinSubSection" <c:if test="${info.opvSabin1PIM ne 'Y'}">style="display: none"</c:if>>
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="col-sm-5 control-label">
                                                            ...
                                                            <span class="mandatory otherQualificationSpan">*</span>
                                                            <a class="btn-tooltip styleguide-tooltip" href="javascript:void(0);" data-toggle="tooltip" data-html="true" title="" data-original-title="<p>For more information regarding the risk levels associated with poliovirus PIM, please visit the MOH Biosafety website.</p>">i</a>
                                                        </div>
                                                        <div class="col-sm-6 col-md-7">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6 col-md-7">
                                                            <textarea maxLength="500" class="col-xs-12" style="margin-bottom: 15px;" name="opvSabin1PIMRetentionReason--v--${status.index}" id="opvSabin1PIMRetentionReason--v--${status.index}" rows="5"><c:out value="${info.opvSabin1PIMRetentionReason}"/></textarea>
                                                ...
                                                <div id="opvSabin2PIMSubSection--v--${status.index}" data-custom-ind="opvSabinSubSection" <c:if test="${info.opvSabin2PIM ne 'Y'}">style="display: none"</c:if>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6 col-md-7">
                                                            <textarea maxLength="500" class="col-xs-12" style="margin-bottom: 15px;" name="opvSabin2PIMRetentionReason--v--${status.index}" id="opvSabin2PIMRetentionReason--v--${status.index}" rows="5"><c:out value="${info.opvSabin2PIMRetentionReason}"/></textarea>
                                                ...
                                                <div id="opvSabin3PIMSubSection--v--${status.index}" data-custom-ind="opvSabinSubSection" <c:if test="${info.opvSabin3PIM ne 'Y'}">style="display: none"</c:if>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6 col-md-7">
                                                            <textarea maxLength="500" class="col-xs-12" style="margin-bottom: 15px;" name="opvSabin3PIMRetentionReason--v--${status.index}" id="opvSabin3PIMRetentionReason--v--${status.index}" rows="5"><c:out value="${info.opvSabin3PIMRetentionReason}"/></textarea>
                                        ...
                                        <input type="hidden" id="findGazetteError" value="${findGazetteError}" readonly disabled/>
                                    </div>
                                </div>
