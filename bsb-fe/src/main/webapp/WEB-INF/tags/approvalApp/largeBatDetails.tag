...
<%@attribute name="batInfo" required="true" type="sg.gov.moh.iais.egp.bsb.dto.register.approval.ApprovalToLargeDto" %>
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-12">
                                                                <a id="addNewBatSection" style="text-decoration: none" href="javascript:void(0)">+ Add New Biological Agent</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
