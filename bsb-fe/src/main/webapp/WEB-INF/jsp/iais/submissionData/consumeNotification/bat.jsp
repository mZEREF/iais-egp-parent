                        ...
                        <section id="reqTSection--v--${status.index}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-7">
                                    ...
                                    <iais:select name="consumeType--v--${status.index}" id="consumeType--v--${status.index}"
                                                 value=""
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-7">
                                        ...
                                        <%--不能为负--%>
                                    <input type="number" name="consumedQty--v--${status.index}" id="consumedQty--v--${status.index}" value=""
                                           maxlength="11"
