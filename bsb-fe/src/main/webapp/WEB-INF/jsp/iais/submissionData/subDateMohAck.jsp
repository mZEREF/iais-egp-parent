    ...
    <div class="row">
        <div class="container">
            ...
            <div class="col-xs-12 col-md-6 text-right">
                <a class="btn btn-secondary" href="/bsb-web/eservice/INTERNET/BsbDataSubmission">START ANOTHER SUBMISSION</a>
                <a class="btn btn-secondary" href="/bsb-web/eservice/INTERNET/MohBSBInboxMsg">GO TO DASHBOARD</a>
            </div>
        </div>
    </div>
</form>
