                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-7 col-md-5 col-xs-7"><p>${item.batName}</p></div>
                                                                                    <div class="clear"></div>
                                                                                </div>
                                                                                <c:choose>
                                                                                    <c:when test="${item.scheduleType ne 'SCHTYPE050'}">
                                                                                        <div class="form-group">
                                                                                            <label class="col-xs-5 col-md-4 control-label">Type Transferred</label>
                                                                                            <div class="col-sm-7 col-md-5 col-xs-7"><p>${item.transferredType}</p></div>
                                                                                            <div class="clear"></div>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label class="col-xs-5 col-md-4 control-label">Quantity of Biological Agent Received</label>
                                                                                            <div class="col-sm-7 col-md-5 col-xs-7"><p>${item.receivedBatQty}</p></div>
                                                                                            <div class="clear"></div>
                                                                                        </div>
                                                                                    </c:when>
                                                                                    <c:otherwise>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-7 col-md-5 col-xs-7"><p>${item.transferredUnit}</p></div>
                                                                                            <div class="clear"></div>
                                                                                        </div>
                                                                                    </c:otherwise>
                                                                                </c:choose>
                                                                ...
                                                                <div class="panel-main-content form-horizontal min-row">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-7 col-md-5 col-xs-7"><p>${receiptSaved.receivingFacName}</p></div>
                                                                            <div class="clear"></div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="col-xs-5 col-md-4 control-label">Actual Date of Receipt</label>
                                                                            <div class="col-sm-7 col-md-5 col-xs-7"><p>${receiptSaved.actualReceiptDate}</p></div>
                                                                            <div class="clear"></div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="col-xs-5 col-md-4 control-label">Actual Time of Receipt</label>
                                                                            <div class="col-sm-7 col-md-5 col-xs-7"><p>${receiptSaved.actualReceiptTime}</p></div>
                                                                            <div class="clear"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
