...
<bat:possessBatDetails batInfos="${batInfo.batInfos}" addressTypeOps="${addressTypeOps}" countryOps="${countryOps}" activeNodeKey="${activeNodeKey}"
                          processType="${processType}" firstScheduleOp="${firstScheduleOp}" scheduleBatMap="${scheduleBatMap}" scheduleOps="${scheduleOps}" editJudge="${pageAppEditSelectDto.appSelect}">
