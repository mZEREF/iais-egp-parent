...
<fac:facilityAuthoriser facAuth="${facAuth}" dataHasError="${DATA_HAS_ERROR}" dataErrors="${DATA_ERRORS}" validFile="${VALID_FILE}" authoriserSampleFile="${authoriserSampleFile}" editJudge="${pageAppEditSelectDto.facSelect}">
