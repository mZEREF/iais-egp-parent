                                ...
                                <div class="row" style="padding-top: 10px;">
                                    <div class="col-xs-12 col-sm-6">
                                        <span style="padding-right: 10%" class="components">
                                            <a class="back" id="previous" href="/bsb-web/eservice/INTERNET/MohBsbRfi?appId=<iais:mask name='rfiAppId' value='${withdrawnDto.appId}'/>"><em class="fa fa-angle-left"></em> Previous</a>
                                        </span>
                                    </div>
