            ...
            <div class="col-xs-12">
                <div class="dashboard-gp">
                    <div class="dashboard-tile-item">
                        <div class="dashboard-tile"><a data-tab="#tabInbox" href="/bsb-web/eservice/INTERNET/MohBSBInboxMsg?msgStatus=MSGRS001" onclick="licToMsgPage()">
                    ...
                    <div class="dashboard-tile-item">
                        <div class="dashboard-tile"><a data-tab="#tabApp" href="/bsb-web/eservice/INTERNET/MohBSBInboxApp?searchStatus=BSBAPST011" onclick="licToAppPage()">
