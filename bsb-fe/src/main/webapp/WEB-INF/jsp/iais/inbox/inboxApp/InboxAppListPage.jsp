                                                            ...
                                                            <td>
                                                                ...
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${app.processType eq 'PROTYPE002' or app.processType eq 'PROTYPE003' or app.processType eq 'PROTYPE004'}">
                                                                        <a href="/bsb-fe/eservice/INTERNET/MohViewApprovalPossessApplication?appId=<iais:mask name='id' value='${app.id}'/>&processType=<iais:mask name='processType' value='${app.processType}'/><c:if test="${app.status eq 'BSBAPST001'}">&editId=<iais:mask name='editId' value='${app.id}'/></c:if>"><c:out value="${app.applicationNo}"/></a>
                                                                    </c:when>
                                                                ...
                                                                <select id="appAction${status.index}" name="appAction${status.index}" data-action-select="">
                                                                    ...
                                                                    <c:choose>
                                                                        ...
                                                                        <c:when test="${(app.processType eq 'PROTYPE002' or app.processType eq 'PROTYPE003' or app.processType eq 'PROTYPE004') and app.status eq 'BSBAPST001'}">
                                                                            <option value="/bsb-fe/eservice/INTERNET/MohApprovalApplication?editId=<iais:mask name='editId' value='${app.id}'/>&processType=<iais:mask name='processType' value='${app.processType}'/>">Edit</option>
                                                                        </c:when>
