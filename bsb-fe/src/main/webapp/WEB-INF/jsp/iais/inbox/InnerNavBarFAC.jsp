...
<ul class="nav nav-tabs hidden-xs hidden-sm" role="tablist">
    ...
    <li role="presentation" id="appTab">
        <a href="/bsb-web/eservice/INTERNET/MohBSBInboxApp" aria-controls="tabApp" role="tab">Applications  <span class="btn-tooltip styleguide-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="<p>Contains past applications that were submitted to MOH and saved draft applications.</p>" style="border-radius: 50%">i</span></a>
    </li>
    <li role="presentation" id="facTab">
        <a href="/bsb-web/eservice/INTERNET/MohBSBInboxFac" aria-controls="tabFac" role="tab">Facilities  <span class="btn-tooltip styleguide-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="<p>Unless submitting an application for new facility registration,please select from the list of available facility before performing any application or submission.</p>" style="border-radius: 50%">i</span></a>
    </li>
    ...
    <li role="presentation" id="certTab">
        <a href="/bsb-web/eservice/INTERNET/MohBsbInboxCertificationInspectionFAC" style="padding: 15px 0" aria-controls="tabLic" role="tab">Certifications/<br/>Inspections  <span class="btn-tooltip styleguide-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="<p>For retrieval of final report uploaded by MOH and/or MOH-AFC.</p>" style="border-radius: 50%; position: absolute; top: 27px; right: 8px;">i</span></a>
    </li>
    ...
    <li role="presentation" id="reportEventTab">
        <a href="/bsb-web/eservice/INTERNET/MohBsbInboxRep" aria-controls="tabLic" role="tab">Reportable Events</a>
    </li>
</ul>
<div class="tab-nav-mobile visible-xs visible-sm">
    <div class="swiper-wrapper" role="tablist">
        ...
        <div class="swiper-slide">
            <a href="/bsb-web/eservice/INTERNET/MohBSBInboxApp" aria-controls="tabApplication" role="tab">Applications</a>
        </div>
        <div class="swiper-slide">
            <a href="/bsb-web/eservice/INTERNET/MohBSBInboxFac" aria-controls="tabFacility" role="tab">Facilities</a>
        </div>
        <div class="swiper-slide">
            <a href="/bsb-web/eservice/INTERNET/MohBsbInboxApprovalFacAdmin" aria-controls="tabLicence" role="tab">Approvals</a>
        </div>
        <div class="swiper-slide">
            <a href="/bsb-web/eservice/INTERNET/MohBsbInboxCertificationInspectionFAC" aria-controls="tabLicence" role="tab">Certifications/Inspections</a>
        </div>
        <div class="swiper-slide">
            <a href="#" aria-controls="tabLicence" role="tab">Data Submissions</a>
        </div>
        <div class="swiper-slide">
            <a href="/bsb-web/eservice/INTERNET/MohBsbInboxRep" aria-controls="tabLicence" role="tab">Reportable Events</a>
        </div>
    </div>
