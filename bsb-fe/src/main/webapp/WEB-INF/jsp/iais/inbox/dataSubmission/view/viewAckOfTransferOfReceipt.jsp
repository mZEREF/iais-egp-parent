                            ...
                            <c:choose>
                                <c:when test="${item.schedule ne 'SCHTYPE006'}">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7 col-md-5 col-xs-7"><p><iais:code code="${item.handleType}"/></p></div>
                                        <div class="clear"></div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <c:otherwise>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7 col-md-5 col-xs-7"><p><iais:code code="${item.transferredUnit}"/></p></div>
                                        <div class="clear"></div>
                                    </div>
                                </c:otherwise>
                            </c:choose>
