...
<div class="panel-group" role="tablist" aria-multiselectable="true">
    ...
    <div class="panel panel-default">
        ...
        <div id="previewBatInfo" class="panel-collapse collapse">
            <div class="panel-body">
                <c:forEach var="info" items="${dataSubInfo.exportNotList}" varStatus="status">
                    <div class="panel-main-content form-horizontal min-row">
                        <div class="form-group">
                            <div class="col-10">
                        ...
                        <div>
                            ...
                            <c:choose>
                                <c:when test="${info.schedule eq 'SCHTYPE050'}">
                                    <div class="form-group">
                ...
                <div class="panel-main-content form-horizontal min-row">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7 col-md-5 col-xs-7">
                                <p>${dataSubInfo.receivingCountry}</p>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7 col-md-5 col-xs-7">
                                <p><fmt:formatDate value="${dataSubInfo.exportationDate}"
