                                    ...
                                    <div class="table-gp">
                                        <table aria-describedby="" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <iais:sortableHeader needSort="false" field="processType" value="Process Type" isFE="true" style="width:12%"/>
                                                <iais:sortableHeader needSort="true" field="status" value="Status" isFE="true" style="width:10%"/>
                                                <iais:sortableHeader needSort="false" field="" value="Organization Name" isFE="true" style="width:8%"/>
                                                <iais:sortableHeader needSort="false" field="" value="Organization Address" isFE="true" style="width:14%"/>
                                            ...
                                            <tbody>
                                            <c:choose>
                                                <%--@elvariable id="dataList" type="java.util.List<sg.gov.moh.iais.egp.bsb.entity.Approval>"--%>
