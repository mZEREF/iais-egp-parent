                                                            ...
                                                            <div id="previewIncidentInfo" class="panel-collapse collapse">
                                                                <div class="panel-body">
                                                                    <c:if test="${view.followupStatus ne 'INCIDST003' && view.followupStatus ne 'INCIDST002'}">
                                                                        <div class="text-right app-font-size-16"><c:if test="${not empty maskedEditId}"><a href="/bsb-web/eservice/INTERNET/IncidentFollowup1BEdit?editId=${maskedEditId}"><em class="fa fa-pencil-square-o"></em>Edit</a></c:if></div>
                                                                    </c:if>
