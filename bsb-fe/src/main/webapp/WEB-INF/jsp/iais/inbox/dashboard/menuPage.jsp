...
<%@ taglib uri="http://www.ecq.com/iais-bsb" prefix="bsb"%>
...
<bsb:single-constant attributeKey="afcRole" classFullName="com.ecquaria.cloud.moh.iais.common.constant.role.RoleConsts" constantName="USER_ROLE_BSB_AFC_USER"/>
<div class="row">
        ...
        <div class="navigation">
            <ul class="nav nav-tabs nav-menu">
                ...
                <menu:load id="inbox-top-menus">
                    <c:choose>
                        <%--@elvariable id="iais_Login_User_Info_Attr" type="com.ecquaria.cloud.moh.iais.dto.LoginContext"--%>
                        <c:when test="${afcRole eq iais_Login_User_Info_Attr.curRoleId}">
                            <menu:include name="BSB_INTER_INBOX_AFC"/>
                        </c:when>
                        <c:otherwise>
