...
<div class="tab-nav-mobile visible-xs visible-sm" style="overflow:hidden">
    <div class="swiper-wrapper" role="tablist">
        <div class="swiper-slide"><a data-step-key="orgInfo" role="tab" aria-controls="orgInfoPanel" aria-selected="<%=FacilityCertifierRegistrationService.ifNodeSelectedForJsp(facRegRoot, NODE_NAME_ORGANISATION_INFO)%>">Application Information</a></div>
        <div class="swiper-slide"><a data-step-key="primaryDocument" role="tab" aria-controls="PrimaryDocPanel" aria-selected="<%=FacilityCertifierRegistrationService.ifNodeSelectedForJsp(facRegRoot, NODE_NAME_FAC_PRIMARY_DOCUMENT)%>">Supporting Documents</a></div>
        <div class="swiper-slide"><a data-step-key="previewSubmit" role="tab" aria-controls="previewSubmitPanel" aria-selected="<%=FacilityCertifierRegistrationService.ifNodeSelectedForJsp(facRegRoot, NODE_NAME_CER_PREVIEW_SUBMIT)%>">Preview and Submit</a></div>
    </div>
