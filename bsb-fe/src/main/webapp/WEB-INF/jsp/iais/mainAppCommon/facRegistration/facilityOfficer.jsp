...
<div class="form-group ">
    ...
    <div class="col-sm-6 col-md-7">
        <input type="text" autocomplete="off" name="employmentStartDt" id="employmentStartDt" data-date-start-date="01/01/1900" value="<c:out value="${facOfficer.employmentStartDt}"/>" placeholder="dd/mm/yyyy" maxlength="10" class="date_picker form-control"/>
