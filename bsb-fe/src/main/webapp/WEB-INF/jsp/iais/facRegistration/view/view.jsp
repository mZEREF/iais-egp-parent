...
<%--@elvariable id="SELECTED_ACTIVITIES" type="java.lang.String"--%>
<%--@elvariable id="isCertifiedFacility" type="java.lang.String"--%>
<%--@elvariable id="isUncertifiedFacility" type="java.lang.String"--%>
<%--@elvariable id="isRegisteredFacility" type="java.lang.String"--%>
<%--@elvariable id="isSPFifthRegisteredFacility" type="java.lang.String"--%>
<%--@elvariable id="isPolioVirusRegisteredFacility" type="java.lang.String"--%>
    ...
    <div class="main-content">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <a class="back" href="${goBackUrl}"><em class="fa fa-angle-left"></em> Previous</a>
                </div>
            </div>
        </div>
    </div>
