...
<ul id="nav-tabs-ul" class="nav nav-tabs hidden-xs hidden-sm" role="tablist">
    <%if (facRegRoot.getNode(sg.gov.moh.iais.egp.bsb.constant.FacRegisterConstants.NODE_NAME_COMPANY_INFO).isAvailable()) {%>
    <li role="presentation" class="<%=sg.gov.moh.iais.egp.bsb.service.FacilityRegistrationService.computeTabClassnameForJsp(facRegRoot, sg.gov.moh.iais.egp.bsb.constant.FacRegisterConstants.NODE_NAME_COMPANY_INFO)%>">
        <a data-step-key="compInfo" role="tab" aria-selected="<%=sg.gov.moh.iais.egp.bsb.service.FacilityRegistrationService.ifNodeSelectedForJsp(facRegRoot, sg.gov.moh.iais.egp.bsb.constant.FacRegisterConstants.NODE_NAME_COMPANY_INFO)%>">Company Information</a>
    </li>
    <%}%>
