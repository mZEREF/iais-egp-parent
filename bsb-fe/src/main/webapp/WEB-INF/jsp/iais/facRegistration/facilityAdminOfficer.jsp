...
<form method="post" id="mainForm" action="<%=process.runtime.continueURL()%>">
    ...
    <input type="hidden" name="sectionIdx" value="${TableDisplayUtil.indexes(facAdminOfficer.officerList.size())}">
                            ...
                            <div class="tab-pane fade in active">
                                <div id="facInfoPanel" role="tabpanel">
                                    ...
                                    <div class="form-horizontal">
                                        <%@ include file="../mainAppCommon/facRegistration/facilityAdminOfficer.jsp" %>
                                    </div>
                                </div>
