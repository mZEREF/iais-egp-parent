...
<fac:supportingDocuments savedFiles="${savedFiles}" newFiles="${newFiles}" docSettings="${docSettings}" editJudge="true" otherDocTypes="${otherDocTypes}" docTypeOps="${docTypeOps}"
