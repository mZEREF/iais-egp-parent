...
<form method="post" id="mainForm" action=<%=process.runtime.continueURL()%>>
    ...
    <div class="container">
        <div class="component-gp col-xs-12 col-sm-11 col-md-10 col-lg-8">
            ...
            <br/>
            <p>application to defer renewal of registeration for Facility No.${appInfo.facilityNo}</p>
            ...
            <div class="col-xs-12" style="padding: 0 0 10px 0; margin-bottom: 10px; border-bottom: 1px solid black">
                <div class="col-xs-4" style="padding: 0">${appInfo.appNo}</div>
                <div class="col-xs-4" style="padding: 0"><fmt:formatDate value="${appInfo.date}" pattern="dd/MM/yyyy HH:mm:ss"/></div>
            </div>
            <br/>
            <div class="row">
                ...
                <div class="col-xs-12 col-md-10">
                    <div class="text-right text-center-mobile">
                        <a class="btn btn-secondary" href="javascript:void(0);" onclick="printFacilityRegistration(${appInfo.appNo});">PRINT</a>
