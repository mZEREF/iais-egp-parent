...
<fac:facilityCommittee facCommittee="${facCommittee}" dataHasError="${DATA_HAS_ERROR}" dataErrors="${DATA_ERRORS}" validFile="${VALID_FILE}" committeeSampleFile="${committeeSampleFile}" editJudge="${true}" editableFieldSet="${editableFieldSet}"
