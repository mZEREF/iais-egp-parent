                                    ...
                                    <div class="table-gp">
                                        <table aria-describedby="" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <iais:sortableHeader needSort="true" field="name" value="Facility Name" isFE="true" style="width:15%"/>
                                                <iais:sortableHeader needSort="true" field="classification" value="Facility Classification" isFE="true" style="width:18%"/>
