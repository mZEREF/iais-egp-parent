                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active">
                                <div id="previewPanel" role="tabpanel">
                                    <approvalApp:preview facProfileDto="${facProfileDto}" batInfo="${batInfo}" facAuthorisedList="${facAuthListWanted}" processType="${processType}" facProfileEditJudge="true" docEditJudge="true">
                                ...
                                <div class="application-tab-footer">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 ">
                                            <a class="back" id="previous" href="/bsb-web/eservice/INTERNET/MohBsbInboxApprovalFacAdmin"><em class="fa fa-angle-left"></em> Previous</a>
                                        </div>
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="button-group">
                                                <a class="btn btn-secondary" id="printBtn" onclick="printApprovalApp('${printApprovalAppId}');" >Print</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
