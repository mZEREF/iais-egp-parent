...
<iais:confirm msg="There is an existing draft for the chosen type; if you choose to continue with a new application, the draft application will be discarded."
