                                                                ...
                                                                <section id="batInfoSection--v--${status.index}">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="col-sm-6" style="z-index: 30;">
                                                                            <select name="schedule--v--${status.index}" class="schedule-v-Dropdown" id="schedule--v--${status.index}" data-cascade-dropdown="schedule-bat">
                                                                    ...
                                                                    <div id="transferringFacilityDiv--v--${status.index}" <c:if test="${info.procurementMode ne MasterCodeConstants.PROCUREMENT_MODE_LOCAL_TRANSFER}">style="display: none;"</c:if>>
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <select name="addressType--v--${status.index}" class="addressType-v-Dropdown" id="addressType--v--${status.index}">
