...
<%--@elvariable id="existBatSet" type="java.util.Set<java.lang.String>"--%>
<bat:largeBatDetails batInfos="${batInfo.batInfos}" addressTypeOps="${addressTypeOps}" nationalityOps="${nationalityOps}" activeNodeKey="${activeNodeKey}"
                      firstScheduleOp="${firstScheduleOp}" scheduleBatMap="${scheduleBatMap}" scheduleOps="${scheduleOps}" sourceFac="${sourceFacDetails}"  existBatSet="${existBatSet}" lspJudge="true">
