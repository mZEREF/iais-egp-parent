                                                            ...
                                                            <c:forEach var="info" items="${approvalProfile.batInfos}" varStatus="status">
                                                                ...
                                                                <section id="approvalProfileSection--v--${status.index}">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <select name="batId--v--${status.index}"  class="batIdDropdown${status.index}" id="batId--v--${status.index}">
                                                                    ...
                                                                    <c:if test="${processType eq 'PROTYPE002' or processType eq 'PROTYPE003'}">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <select name="transferCountry--v--${status.index}" class="transferCountryDropdown${status.index}" id="transferCountry--v--${status.index}">
