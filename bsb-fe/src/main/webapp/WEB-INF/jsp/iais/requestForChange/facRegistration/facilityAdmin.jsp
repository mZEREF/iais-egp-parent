                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <section id="mainAdmin">
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <input type="text" autocomplete="off" name="adminNameM" id="adminNameM" value='<c:out value="${facAdmin.mainAdmin.adminName}"/>'/>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-3 col-md-4">
                                                    <input type="text" autocomplete="off" name="idNumberM" id="idNumberM" value='<c:out value="${facAdmin.mainAdmin.idNumber}"/>'/>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <input type="text" autocomplete="off" name="designationM" id="designationM" value='<c:out value="${facAdmin.mainAdmin.designation}"/>'/>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <input type="text" autocomplete="off" name="contactNoM" id="contactNoM" value='<c:out value="${facAdmin.mainAdmin.contactNo}"/>'/>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <input type="text" autocomplete="off" name="emailM" id="emailM" value='<c:out value="${facAdmin.mainAdmin.email}"/>'/>
                                        ...
                                        <section id="alternativeAdmin">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-3 col-md-4">
                                                    <input type="text" autocomplete="off" name="idNumberA" id="idNumberA" value='<c:out value="${facAdmin.alternativeAdmin.idNumber}"/>'/>
