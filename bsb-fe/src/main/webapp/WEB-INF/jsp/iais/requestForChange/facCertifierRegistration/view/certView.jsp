                            ...
                            <div class="tab-pane fade in active">
                                <div id="previewSubmitPanel" role="tabpanel">
                                    <fac:preview orgProfile="${orgProfile}" orgCerTeam="${orgCerTeam}" orgAdmin="${orgAdmin}"
                                        ...
                                        <jsp:attribute name="editFrag"><c:if test="${not empty maskedEditId}"><a href="/bsb-fe/eservice/INTERNET/MohRfcFacilityCertifierRegistration?editId=${maskedEditId}&processType=<iais:mask name='processType' value='${processType}'/>&step=REPLACE-STEP-KEY"><em class="fa fa-pencil-square-o"></em>Edit</a></c:if></jsp:attribute>
