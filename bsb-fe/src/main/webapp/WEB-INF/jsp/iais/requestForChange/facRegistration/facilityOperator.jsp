...
<fac:facilityOperator facOperator="${facOperator}" salutationOps="${salutationOps}" nationalityOps="${nationalityOps}" editJudge="${true}" editableFieldSet="${editableFieldSet}"
