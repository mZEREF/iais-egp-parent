            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="tab-gp steps-tab">
                            ...
                            <div class="tab-pane fade in active">
                                <div id="previewSubmitPanel" role="tabpanel">
                                    <fac:preview isCfJudge="${isCertifiedFacility}" isUcfJudge="${isUncertifiedFacility}" isRfJudge="${isRegisteredFacility}" isFifthRfJudge="${isSPFifthRegisteredFacility}" isPvRfJudge="${isPolioVirusRegisteredFacility}"
                                                 ...
                                                 profileEditJudge="true" batListEditJudge="false" docEditJudge="true" otherAppInfoEditJudge="true" afcEditJudge="true" isRfc="true">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
                                        <a href="#" data-step-key="serviceSelection">Click here to amend other sections</a>
                                    </div>
                                </div>
                        ...
                        <iais:confirm msg="Please make something change" needFungDuoJi="false" popupOrder="noChangeMessage"  title=" " callBack="$('#noChangeMessage').modal('hide');"  needCancel="false" />
