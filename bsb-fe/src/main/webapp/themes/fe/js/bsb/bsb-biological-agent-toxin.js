$(function () {
    var detailRelatedIdsPrefix = ["sampleEnv", "sampleOthers", "workBiomanufacturing", "workAnimal", "workOthers"];
    var detailDivIdPrefix = "sampleWorkDetailDiv";
    $("input[data-custom-ind=batEvnSampleType]").change(function () {
        var id = $(this).attr("id");
        var idx = id.substring('sampleEnv'.length, id.length);
