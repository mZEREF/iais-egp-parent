...
<form method="post" action=<%=process.runtime.continueURL()%>>
  ...
  <h1>AssignedInspection</h1>
  <iais:action>
    <button type="button" class="search btn" onclick="javascript:inspectionChecklist();">Choose one inspection</button>
  </iais:action>
</form>

<script type="text/javascript">
  function inspectionChecklist(){
    SOP.Crud.cfxSubmit("mainForm", "inspectionChecklist");
  }
