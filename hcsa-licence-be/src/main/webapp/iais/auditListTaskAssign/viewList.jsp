...
<form id = "mainForm" method = "post" action=<%=process.runtime.continueURL()%>>
    ...
    <input type="hidden" name="paramController" id="paramController" value="com.ecquaria.cloud.moh.iais.action.AuditSystemListDelegator"/>
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach var = "item" items = "${auditTaskDataDtos}" varStatus="status">
                                        <tr>
                                            ...
                                            <td>
                                                <input name="<c:out value="${id}"/>selectForAd" id="<c:out value="${id}"/>selectForAd" <c:if test="${item.selectedForAudit}">checked</c:if> type="checkbox" value="ad">
                                            </td>
                                        </tr>
                                    </c:forEach>
