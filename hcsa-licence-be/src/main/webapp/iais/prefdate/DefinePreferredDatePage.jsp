  ...
  <%@ include file="/include/formHidden.jsp" %>
      ...
      <div class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-5 col-md-3" >
            <input type="text" name="periodAfterApp" maxlength="2" value="${sessionScope.requestPeriodAttr.periodAfterApp}" />
        ...
        <div class="form-group">
          ...
          <div class="col-xs-5 col-md-3" >
            <input type="text" name="periodBeforeExp" maxlength="2" value="${sessionScope.requestPeriodAttr.periodBeforeExp}" />
        ...
        <div class="form-group">
          ...
          <div class="col-xs-5 col-md-3" >
            <input type="text" name="nonReplyWindow" maxlength="2" value="${sessionScope.requestPeriodAttr.nonReplyWindow}" />
