                    ...
                    <div class="tab-gp dashboard-tab">
                        ...
                        <div class="tab-pane <c:if test="${serListDto.checkListTab=='chkList'}">active</c:if>" id="tabPayment" role="tabpanel">
                                            ...
                                            <table class="table">
                                                ...
                                                <c:forEach var = "item" items = "${section.itemDtoList}" varStatus="two">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <textarea cols="70" rows="7" name="<c:out value="${item.incqDto.sectionNameSub}"/><c:out value="${item.incqDto.itemId}"/>comremark" id="<c:out value="${item.incqDto.sectionNameSub}"/><c:out value="${item.incqDto.itemId}"/>comremark" maxlength="500"><c:out value="${item.incqDto.remark}"/></textarea>
                                                        </td>
                                                        <td>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <c:forEach var = "item" items = "${section.itemDtoList}" varStatus="status">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <textarea cols="70" rows="7" name="<c:out value="${cdto.subName}"/><c:out value="${item.incqDto.sectionNameSub}"/><c:out value="${item.incqDto.itemId}"/>remark" id="<c:out value="${cdto.subName}"/><c:out value="${item.incqDto.itemId}"/><c:out value="${item.incqDto.sectionNameSub}"/>itemCheckboxRemark" maxlength="500"><c:out value="${item.incqDto.remark}"/></textarea>
                                                            </td>
                                                            <td>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div align="left">
                                        <a class="back" href="#" onclick="doBack()"><em class="fa fa-angle-left"/> Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
