                                                ...
                                                <div class="table-gp">
                                                    <table class="table">
                                                        <tr>
                                                            ...
                                                            <td class="col-xs-4">
                                                                <p>
                                                                    <textarea name="followUpAction" cols="50" rows="6" title="content" maxlength="8000">
                                                        ...
                                                        <tr id="engageRemarks" hidden>
                                                            ...
                                                            <td class="col-xs-4">
                                                                <p>
                                                                    <textarea name="enforcementRemarks" cols="50" rows="6" title="content" MAXLENGTH="4000">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="table-gp">
                                                    <table class="table">
                                                        <tr>
                                                            <td class="col-xs-4">
                                                                <p>To include findings in risk score framework?</p>
                                                            </td>
                                                            <td class="col-xs-4">
                                                                <input type="checkbox" id="framework" name="frameworkIncluded"
                                                                       onchange="javascirpt:changeframework();">
                                                            </td>
                                                            <td class="col-xs-4"></td>
                                                        </tr>
                                                        <tr id="frameworkOp" hidden>
                                                            <td class="col-xs-4">
                                                                <p>Which form of risk should it be recorded in risk score framework?:</p>
                                                            </td>
                                                            <td class="col-xs-4">
