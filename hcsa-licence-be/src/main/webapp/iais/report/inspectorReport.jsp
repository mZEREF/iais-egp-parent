                ...
                <div class="table-gp">
                    <table class="table">
                        <tr>
                            ...
                            <td class="col-xs-4">
                                        <span>
                                            <p>${insRepDto.riskRecommendation}</p>
                                            <input type="hidden" name="riskRecommendation" value="${insRepDto.riskRecommendation}">
                                            <p>
                                               <select class="table-select" id="select" name="recommendation">
