                                    ...
                                    <div class="tab-gp dashboard-tab">
                                        ...
                                        <div class="tab-content">
                                            <div class="${infoClassBelow}" id="tabInfo" role="tabpanel">
                                                        ...
                                                        <div class="col-xs-12">
                                                            <div class="table-gp">
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        <td class="col-xs-6" align="right">Application
                                                                            No. (Overall)
                                                                        </td>
                                                ...
                                                <div align="center">
                                                    <a href="/hcsa-licence-web/eservice/INTRANET/LicenceBEViewService"
                                                       target="_blank">
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="table-gp">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                <c:forEach
                                                                        items="${applicationViewDto.appSupDocDtoList}"
                                                                        var="appSupDocDto">
                                                                    <tr>
                                                                        <td>
                                                                            <p><c:out
                                                                                    value="${appSupDocDto.file}"></c:out></p>
                                                                        </td>
                                                                        <td>
                                                                            <p><a href="#"><c:out
                                                                                    value="${appSupDocDto.document}"></c:out></a>
                                                                            </p>
                                                                        </td>
                                                                        <td>
                                                                            <p><c:out
                                                                                    value="${appSupDocDto.size}"></c:out></p>
                                                                        </td>
                                                                        <td>
                                                                            <p><c:out
                                                                                    value="${appSupDocDto.submittedBy}"></c:out></p>
                                                                        </td>
                                                                        <td>
                                                                            <p><c:out
                                                                                    value="${appSupDocDto.dateSubmitted}"></c:out></p>
                                                                        </td>
                                                                    </tr>
                                                                </c:forEach>
                                                        ...
                                                        <div class="table-gp">
                                                            <iais:section title="">
                                                                <iais:row>
                                                                    ...
                                                                    <iais:value width="6">
                                                                        <p><strong><iais:code
                                                                                code="${insRepDto.currentStatus}"/></strong>
                                                                        </p>
                                                                    </iais:value>
                                                                </iais:row>
