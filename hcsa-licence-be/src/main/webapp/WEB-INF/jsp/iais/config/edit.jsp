        ...
        <c:forEach items="${serviceDoc}" var="doc">
          <div class="form-group">
            <div class="col-xs-12 col-md-12">
              ...
              <div class="col-xs-12 col-md-2">
                <input  type="text" name="descriptionServiceDoc" maxlength="255" value="${doc.docTitle}">
              </div>
        ...
        <c:forEach items="${comDoc}" var="doc" varStatus="sta">
          <div class="form-group">
            <div class="col-xs-12 col-md-12">
              ...
              <div class="col-xs-12 col-md-2">
                <input  type="text" name="descriptionCommDoc" maxlength="255" value="${doc.docTitle}">
              </div>
              <div class="col-xs-12 col-md-2 form-check" style="margin-top: 1%">
                ...
                <input style="white-space: nowrap" class="form-check-input" <c:if test="${doc.isMandatory}">checked</c:if>  type="checkbox" onclick="checkboxOnclick(this)" name="descriptionCommDocMandatory">
                <label style="white-space: nowrap" class="form-check-label" ><span class="check-square"></span>Mandatory ?</label>
              </div>
              <div class="col-xs-12 col-md-2 form-check" style="margin-top: 1%">
      ...
      <div class="form-group" style="display: none" id="${routingStages.key}" >
        <div class="col-xs-12 col-md-12"  style="margin-top: 10px">
          <table aria-describedby="" border="1px" style="text-align: center" valign="middle" >
            <tr>
              <th scope="col" class="text-center" 10% ;height: 40px;text-align: center;padding: 1% 0% 1% "> Application Type&nbsp;<span class="mandatory" >*</span></th>
              ...
              <tr >
                ...
                <td >
                  ...
                  <div class="col-xs-12 col-md-6" style="margin-top: 1%;margin-bottom: 1%;text-align:left" >
                    ...
                    <c:if test="${routingStage.stageCode=='INS'}">
                      <c:forEach items="${routingStage.hcsaSvcSpeRoutingSchemeDtos}" var="hcsaSvcSpeRoutingSchemeDto" varStatus="ind">
                        <div style="margin-top: 1%">
                          ...
                          <span name="iaisErrorMsg" class="error-msg" id="error_insRoutingStage${routingStages.key}${ind.index}"></span>
                        </div>
                      </c:forEach>
                    </c:if>
