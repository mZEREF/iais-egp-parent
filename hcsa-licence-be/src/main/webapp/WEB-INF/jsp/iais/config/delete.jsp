          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-md-3">
              <div class="form-check ">
                <input class="form-check-input" disabled="disabled" name="PremisesType"<c:if test="${fn:contains(type,'OFFSIET')}">checked="checked"</c:if> id="icon4checkboxSample" type="checkbox" name="Offsite"  value="OFFSIET" aria-invalid="false">
