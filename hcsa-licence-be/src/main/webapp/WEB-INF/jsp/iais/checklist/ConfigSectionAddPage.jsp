                ...
                <div class="gray-content-box sectionClass sectionSon" data-id="${sectionStatus.index}">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading"  role="tab">
                      <h4 class="panel-title"><div role="button" data-toggle="collapse" href="#collapseOne${sectionStatus.index}" aria-expanded="true" aria-controls="collapseOne">${chklsec.section}</div>
