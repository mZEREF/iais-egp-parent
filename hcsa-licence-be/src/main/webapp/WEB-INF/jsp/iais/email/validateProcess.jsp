                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="tabProcessing" role="tabpanel">
                                                ...
                                                <iais:section title="" id = "process_NcProcess">
                                                    ...
                                                    <iais:row>
                                                        <label class="col-md-4 control-label">Internal Remarks <span style="color: red; display: none;" id="internalRemarkStar"> *</span></label>
                                                    ...
                                                    <iais:row>
                                                        ...
                                                        <iais:value width="7">
                                                            <iais:select id="decision-validate-email" name="decision"  cssClass="nice-select nextStage" options="appTypeOption" firstOption="Please select"
                                                                         onchange="javascript:showRollBackTo();"/>
...
<script type="text/javascript">
    ...
    function doSend() {
        ...
        if(remark.length>300){
            $("#error_internalRemarks1").html('Remarks should not be more than 300 characters.');
    ...
    $("[name='decision']").change(function selectChange() {
        var selectValue = $("[name='decision']").val();
