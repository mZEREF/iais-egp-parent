                                    ...
                                    <div class="tab-gp dashboard-tab">
                                        ...
                                        <div class="tab-content row">
                                            <c:choose>
                                                ...
                                                <c:when test="${not empty lisLicTab}">
                                                    <a style="float:left;padding-top: 1.1%;text-decoration:none;" class="back" href="/hcsa-licence-web/eservice/INTRANET/MohLicenseeOnlineEnquiry/1/preLicenceSearch?back=back"><em class="fa fa-angle-left"></em> Back</a>
                                                </c:when>
                                                <c:otherwise>
                                                    <a href="#"
