                                ...
                                <div class="panel-main-content">
                                    <iais:section title="" id="supPoolList">
                                        <iais:row>
                                            ...
                                            <iais:value width="18">
                                                <label>
                                                    <input type="text" style="width:180%; font-weight:normal;"
                                                           name="searchNo" maxlength="100" value="${searchNo}"/>
                                                </label>
                                            </iais:value>
                                        </iais:row>
                                        <iais:row>
                                            ...
                                            <iais:value width="18" cssClass="form-check">
                                                <input id="applicationChk" type="radio"
                                                       <c:if test="${count=='2'}">checked</c:if> name="searchChk"
                                        ...
                                        <iais:row id="selectSearchChkMsg" style="display: none">
                                            <div class="row" height="1" style="font-size: 1.6rem; color: #D22727; padding-left: 20px" id="selectSearchChkMsg">
                                ...
                                <c:otherwise>
                                    ...
                                    <c:forEach var="pool" items="${SearchResult.rows}" varStatus="status">
                                        <tr>
                                            ...
                                            <td><c:out value="${pool.hciCode}"/><c:if
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <select>
                                                                ...
                                                                <c:forEach items="${pool.address}" var="address"
                                                                           varStatus="index">
