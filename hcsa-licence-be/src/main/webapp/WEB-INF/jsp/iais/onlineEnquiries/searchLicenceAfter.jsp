                                        ...
                                        <div class="panel-main-content">
                                            <iais:section title="" id="supPoolList">
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        ...
                                                        <input type="text" maxlength="20"
                                                               ...
                                                               name="application_no"
                                                               value="${SearchParam.filters['appNo']}"/>
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        <div id="application_type">
                                                            <iais:select name="application_type"
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        <div id="application_status">
                                                            <iais:select name="application_status"
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        ...
                                                        <input type="text" maxlength="24"
                                                               style=" font-weight:normal;"
                                                               name="licence_no"
                                                               value="${SearchParam.filters['licence_no']}"/>
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        ...
                                                        <input type="text" maxlength="10"
                                                               style=" font-weight:normal;"
                                                               name="uen_no"
                                                               value="${SearchParam.filters['uen_no']}"/>
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        <div id="service_licence_type">
                                                            <iais:select name="service_licence_type"
                                                                         options="licSvcTypeOption"
                                                                         firstOption="Please Select"
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        <div id="service_sub_type">
                                                            <iais:select name="service_sub_type"
                                                                         options="licSvcSubTypeOption"
                                                                         firstOption="Please Select"
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        <div id="licence_status">
                                                            <iais:select name="licence_status"
                                                                         options="licStatusOption"
                                                                         firstOption="Please Select"
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        <iais:datePicker id="expiry_start_date"
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        ...
                                                        <input type="text" maxlength="7"
                                                               style=" font-weight:normal;"
                                                               name="hci_code"
                                                               value="${SearchParam.filters['hciCode']}"/>
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        ...
                                                        <input type="text" maxlength="10"
                                                               style=" font-weight:normal;"
                                                               name="licensee_idNo"
                                                               value="${SearchParam.filters['licenseeIdNo']}"/>
                                    ...
                                    <div class="panel-body">
                                        <div class="panel-main-content">
                                            <iais:section title="" id="supPoolList">
                                                ...
                                                <iais:row>
                                                    ...
                                                    <div class="col-sm-7 col-md-4 col-xs-10">
                                                        <div id="personnelRoleOption">
                                                            <iais:select name="personnelRole"
                                                                         options="servicePersonnelRoleOption"
                                                                         firstOption="Please Select"
                                                ...
                                                <iais:row>
                                                    <iais:field
                                                            value="Service Personnel Professional Regn. No."/>
                                                    <div class="col-sm-7 col-md-4 col-xs-10">

                                                        <input type="text" maxlength="20"
                                                               style=" font-weight:normal;"
                                                               name="personnelRegnNo"
                            ...
                            <div class="col-xs-9 col-md-9">
                                <iais:action style="text-align:right;">
                                    <a style=" float:left;padding-top: 1.1%;text-decoration:none;"
                                       onclick="javascript:doLicBack()"><em class="fa fa-angle-left"> </em> Back</a>
                                    <button class="btn btn-secondary" type="button"
                                            onclick="javascript:doLicClear()">Clear
                                    </button>
                                    <button class="btn btn-primary" type="button"
                                            onclick="javascript:doLicSearch()">Search
                                    </button>
                                </iais:action>
                            </div>
                        </div>
                                                        ...
                                                        <c:otherwise>
                                                            ...
                                                            <c:forEach var="pool"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><iais:service
                                                                            value="${pool.serviceName}"></iais:service></td>
                                                                    <td><fmt:formatDate
