<div class=" col-md-12">
    ...
    <hr>
    <div class="row">
        <iais:field width="6" value="Total No. of Co-funded IUI Cycles"/>
        <div class="col-md-6">
    ...
    <hr>
    <div class="row">
        <iais:field width="6" value="Total No. of Co-funded ART Fresh Cycles"/>
        <div class="col-md-6">
    ...
    <hr>
    <div class="row">
        <iais:field width="6" value="Total No. of Co-funded ART Frozen Cycles"/>
        <div class="col-md-6">
    ...
    <hr>
    <div class="row">
        <iais:field width="6" value="Total No. of Co-funded PGT Cycles"/>
        <div class="col-md-6">
