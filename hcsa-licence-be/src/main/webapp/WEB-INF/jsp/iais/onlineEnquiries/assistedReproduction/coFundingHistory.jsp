<div class=" col-md-10" style="left: 8%;">
    ...
    <hr>
    <div class="row">
        <iais:field width="6" cssClass="col-md-6" value="Total No. of Co-funded ART Cycles claimed by patient when she is 40 years old and above"/>
        <div class="col-md-6">
    ...
    <hr>
    <div class="row">
        <iais:field width="6" cssClass="col-md-6" value="Total No. of Co-funded PGT Cycles claimed by patient when she is 40 years old and above"/>
        <div class="col-md-6">
