                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="form-check">
                                        <input disabled name="<c:out value="${ckkId}"/>rad" id="<c:out value="${cdto.subName}"/><c:out value="${item.incqDto.itemId}"/><c:out value="${item.incqDto.sectionNameShow}"/>itemCheckboxYes" onclick="hideCheckBox('${ckkId}')" type="radio" <c:if test="${item.incqDto.chkanswer eq'Yes'}">checked</c:if> value="Yes" class="form-check-input" />
                                ...
                                <td class="text-right">
                                    <div class="form-check">
                                        <input disabled  name="<c:out value="${ckkId}"/>rad" id="<c:out value="${cdto.subName}"/><c:out value="${item.incqDto.itemId}"/><c:out value="${item.incqDto.sectionNameShow}"/>itemCheckboxNo"  onclick="showCheckBox('${ckkId}')" type="radio" <c:if test="${item.incqDto.chkanswer eq'No'}">checked</c:if> value="No" class="form-check-input" />
                                ...
                                <td class="text-right">
                                    <div class="form-check">
                                        <input  disabled name="<c:out value="${ckkId}"/>rad" id="<c:out value="${cdto.subName}"/><c:out value="${item.incqDto.itemId}"/><c:out value="${item.incqDto.sectionNameShow}"/>itemCheckboxNa" onclick="hideCheckBox('${ckkId}')" type="radio" <c:if test="${item.incqDto.chkanswer eq'N/A'}">checked</c:if> value="N/A" class="form-check-input" />
                                ...
                                <td class="text-left">
                                    <div id="<c:out value="${ckkId}"/>ck"   <c:if test="${item.incqDto.chkanswer != 'No'}">style="display: none;"</c:if>>
                                        <div class="form-check">
                                            <input disabled  name="<c:out value="${ckkId}"/>rec" id="<c:out value="${cdto.subName}${item.incqDto.itemId}"/><c:out value="${item.incqDto.sectionNameShow}"/>rec" type="checkbox" <c:if test="${item.incqDto.rectified}">checked</c:if> value="rec"/>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                ...
                <table aria-describedby="" class="table">
                    ...
                    <c:forEach var = "item" items = "${service.adchklDto.adItemList}" varStatus="status">
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="form-check"><input disabled  name="<c:out value="${ckkId}"/>adhocrad" id="<c:out value="${item.id}"/>adhocitemCheckboxYes" onclick="hideCheckBox('${ckkId}')" type="radio" <c:if test="${item.adAnswer eq'Yes'}">checked</c:if> value="Yes" class="form-check-input"/>
                                    <label class="form-check-label" for="<c:out value="${ckkId}"/>adhocitemCheckboxYes"><span class="check-circle"></span></label>
                                </div>
                            </td>
                            <td class="text-right">
                                <div class="form-check">
                                    <input disabled  name="<c:out value="${ckkId}"/>adhocrad" id="<c:out value="${ckkId}"/>adhocitemCheckboxNo"  onclick="showCheckBox('${ckkId}')" type="radio" <c:if test="${item.adAnswer eq'No'}">checked</c:if> value="No" class="form-check-input"/>
                                    <label class="form-check-label" for="<c:out value="${ckkId}"/>adhocitemCheckboxNo"><span class="check-circle"></span></label>
                                </div>
                            </td>
                            <td class="text-right">
                                <div class="form-check">
                                    <input disabled  name="<c:out value="${ckkId}"/>adhocrad" id="<c:out value="${item.id}"/>adhocitemCheckboxNa" onclick="hideCheckBox('${ckkId}')" type="radio" <c:if test="${item.adAnswer eq'N/A'}">checked</c:if> value="N/A"  class="form-check-input"/>
                            ...
                            <td class="text-left">
                                <div id="<c:out value="${ckkId}"/>ck"<c:if test="${item.adAnswer != 'No'}">style="display: none;"</c:if>>
                                    <div class="form-check">
                                        <input disabled  name="<c:out value="${ckkId}"/>adhocrec" id="<c:out value="${ckkId}"/>adhocrec" type="checkbox" <c:if test="${item.rectified}">checked</c:if> value="rec"/>
                                    </div>
                                </div>
                            </td>
