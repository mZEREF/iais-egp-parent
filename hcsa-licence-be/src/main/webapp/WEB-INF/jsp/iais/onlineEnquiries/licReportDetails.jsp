                    ...
                    <div class="tab-gp dashboard-tab">
                        ...
                        <ul class="nav nav-tabs hidden-xs hidden-sm" role="tablist">
                            <li class="complete" role="presentation"><a href="#tabLicenseeDetails"
                                                                        ...
                                                                        data-toggle="tab">Licensee Details</a></li>
                        ...
                        <div class="tab-content ">
                            <div class="tab-pane" id="tabLicenseeDetails" role="tabpanel">
                                            ...
                                            <div class="table-gp">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;${organizationLicDto.licenseeDto.postalCode}<c:if
                                ...
                                <c:forEach var="member" items="${organizationLicDto.licenseeKeyApptPersonDtos}"
                                           varStatus="status">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="table-gp">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <td align="right">Salutation</td>
                                                        <td>&nbsp;${organizationLicDto.licenseeIndividualDto.salutation}
                                                            <c:if test="${empty organizationLicDto.licenseeIndividualDto.salutation}">-</c:if></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">ID Type</td>
                                                        <td>&nbsp;${organizationLicDto.licenseeIndividualDto.idType}
                                                            <c:if test="${empty organizationLicDto.licenseeIndividualDto.idType}">-</c:if></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">ID No</td>
                                                        <td>&nbsp;${organizationLicDto.licenseeIndividualDto.idNo}<c:if
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;${organizationLicDto.licenseeDto.addrType}<c:if
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;${organizationLicDto.licenseeIndividualDto.mobileNo}
                                            ...
                                            <div class="col-xs-12">
                                                <div class="table-gp">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td class="col-xs-6" align="right">Name</td>
                                                            <td class="col-xs-6">&nbsp;${personnel.keyPersonnelDto.name}
                                                                <c:if test="${empty personnel.keyPersonnelDto.name}">-</c:if></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">Salutation</td>
                                                            <td>&nbsp;${personnel.keyPersonnelDto.salutation}<c:if
                                                        ...
                                                        <c:if test="${personnel.licKeyPersonnelDto.psnType!='MedAlert'}">
                                                            <tr>
                                                                <td align="right">Designation</td>
                                                                <td>&nbsp;${personnel.keyPersonnelDto.designation}<c:if
                                                        ...
                                                        <c:if test="${personnel.licKeyPersonnelDto.psnType=='Clinical Governance Officer'}">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>&nbsp;${personnel.keyPersonnelExtDto.subSpeciality}
                                                        ...
                                                        <c:if test="${personnel.licKeyPersonnelDto.psnType!='MedAlert' && personnel.licKeyPersonnelDto.psnType!='Clinical Governance Officer'}">
                                                            <tr>
                                                                <td align="right">Office Telephone No</td>
                                                                <td>&nbsp;${personnel.keyPersonnelDto.officeTelNo}<c:if
                                                                        test="${empty personnel.keyPersonnelDto.officeTelNo}">-</c:if></td>
                                                            </tr>
                                                        </c:if>
                                                        <tr>
                                                            <td align="right">Email Address</td>
                                                            <td>&nbsp;${personnel.keyPersonnelDto.emailAddr}<c:if
                                                                    test="${empty personnel.keyPersonnelDto.emailAddr}">-</c:if></td>
                                                        </tr>
                                                        <c:if test="${personnel.licKeyPersonnelDto.psnType=='MedAlert'}">
                                                            <tr>
                                                                <td align="right">Preferred Mode of Receiving MedAlert
                                                                </td>
                                                                <td>&nbsp;${personnel.keyPersonnelExtDto.preferredMode}
                                ...
                                <div class="panel panel-default">
                                            ...
                                            <div class="table-gp">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-xs-4">
                                                            <p>&nbsp;<c:out value="${insRepDto.hciCode}"/><c:if
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-xs-4">
                                                            <p>&nbsp;<c:out value="${insRepDto.hciName}"/><c:if
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-xs-4">
                                                            <c:if test="${ not empty insRepDto.principalOfficers}">
                                                                <p>
                                                                    <c:forEach items="${insRepDto.principalOfficers}"
                                                                               var="poName">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-xs-4">
                                                            <c:if test="${not empty insRepDto.inspectors}">
                                                                <p><c:forEach items="${insRepDto.inspectors}"
                                                                              var="inspector" varStatus="status">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-xs-4">
                                                            <c:if test="${not empty insRepDto.inspectOffices}">
                                                                <p><c:forEach items="${insRepDto.inspectOffices}"
                                                                              var="ioName">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="table-gp">
                                                <div class="text">
                                                    <p><strong><span>&nbsp;Part I: Inspection Checklist</span></strong>
                                                    </p>
                                                </div>
                                                <table class="table">
                                                    <tr>
                                                            ...
                                                            <td colspan="2" class="col-xs-8">
                                                                <c:if test="${insRepDto.ncRegulation != null && not empty insRepDto.ncRegulation}">
                                                                    <table class="table">
                                                                        ...
                                                                        <tbody>
                                                                        <c:forEach items="${insRepDto.ncRegulation}"
                                                                                   var="ncRegulations"
                                                                                   varStatus="status">
                                                                            <tr>
                                                                                <td>
                                                        ...
                                                        <td colspan="2" class="col-xs-8">
                                                            <c:if test="${insRepDto.ncRectification != null}">
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                    <c:forEach items="${insRepDto.ncRectification}"
                                                                               var="ncRectification"
                                                                               varStatus="status">
                                                                        <tr>
                                                                            <td>
