                                ...
                                <div class="tab-gp dashboard-tab">
                                    ...
                                    <div class="tab-content ">
                                        <div class="tab-pane" id="tabLicenseeDetails" role="tabpanel">
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="table-gp">
                                                            <table class="table table-bordered">
                                                                <tbody>
                                                                <tr>
                                                                    <td class="col-xs-6" align="right">Licensee Type
                                                                    </td>
                                                                    <td class="col-xs-6">
                                                                        &nbsp;${organizationLicDto.licenseeDto.licenseeType}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">UEN</td>
                                                                    <td>&nbsp;${organizationLicDto.uenNo}<c:if
                                                                            test="${empty organizationLicDto.uenNo}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Are you registered with ACRA/ROS
                                                                    </td>
                                                        ...
                                                        <div class="table-gp">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="col-xs-6">
                                                                        &nbsp;${organizationLicDto.licenseeDto.name}
                                                                        <c:if
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>&nbsp;${organizationLicDto.licenseeDto.unitNo}
                                                                        <c:if
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        &nbsp;${organizationLicDto.licenseeDto.streetName}
                                                                        <c:if
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        &nbsp;${organizationLicDto.licenseeDto.buildingName}
                                                                        <c:if
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <c:if test="${empty organizationLicDto.licenseeDto.officeTelNo}">-</c:if></td>
                                                                </tr>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading"><strong>Sole Proprietor - Licensee</strong>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="table-gp">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="col-xs-6">
                                                                        &nbsp;${organizationLicDto.licenseeDto.name}
                                                                        <c:if test="${empty organizationLicDto.licenseeDto.name}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Salutation</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <c:if test="${empty organizationLicDto.licenseeIndividualDto.idNo}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Postal Code</td>
                                                                    <td>
                                                                        &nbsp;${organizationLicDto.licenseeDto.postalCode}
                                                                        <c:if test="${empty organizationLicDto.licenseeDto.postalCode}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Address Type</td>
                                                                    <td>&nbsp;${organizationLicDto.licenseeDto.addrType}
                                                                        <c:if test="${empty organizationLicDto.licenseeDto.addrType}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Block No</td>
                                                                    <td>&nbsp;${organizationLicDto.licenseeDto.blkNo}
                                                                        <c:if test="${empty organizationLicDto.licenseeDto.blkNo}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Floor No</td>
                                                                    <td>&nbsp;${organizationLicDto.licenseeDto.floorNo}
                                                                        <c:if test="${empty organizationLicDto.licenseeDto.floorNo}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Unit No</td>
                                                                    <td>&nbsp;${organizationLicDto.licenseeDto.unitNo}
                                                                        <c:if test="${empty organizationLicDto.licenseeDto.unitNo}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Street Name</td>
                                                                    <td>
                                                                        &nbsp;${organizationLicDto.licenseeDto.streetName}
                                                                        <c:if test="${empty organizationLicDto.licenseeDto.streetName}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Building Name</td>
                                                                    <td>
                                                                        &nbsp;${organizationLicDto.licenseeDto.buildingName}
                                                                        <c:if test="${empty organizationLicDto.licenseeDto.buildingName}">-</c:if></td>
                                                                </tr>
                                                                <tr>
                                            ...
                                            <c:forEach var="personnel" items="${personnelsDto}">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <strong>${personnel.licKeyPersonnelDto.psnType}</strong></div>
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            <div class="table-gp">
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        <td class="col-xs-6" align="right">Name</td>
                                                                        <td class="col-xs-6">
                                                                            &nbsp;${personnel.keyPersonnelDto.name}<c:if
                                                                                test="${empty personnel.keyPersonnelDto.name}">-</c:if></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="right">Salutation</td>
                                                                        <td>
                                                                            &nbsp;${personnel.keyPersonnelDto.salutation}
                                                                            <c:if test="${empty personnel.keyPersonnelDto.salutation}">-</c:if></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="right">ID Type</td>
                                                                    ...
                                                                    <c:if test="${personnel.licKeyPersonnelDto.psnType!='MedAlert'}">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <c:if test="${empty personnel.keyPersonnelDto.designation}">-</c:if></td>
                                                                        </tr>
                                                                    </c:if>
                                                                    <c:if test="${personnel.licKeyPersonnelDto.psnType=='Clinical Governance Officer'}">
                                                                        ...
                                                                        <tr>
                                                                            <td align="right">Professional Regn. No.
                                                                            </td>
                                                                            <td>
                                                                                &nbsp;${personnel.keyPersonnelExtDto.profRegNo}
                                                                                <c:if test="${empty personnel.keyPersonnelExtDto.profRegNo}">-</c:if></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td align="right">Sub-specialty or relevant
                                                                                qualification
                                                                            </td>
                                                                            <td>
                                                                    ...
                                                                    <tr>
                                                                        <td align="right">Mobile No</td>
                                                                        <td>&nbsp;${personnel.keyPersonnelDto.mobileNo}
                                                                            <c:if test="${empty personnel.keyPersonnelDto.mobileNo}">-</c:if></td>
                                                                    </tr>
                                                                    <c:if test="${personnel.licKeyPersonnelDto.psnType!='MedAlert' && personnel.licKeyPersonnelDto.psnType!='Clinical Governance Officer'}">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <c:if test="${empty personnel.keyPersonnelDto.officeTelNo}">-</c:if></td>
                                                                        </tr>
                                                                    </c:if>
                                                                    <tr>
                                                                        <td align="right">Email Address</td>
