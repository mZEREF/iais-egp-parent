                                                                            ...
                                                                            <iais:value width="7">
                                                                                <div class="table-gp" id = "processRecRfi">
                                                                                    <table class="table">
                                                                                        ...
                                                                                        <tbody>
                                                                                            <c:forEach var="appVehicleNo" items="${applicationViewDto.appSvcVehicleDtos}" varStatus="status">
                                                                                                <tr>
                                                                                                    <td><c:out value="${varStatus.count}"></c:out></td>
                                                                                                    <td><c:out value="${appVehicleNo.vehicleName}"/></td>
                                                                                                    <td>
                                                                                                        <input class="form-check-input" type="radio" name="vehicleNoRadio${varStatus.count}" value = "approve" aria-invalid="false" <c:if test="${'VEST002' eq appVehicleNo.status}">checked="checked"</c:if>/>
                                                                                                        <label class="form-check-label"><span class="check-circle"></span>Approve</label>
                                                                                                        &nbsp;
                                                                                                        <input class="form-check-input" type="radio" name="vehicleNoRadio${varStatus.count}" value = "reject" aria-invalid="false" <c:if test="${'VEST003' eq appVehicleNo.status}">checked="checked"</c:if>/>
                                                                                                        <label class="form-check-label"><span class="check-circle"></span>Reject</label>
                                                                                                        <br><span class="error-msg" name="iaisErrorMsg" id="error_vehicleNoRadioError${varStatus.count}"></span>
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <input type="text" name="vehicleNoRemarks${varStatus.count}" maxlength="400" value="${appVehicleNo.remarks}" />
                                                                                                        <br><span class="error-msg" name="iaisErrorMsg" id="error_vehicleNoRemarksError${varStatus.count}"></span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </c:forEach>
                                                                                        </tbody>
