...
<div class="panel-body">
  ...
  <div class="row">
    ...
    <br>
    <p>1. The Applicant, PO, CGO(s), and KAHs have not been convicted or found guilty by a disciplinary tribunal of a professional body or its equivalent in Singapore or elsewhere.</p>
    <br>
    <div class="form-check col-xs-3">
    ...
    <br>
    <p>2. The Applicant, PO, CGO(s), and KAHs are not awaiting the commencement of disciplinary proceedings before a disciplinary tribunal of a professional body or its equivalent, or the conclusion of such disciplinary proceedings, in Singapore or elsewhere.</p>
    <br>
    <div class="form-check col-xs-3">
    ...
    <div class="col-xs-12 txt-area-normal">
      <p>4. If you have selected 'Yes' to any of the questions above, please provide further details below:</p>
