    ...
    <div class="panel-collapse collapse" id="keyRoles" role="tabpanel" aria-labelledby="headingOne">
        <div class="panel-body">
            <div class="panel-main-content form-horizontal min-row">
                ...
                <iais:row>
                    <div class="col-md-6">
                        <label><strong>Licensee Information</strong></label>
                    </div>
                    <div class="col-md-6">
                    </div>
                </iais:row>
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        ...
                        <div class="col-md-6">
                            <span class="oldVal " attr="${oldLicenceDto.name}" style="display: none"><c:out
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        <div class="col-md-6">
                            <span class="newVal " attr="${newLicenceDto.postalCode}"><c:out
                                    value="${newLicenceDto.postalCode}"/></span>
                        </div>
                        <div class="col-md-6">
                            <span class="oldVal " attr="${oldLicenceDto.postalCode}" style="display: none"><c:out
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        <div class="col-md-6">
                            <span class="newVal " attr="${newLicenceDto.addrType}"><iais:code
                                    code="${newLicenceDto.addrType}"/></span>

                        </div>
                        <div class="col-md-6">
                            <span class="oldVal" attr="${oldLicenceDto.addrType}" style="display: none"><iais:code
                                    code="${oldLicenceDto.addrType}"/></span>
                        </div>
                    </iais:value>
                </iais:row>
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        <div class="col-md-6">
                            <span class="newVal " attr="${newLicenceDto.blkNo}"><c:out
                                    value="${newLicenceDto.blkNo}"/></span>
                        </div>
                        <div class="col-md-6">
                            <span class="oldVal " attr="${oldLicenceDto.blkNo}" style="display: none"><c:out
                                    value="${oldLicenceDto.blkNo}"/></span>
                        </div>
                    </iais:value>
                </iais:row>
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        <div class="col-md-6">
                            <span class="newVal " attr="${newLicenceDto.floorNo}"><c:out
                                    value="${newLicenceDto.floorNo}"/></span>

                        </div>
                        <div class="col-md-6">
                            <span class="oldVal " attr="${oldLicenceDto.floorNo}" style="display: none"><c:out
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        <div class="col-md-6">
                            <span class="newVal " attr="${newLicenceDto.unitNo}"><c:out
                                    value="${newLicenceDto.unitNo}"/></span>
                        </div>
                        <div class="col-md-6">
                            <span class="oldVal " attr="${oldLicenceDto.unitNo}"
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        <div class="col-md-6">
                            <span class="newVal " attr="${newLicenceDto.streetName}"><c:out
                                    value="${newLicenceDto.streetName}"/></span>
                        </div>
                        <div class="col-md-6">
                            <span class="oldVal " attr="${oldLicenceDto.streetName}" style="display: none"><c:out
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        <div class="col-md-6">
                            <span class="newVal " attr="${newLicenceDto.buildingName}"><c:out
                                    value="${newLicenceDto.buildingName}"/></span>
                        </div>
                        <div class="col-md-6">
                            <span class="oldVal " attr="${oldLicenceDto.buildingName}" style="display: none"><c:out
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        <div class="col-md-6">
                            <span class="newVal " attr="${newLicenceDto.officeTelNo}"><c:out
                                    value="${newLicenceDto.officeTelNo}"/></span>
                        </div>
                        <div class="col-md-6">
                            <span class="oldVal " attr="${oldLicenceDto.officeTelNo}" style="display: none"><c:out
                ...
                <iais:row>
                    ...
                    <iais:value width="7" cssClass="col-md-7" display="true">
                        <div class="col-md-6">
                            <span class="newVal " attr="${newLicenceDto.emilAddr}"><c:out
                                    value="${newLicenceDto.emilAddr}"/></span>
                        </div>
                        <div class="col-md-6">
                            <span class="oldVal " attr="${oldLicenceDto.emilAddr}" style="display: none"><c:out
                ...
                <c:forEach items="${appSubmissionDto.boardMember}" var="Board" varStatus="status">
                    <iais:row>
                        <div class="col-md-6"><label><strong>Board Member ${status.index+1}</strong></label></div>
                    </iais:row>
                    <iais:row>
                        ...
                        <iais:value width="7" cssClass="col-md-7" display="true">
                            <div class="col-md-6">
                                <span class="newVal " attr="${Board.idNo}">
                                    ${Board.idNo}
                                    <jsp:include
                                            page="/WEB-INF/jsp/iais/hcsaLicence/section/disciplinaryRecordMark.jsp">
                    ...
                    <iais:row>
                        ...
                        <iais:value width="7" cssClass="col-md-7" display="true">
                            <div class="col-md-6">
                                <span class="newVal " attr="${Board.designation}"><iais:code
                                        code="${Board.designation}"/></span>
                            </div>
                        </iais:value>
                    </iais:row>
                ...
                <c:forEach items="${appSubmissionDto.authorisedPerson}" var="Authorised" varStatus="status">
                    <iais:row>
                        <div class="col-md-6">
                            <label><strong>Authorised Person ${status.index+1}</strong></label>
                        </div>
                    </iais:row>
                    ...
                    <iais:row>
                        ...
                        <iais:value width="7" cssClass="col-md-7" display="true">
                            <div class="col-md-6">
                                <span class="newVal " attr="${Authorised.designation}"><iais:code
                                        code="${Authorised.designation}"/></span>
                            </div>
                        </iais:value>
                    </iais:row>
