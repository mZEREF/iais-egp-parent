        ...
        <iais:row>
            ...
            <div class="col-md-8 col-xs-8">
                <c:if test="${!weeklyDto.selectAllDay}">
                    <div class="col-md-4 col-xs-12 visible-sm visible-xs time-padding-left">
                ...
                <c:if test="${!weeklyDto.selectAllDay}">
                    <div class="col-md-4 col-xs-4 visible-sm visible-xs time-padding-left">
                ...
                <c:if test="${weeklyDto.selectAllDay}">
                    <div class="col-md-4 col-xs-3 visible-sm visible-xs time-padding-left">
