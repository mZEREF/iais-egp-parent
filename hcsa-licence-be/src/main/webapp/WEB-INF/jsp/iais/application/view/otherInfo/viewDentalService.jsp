<div class="">
    <iais:row>
        ...
        <iais:value width="3" cssClass="col-md-7" display="true">
            <c:if test="${appSvcOtherInfoDto.appSvcOtherInfoMedDto.medicalTypeIt eq '0'}">
                IT System
            </c:if>
            <c:if test="${appSvcOtherInfoDto.appSvcOtherInfoMedDto.medicalTypePaper eq '0'}">
                Paper cards
            </c:if>
        </iais:value>
    </iais:row>
    ...
    <iais:row>
        ...
        <iais:value width="3" cssClass="col-md-7" display="true">
            <c:if test="${'1' == appSvcOtherInfoDto.appSvcOtherInfoMedDto.openToPublic}">Yes</c:if>
            <c:if test="${'0' == appSvcOtherInfoDto.appSvcOtherInfoMedDto.openToPublic}">No</c:if>
        </iais:value>
    </iais:row>
