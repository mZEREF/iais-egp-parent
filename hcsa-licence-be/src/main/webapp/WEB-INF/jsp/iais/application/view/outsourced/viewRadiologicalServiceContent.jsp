...
<div class="amended-service-info-gp form-horizontal min-row <c:if test="${outsourceDto.bundleSvcCode eq AppServicesConsts.SERVICE_CODE_RADIOLOGICAL_SERVICES}">hidden</c:if>">
    <div class="col-xs-12">
