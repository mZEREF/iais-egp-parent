    ...
    <table aria-describedby="" class="table"  border="1px" style="border-collapse: collapse;">
        ...
        <tr>
            ...
            <th scope="col" style="vertical-align:middle;font-weight:normal;">
                <input name="reminderThreshold" style="margin-left: 20%;width: 50%;" type="text" value="<c:out value="${reminderThreshold}"/>" placeholder="Enter required man-days" maxlength="5" style="width: 50% ;height: 10%;"/>
                man-days<br>
  ...
  <c:forEach items="${hcsaSvcRoutingStageDtos}" var="hcsaSvcRoutingStageDto">
      <tr>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-8 col-sm-6 col-md-5">
            <input style="display: none" value="${orgUserName}" name="createBy" >
            <p>Charlie Tan</p>
