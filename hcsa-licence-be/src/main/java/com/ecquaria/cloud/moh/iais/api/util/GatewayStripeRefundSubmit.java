...
public class GatewayStripeRefundSubmit {

    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) throws Exception {

    	Map<String, String> sPara = GatewayStripeRefundCore.paraFilter(sParaTemp);
    	String mysign = GatewayStripeRefundCore.buildSign(sPara, GatewayStripeRefundConfig.sign_type);
        
        sPara.put("sign", mysign);
        sPara.put("sign_type", GatewayStripeRefundConfig.sign_type);
    ...
    public static String buildForm(Map<String, String> sParaTemp, String gateway, String strMethod,
        ...
        sbHtml.append("<form id=\"GatewayStripeRefundSubmit\" name=\"GatewayStripeRefundSubmit\" action=\"").append(gateway).append("_input_charset=").append(GatewayConfig.input_charset).append("\" method=\"").append(strMethod).append("\">");
        ...
        sbHtml.append("<script>document.forms['GatewayStripeRefundSubmit'].submit();</script>");
