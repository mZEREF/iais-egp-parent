...
public class HcsaWeightageRiskValidate implements CustomizeValidator {
    ...
    private void doWeightageVad(HcsaRiskWeightageDto temp, Map<String, String> errMap) {
        ...
        boolean lasInpNumFlag = formatVad(temp,errMap,temp.getDoLastInp(),"lastInp",mess + "for Last Inspection");
        boolean lasSecInpNumFlag = formatVad(temp,errMap,temp.getDoSecLastInp(),"secLastInp",mess + "for Second Last Inspection");
        boolean lasFinNumFlag = formatVad(temp,errMap,temp.getDoFinancial(),"fin",mess + "for Financial Scheme Audit");
        boolean lasLeaNumFlag = formatVad(temp,errMap,temp.getDoLeadship(),"lea",mess + "for Leadership And Governance");
        boolean lasLegNumFlag = formatVad(temp,errMap,temp.getDoLegislative(),"leg",mess + "for Legislative Breaches");
