...
public interface AppPremisesRoutingHistoryClient {
    ...
    @GetMapping(value = "/iais-application-history/secondRouteBack-history/{appNo}")
    FeignResponseEntity<AppPremisesRoutingHistoryDto> getSecondRouteBackHistoryByAppNo(@PathVariable("appNo") String appNo);
}
