...
public interface InspectionTaskClient {
    ...
    @PostMapping(value = "/iais-inspection/system-group-param", consumes = MediaType.APPLICATION_JSON_VALUE)
    FeignResponseEntity<SearchResult<SystemAssignSearchQueryDto>> searchSystemPoolTaskByGroup(@RequestBody SearchParam searchParam);
    ...
    @GetMapping(value = "/iais-appt-inspec-be/appt-allsystemdate-dto/{appPremCorrId}", produces = MediaType.APPLICATION_JSON_VALUE)
    FeignResponseEntity<List<AppPremisesInspecApptDto>> getAllSystemDtosByAppPremCorrId(@PathVariable(name = "appPremCorrId")String appPremCorrId);
     ...
     * inspection history
     */
    @GetMapping(value = "/iais-inspection/insp-history-app/licenceIdandappid", consumes = {MediaType.APPLICATION_JSON_VALUE})
    FeignResponseEntity<List<ApplicationDto>> getInspHistoryAppByLicId(@RequestParam(name = "licenceId") String licenceId,
                                                                       @RequestParam(name = "newestAppld") String appId);
    ...
    @DeleteMapping(value = "/insp-appt-draft/insp-appt-draft/sh-an",produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    FeignResponseEntity<List<AppPremInspApptDraftDto>> deleteInspDateDraftByAppNo(@RequestBody List<String> appNoList);

    @DeleteMapping(value = "/insp-appt-draft/insp-appt-draft/sh-an-ref",produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    FeignResponseEntity<List<AppPremInspApptDraftDto>> deleteInspDateDraftByApptRefNo(@RequestBody List<String> apptRefNos);
}
