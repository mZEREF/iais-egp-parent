...
public class ApplicationClientFallback implements ApplicationClient{
    ...
    @Override
    public FeignResponseEntity<List<AppGrpPremisesDto>> getOtherChangeHciNameApp(ApplicationDto application) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<TaskDto>> getActiveTaskList(String premCorrId) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<Set<String>> getActiveInspectorByCorrelationId(String appNo, String processUrl, String roleId) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
