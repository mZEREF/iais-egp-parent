        ...
        map.forEach((insGrpId, licIds) -> {
            ...
            for (AppSubmissionDto entity : appSubmissionDtoList) {
                try {
                    ...
                    entity.setAppStatus(ApplicationConsts.APPLICATION_STATUS_PENDING_TASK_ASSIGNMENT);
                    ...
                    RfcHelper.beforeSubmit(entity,null,grpNo,ApplicationConsts.APPLICATION_TYPE_POST_INSPECTION,null);
