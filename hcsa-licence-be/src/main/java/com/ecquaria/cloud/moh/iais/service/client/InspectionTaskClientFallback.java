...
public class InspectionTaskClientFallback implements InspectionTaskClient {
    ...
    @Override
    public FeignResponseEntity<SearchResult<ComPoolAjaxQueryDto>> commonPoolResult(SearchParam searchParam) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<SearchResult<SystemAssignSearchQueryDto>> searchSystemPoolTaskByGroup(SearchParam searchParam) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppPremPreInspectionNcDocDto>> getFilesByItemId(String itemId) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<EventInspRecItemNcDto> getEventInspRecItemNcDtoByCorrIds(EventInspRecItemNcDto eventInspRecItemNcDto) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<ApplicationDto>> getInspHistoryAppByLicId(String licenceId) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<AppStageSlaTrackingDto> createAppStageSlaTrackingDto(AppStageSlaTrackingDto appStageSlaTrackingDto) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<AppStageSlaTrackingDto> updateAppStageSlaTrackingDto(AppStageSlaTrackingDto appStageSlaTrackingDto) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppStageSlaTrackingDto>> getSlaTrackByAppNo(String appNo) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<AppStageSlaTrackingDto> searchSlaTrackById(String id) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppPremisesRoutingHistoryExtDto>> createAppPremisesRoutingHistoryExtDtos(List<AppPremisesRoutingHistoryExtDto> appPremisesRoutingHistoryExtDtos) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppPremInspCorrelationDto>> createAppPremInspCorrelationDto(List<AppPremInspCorrelationDto> appPremInspCorrelationDtos) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<AppPremInspCorrelationDto> updateAppPremInspCorrelationDto(AppPremInspCorrelationDto appPremInspCorrelationDto) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppPremInspCorrelationDto>> getAppInspCorreByAppNoUserIdStatus(String appNo, String userId, String status) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppPremInspCorrelationDto>> getAppInspCorreByUserIdStatus(String userId, String status) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppPremInspCorrelationDto>> getAppInspCorreByAppNoStatus(String appNo, String status) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<SearchResult<ReschedulingOfficerQueryDto>> officerReSchSearch(SearchParam searchParam) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<ReschedulingOfficerDto> reScheduleSaveRouteData(ReschedulingOfficerDto reschedulingOfficerDto) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppPremInspApptDraftDto>> createAppPremisesInspecApptDto(List<AppPremInspApptDraftDto> appPremInspApptDraftDtos) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<AppPremInspApptDraftDto> updateAppPremisesInspecApptDto(AppPremInspApptDraftDto appPremInspApptDraftDto) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppPremInspApptDraftDto>> getInspApptDraftListByAppNo(String appNo) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<String> deleteInspDateDraftByAppNo(List<String> appNoList) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<String> deleteInspDateDraftByApptRefNo(List<String> apptRefNos) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<AppPremInspApptDraftDto>> getAllInspApptDrafts() {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<String> deleteInspDateDraftById(String id) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
