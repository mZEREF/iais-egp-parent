...
//                    case ApplicationConsts.PREMISES_TYPE_OFF_SITE:complianceHistoryDto.setInspectionTypeName("Off-Site Inspection");break;
    ...
    @Override
    @SearchTrack(catalog = "hcsaOnlineEnquiry", key = "applicationOnlineEnquiry")
    public SearchResult<ApplicationQueryResultsDto> searchApplicationQueryResult(SearchParam searchParam) {
        return onlineEnquiryViewClient.searchApplicationQueryResult(searchParam).getEntity();
    }
    ...
    @Override
    @SearchTrack(catalog = "hcsaOnlineEnquiry", key = "paymentOnlineEnquiry")
    public SearchResult<PaymentQueryResultsDto> searchPaymentQueryResult(SearchParam searchParam) {
        return onlineEnquiryViewClient.searchPaymentQueryResult(searchParam).getEntity();
    }
...
//        inspectionReportDto.setReportNoteBy(leadName);
    ...
    public void getInspReport(BaseProcessClass bpc, String appPremisesCorrelationId, String licenceId) {
        ...
        ParamUtil.setSessionAttr(bpc.request, HcsaLicenceBeConstant.APP_SPECIAL_FLAG,
                "view");
        ParamUtil.setSessionAttr(bpc.request, HcsaLicenceBeConstant.APP_VEHICLE_FLAG, "RETYPE007_view");
        ParamUtil.setSessionAttr(bpc.request, HcsaLicenceBeConstant.APP_OTHER_FLAG, "view");
