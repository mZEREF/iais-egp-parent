...
public interface HcsaLicenceClient {
    ...
    @RequestMapping(path = "/hcsa-key-personnel/latestVersion/{idNo}/{orgId}/{nationality}",method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    FeignResponseEntity<KeyPersonnelDto> getLatestVersionKeyPersonnelByidNoAndOrgId(@PathVariable(name = "idNo") String idNo,
                                                                           @PathVariable(name = "orgId") String orgId,
                                                                                    @PathVariable(name = "nationality") String nationality);
