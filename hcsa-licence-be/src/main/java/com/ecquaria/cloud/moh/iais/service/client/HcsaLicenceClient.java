...
public interface HcsaLicenceClient {
    ...
    @GetMapping(path= "/lic-common/lic-corrid{licenceId}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(path = "/lic-common/licence-by-licno",method = RequestMethod.POST,consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/data-submission-be/arPatients", produces = MediaType.APPLICATION_JSON_VALUE)
