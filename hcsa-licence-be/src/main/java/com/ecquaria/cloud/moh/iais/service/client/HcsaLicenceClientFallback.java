...
public class HcsaLicenceClientFallback implements HcsaLicenceClient {
    ...
    @Override
    public FeignResponseEntity<String> groupLicenceNumber(String groupLicence,String orgLicecnceId) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<EicRequestTrackingDto> getLicEicRequestTrackingDto(String eventRefNo) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<EicRequestTrackingDto> updateLicEicRequestTracking(EicRequestTrackingDto licEicRequestTrackingDto) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
