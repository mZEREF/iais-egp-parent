...
public class OrganizationClientFallback implements OrganizationClient {
    ...
    @Override
    public FeignResponseEntity<List<TaskDto>> getCompleteTaskByRefNo(String refNo) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
    ...
    @Override
    public FeignResponseEntity<List<TaskDto>> getTaskByRefNoStatus(String refNo, String taskStatus, String processUrl) {
        FeignResponseEntity entity = new FeignResponseEntity<>();
        HttpHeaders headers = new HttpHeaders();
        entity.setHeaders(headers);
        return entity;
